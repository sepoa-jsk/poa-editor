(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var{entries:e,setPrototypeOf:t,isFrozen:n,getPrototypeOf:r,getOwnPropertyDescriptor:i}=Object,{freeze:a,seal:o,create:s}=Object,{apply:c,construct:l}=typeof Reflect<`u`&&Reflect;a||=function(e){return e},o||=function(e){return e},c||=function(e,t){var n=[...arguments].slice(2);return e.apply(t,n)},l||=function(e){return new e(...[...arguments].slice(1))};var u=C(Array.prototype.forEach),d=C(Array.prototype.lastIndexOf),f=C(Array.prototype.pop),p=C(Array.prototype.push),m=C(Array.prototype.splice),h=Array.isArray,g=C(String.prototype.toLowerCase),_=C(String.prototype.toString),v=C(String.prototype.match),ee=C(String.prototype.replace),y=C(String.prototype.indexOf),b=C(String.prototype.trim),te=C(Number.prototype.toString),ne=C(Boolean.prototype.toString),re=typeof BigInt>`u`?null:C(BigInt.prototype.toString),ie=typeof Symbol>`u`?null:C(Symbol.prototype.toString),x=C(Object.prototype.hasOwnProperty),ae=C(Object.prototype.toString),S=C(RegExp.prototype.test),oe=se(TypeError);function C(e){return function(t){t instanceof RegExp&&(t.lastIndex=0);var n=[...arguments].slice(1);return c(e,t,n)}}function se(e){return function(){return l(e,[...arguments])}}function w(e,r){let i=arguments.length>2&&arguments[2]!==void 0?arguments[2]:g;if(t&&t(e,null),!h(r))return e;let a=r.length;for(;a--;){let t=r[a];if(typeof t==`string`){let e=i(t);e!==t&&(n(r)||(r[a]=e),t=e)}e[t]=!0}return e}function T(e){for(let t=0;t<e.length;t++)x(e,t)||(e[t]=null);return e}function E(t){let n=s(null);for(let[r,i]of e(t))x(t,r)&&(h(i)?n[r]=T(i):i&&typeof i==`object`&&i.constructor===Object?n[r]=E(i):n[r]=i);return n}function ce(e){switch(typeof e){case`string`:return e;case`number`:return te(e);case`boolean`:return ne(e);case`bigint`:return re?re(e):`0`;case`symbol`:return ie?ie(e):`Symbol()`;case`undefined`:return ae(e);case`function`:case`object`:{if(e===null)return ae(e);let t=e,n=D(t,`toString`);if(typeof n==`function`){let e=n(t);return typeof e==`string`?e:ae(e)}return ae(e)}default:return ae(e)}}function D(e,t){for(;e!==null;){let n=i(e,t);if(n){if(n.get)return C(n.get);if(typeof n.value==`function`)return C(n.value)}e=r(e)}function n(){return null}return n}function le(e){try{return S(e,``),!0}catch{return!1}}var O=a(`a.abbr.acronym.address.area.article.aside.audio.b.bdi.bdo.big.blink.blockquote.body.br.button.canvas.caption.center.cite.code.col.colgroup.content.data.datalist.dd.decorator.del.details.dfn.dialog.dir.div.dl.dt.element.em.fieldset.figcaption.figure.font.footer.form.h1.h2.h3.h4.h5.h6.head.header.hgroup.hr.html.i.img.input.ins.kbd.label.legend.li.main.map.mark.marquee.menu.menuitem.meter.nav.nobr.ol.optgroup.option.output.p.picture.pre.progress.q.rp.rt.ruby.s.samp.search.section.select.shadow.slot.small.source.spacer.span.strike.strong.style.sub.summary.sup.table.tbody.td.template.textarea.tfoot.th.thead.time.tr.track.tt.u.ul.var.video.wbr`.split(`.`)),k=a(`svg.a.altglyph.altglyphdef.altglyphitem.animatecolor.animatemotion.animatetransform.circle.clippath.defs.desc.ellipse.enterkeyhint.exportparts.filter.font.g.glyph.glyphref.hkern.image.inputmode.line.lineargradient.marker.mask.metadata.mpath.part.path.pattern.polygon.polyline.radialgradient.rect.stop.style.switch.symbol.text.textpath.title.tref.tspan.view.vkern`.split(`.`)),ue=a([`feBlend`,`feColorMatrix`,`feComponentTransfer`,`feComposite`,`feConvolveMatrix`,`feDiffuseLighting`,`feDisplacementMap`,`feDistantLight`,`feDropShadow`,`feFlood`,`feFuncA`,`feFuncB`,`feFuncG`,`feFuncR`,`feGaussianBlur`,`feImage`,`feMerge`,`feMergeNode`,`feMorphology`,`feOffset`,`fePointLight`,`feSpecularLighting`,`feSpotLight`,`feTile`,`feTurbulence`]),de=a([`animate`,`color-profile`,`cursor`,`discard`,`font-face`,`font-face-format`,`font-face-name`,`font-face-src`,`font-face-uri`,`foreignobject`,`hatch`,`hatchpath`,`mesh`,`meshgradient`,`meshpatch`,`meshrow`,`missing-glyph`,`script`,`set`,`solidcolor`,`unknown`,`use`]),fe=a(`math.menclose.merror.mfenced.mfrac.mglyph.mi.mlabeledtr.mmultiscripts.mn.mo.mover.mpadded.mphantom.mroot.mrow.ms.mspace.msqrt.mstyle.msub.msup.msubsup.mtable.mtd.mtext.mtr.munder.munderover.mprescripts`.split(`.`)),pe=a([`maction`,`maligngroup`,`malignmark`,`mlongdiv`,`mscarries`,`mscarry`,`msgroup`,`mstack`,`msline`,`msrow`,`semantics`,`annotation`,`annotation-xml`,`mprescripts`,`none`]),me=a([`#text`]),he=a(`accept.action.align.alt.autocapitalize.autocomplete.autopictureinpicture.autoplay.background.bgcolor.border.capture.cellpadding.cellspacing.checked.cite.class.clear.color.cols.colspan.controls.controlslist.coords.crossorigin.datetime.decoding.default.dir.disabled.disablepictureinpicture.disableremoteplayback.download.draggable.enctype.enterkeyhint.exportparts.face.for.headers.height.hidden.high.href.hreflang.id.inert.inputmode.integrity.ismap.kind.label.lang.list.loading.loop.low.max.maxlength.media.method.min.minlength.multiple.muted.name.nonce.noshade.novalidate.nowrap.open.optimum.part.pattern.placeholder.playsinline.popover.popovertarget.popovertargetaction.poster.preload.pubdate.radiogroup.readonly.rel.required.rev.reversed.role.rows.rowspan.spellcheck.scope.selected.shape.size.sizes.slot.span.srclang.start.src.srcset.step.style.summary.tabindex.title.translate.type.usemap.valign.value.width.wrap.xmlns`.split(`.`)),ge=a(`accent-height.accumulate.additive.alignment-baseline.amplitude.ascent.attributename.attributetype.azimuth.basefrequency.baseline-shift.begin.bias.by.class.clip.clippathunits.clip-path.clip-rule.color.color-interpolation.color-interpolation-filters.color-profile.color-rendering.cx.cy.d.dx.dy.diffuseconstant.direction.display.divisor.dur.edgemode.elevation.end.exponent.fill.fill-opacity.fill-rule.filter.filterunits.flood-color.flood-opacity.font-family.font-size.font-size-adjust.font-stretch.font-style.font-variant.font-weight.fx.fy.g1.g2.glyph-name.glyphref.gradientunits.gradienttransform.height.href.id.image-rendering.in.in2.intercept.k.k1.k2.k3.k4.kerning.keypoints.keysplines.keytimes.lang.lengthadjust.letter-spacing.kernelmatrix.kernelunitlength.lighting-color.local.marker-end.marker-mid.marker-start.markerheight.markerunits.markerwidth.maskcontentunits.maskunits.max.mask.mask-type.media.method.mode.min.name.numoctaves.offset.operator.opacity.order.orient.orientation.origin.overflow.paint-order.path.pathlength.patterncontentunits.patterntransform.patternunits.points.preservealpha.preserveaspectratio.primitiveunits.r.rx.ry.radius.refx.refy.repeatcount.repeatdur.restart.result.rotate.scale.seed.shape-rendering.slope.specularconstant.specularexponent.spreadmethod.startoffset.stddeviation.stitchtiles.stop-color.stop-opacity.stroke-dasharray.stroke-dashoffset.stroke-linecap.stroke-linejoin.stroke-miterlimit.stroke-opacity.stroke.stroke-width.style.surfacescale.systemlanguage.tabindex.tablevalues.targetx.targety.transform.transform-origin.text-anchor.text-decoration.text-rendering.textlength.type.u1.u2.unicode.values.viewbox.visibility.version.vert-adv-y.vert-origin-x.vert-origin-y.width.word-spacing.wrap.writing-mode.xchannelselector.ychannelselector.x.x1.x2.xmlns.y.y1.y2.z.zoomandpan`.split(`.`)),_e=a(`accent.accentunder.align.bevelled.close.columnalign.columnlines.columnspacing.columnspan.denomalign.depth.dir.display.displaystyle.encoding.fence.frame.height.href.id.largeop.length.linethickness.lquote.lspace.mathbackground.mathcolor.mathsize.mathvariant.maxsize.minsize.movablelimits.notation.numalign.open.rowalign.rowlines.rowspacing.rowspan.rspace.rquote.scriptlevel.scriptminsize.scriptsizemultiplier.selection.separator.separators.stretchy.subscriptshift.supscriptshift.symmetric.voffset.width.xmlns`.split(`.`)),ve=a([`xlink:href`,`xml:id`,`xlink:title`,`xml:space`,`xmlns:xlink`]),ye=o(/\{\{[\w\W]*|[\w\W]*\}\}/gm),be=o(/<%[\w\W]*|[\w\W]*%>/gm),xe=o(/\$\{[\w\W]*/gm),Se=o(/^data-[\-\w.\u00B7-\uFFFF]+$/),Ce=o(/^aria-[\-\w]+$/),we=o(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp|matrix):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),A=o(/^(?:\w+script|data):/i),Te=o(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),Ee=o(/^html$/i),De=o(/^[a-z][.\w]*(-[.\w]+)+$/i),Oe=Object.freeze({__proto__:null,ARIA_ATTR:Ce,ATTR_WHITESPACE:Te,CUSTOM_ELEMENT:De,DATA_ATTR:Se,DOCTYPE_NAME:Ee,ERB_EXPR:be,IS_ALLOWED_URI:we,IS_SCRIPT_OR_DATA:A,MUSTACHE_EXPR:ye,TMPLIT_EXPR:xe}),ke={element:1,text:3,progressingInstruction:7,comment:8,document:9},Ae=function(){return typeof window>`u`?null:window},je=function(e,t){if(typeof e!=`object`||typeof e.createPolicy!=`function`)return null;let n=null,r=`data-tt-policy-suffix`;t&&t.hasAttribute(r)&&(n=t.getAttribute(r));let i=`dompurify`+(n?`#`+n:``);try{return e.createPolicy(i,{createHTML(e){return e},createScriptURL(e){return e}})}catch{return console.warn(`TrustedTypes policy `+i+` could not be created.`),null}},Me=function(){return{afterSanitizeAttributes:[],afterSanitizeElements:[],afterSanitizeShadowDOM:[],beforeSanitizeAttributes:[],beforeSanitizeElements:[],beforeSanitizeShadowDOM:[],uponSanitizeAttribute:[],uponSanitizeElement:[],uponSanitizeShadowNode:[]}};function Ne(){let t=arguments.length>0&&arguments[0]!==void 0?arguments[0]:Ae(),n=e=>Ne(e);if(n.version=`3.4.2`,n.removed=[],!t||!t.document||t.document.nodeType!==ke.document||!t.Element)return n.isSupported=!1,n;let{document:r}=t,i=r,o=i.currentScript,{DocumentFragment:c,HTMLTemplateElement:l,Node:te,Element:ne,NodeFilter:re,NamedNodeMap:ie=t.NamedNodeMap||t.MozNamedAttrMap,HTMLFormElement:ae,DOMParser:C,trustedTypes:se}=t,T=ne.prototype,ye=D(T,`cloneNode`),be=D(T,`remove`),xe=D(T,`nextSibling`),Se=D(T,`childNodes`),Ce=D(T,`parentNode`);if(typeof l==`function`){let e=r.createElement(`template`);e.content&&e.content.ownerDocument&&(r=e.content.ownerDocument)}let A,Te=``,{implementation:De,createNodeIterator:j,createDocumentFragment:Pe,getElementsByTagName:Fe}=r,{importNode:Ie}=i,M=Me();n.isSupported=typeof e==`function`&&typeof Ce==`function`&&De&&De.createHTMLDocument!==void 0;let{MUSTACHE_EXPR:Le,ERB_EXPR:Re,TMPLIT_EXPR:ze,DATA_ATTR:Be,ARIA_ATTR:Ve,IS_SCRIPT_OR_DATA:He,ATTR_WHITESPACE:Ue,CUSTOM_ELEMENT:We}=Oe,{IS_ALLOWED_URI:Ge}=Oe,N=null,Ke=w({},[...O,...k,...ue,...fe,...me]),P=null,qe=w({},[...he,...ge,..._e,...ve]),F=Object.seal(s(null,{tagNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeNameCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},allowCustomizedBuiltInElements:{writable:!0,configurable:!1,enumerable:!0,value:!1}})),I=null,Je=null,L=Object.seal(s(null,{tagCheck:{writable:!0,configurable:!1,enumerable:!0,value:null},attributeCheck:{writable:!0,configurable:!1,enumerable:!0,value:null}})),Ye=!0,Xe=!0,Ze=!1,Qe=!0,$e=!1,et=!0,R=!1,tt=!1,nt=!1,rt=!1,it=!1,at=!1,ot=!0,st=!1,ct=`user-content-`,lt=!0,ut=!1,dt={},z=null,ft=w({},[`annotation-xml`,`audio`,`colgroup`,`desc`,`foreignobject`,`head`,`iframe`,`math`,`mi`,`mn`,`mo`,`ms`,`mtext`,`noembed`,`noframes`,`noscript`,`plaintext`,`script`,`style`,`svg`,`template`,`thead`,`title`,`video`,`xmp`]),pt=null,mt=w({},[`audio`,`video`,`img`,`source`,`image`,`track`]),ht=null,gt=w({},[`alt`,`class`,`for`,`id`,`label`,`name`,`pattern`,`placeholder`,`role`,`summary`,`title`,`value`,`style`,`xmlns`]),_t=`http://www.w3.org/1998/Math/MathML`,vt=`http://www.w3.org/2000/svg`,B=`http://www.w3.org/1999/xhtml`,yt=B,bt=!1,xt=null,St=w({},[_t,vt,B],_),Ct=w({},[`mi`,`mo`,`mn`,`ms`,`mtext`]),wt=w({},[`annotation-xml`]),Tt=w({},[`title`,`style`,`font`,`a`,`script`]),Et=null,Dt=[`application/xhtml+xml`,`text/html`],V=null,Ot=null,kt=r.createElement(`form`),At=function(e){return e instanceof RegExp||e instanceof Function},jt=function(){let e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};if(Ot&&Ot===e)return;(!e||typeof e!=`object`)&&(e={}),e=E(e),Et=Dt.indexOf(e.PARSER_MEDIA_TYPE)===-1?`text/html`:e.PARSER_MEDIA_TYPE,V=Et===`application/xhtml+xml`?_:g,N=x(e,`ALLOWED_TAGS`)&&h(e.ALLOWED_TAGS)?w({},e.ALLOWED_TAGS,V):Ke,P=x(e,`ALLOWED_ATTR`)&&h(e.ALLOWED_ATTR)?w({},e.ALLOWED_ATTR,V):qe,xt=x(e,`ALLOWED_NAMESPACES`)&&h(e.ALLOWED_NAMESPACES)?w({},e.ALLOWED_NAMESPACES,_):St,ht=x(e,`ADD_URI_SAFE_ATTR`)&&h(e.ADD_URI_SAFE_ATTR)?w(E(gt),e.ADD_URI_SAFE_ATTR,V):gt,pt=x(e,`ADD_DATA_URI_TAGS`)&&h(e.ADD_DATA_URI_TAGS)?w(E(mt),e.ADD_DATA_URI_TAGS,V):mt,z=x(e,`FORBID_CONTENTS`)&&h(e.FORBID_CONTENTS)?w({},e.FORBID_CONTENTS,V):ft,I=x(e,`FORBID_TAGS`)&&h(e.FORBID_TAGS)?w({},e.FORBID_TAGS,V):E({}),Je=x(e,`FORBID_ATTR`)&&h(e.FORBID_ATTR)?w({},e.FORBID_ATTR,V):E({}),dt=x(e,`USE_PROFILES`)?e.USE_PROFILES&&typeof e.USE_PROFILES==`object`?E(e.USE_PROFILES):e.USE_PROFILES:!1,Ye=e.ALLOW_ARIA_ATTR!==!1,Xe=e.ALLOW_DATA_ATTR!==!1,Ze=e.ALLOW_UNKNOWN_PROTOCOLS||!1,Qe=e.ALLOW_SELF_CLOSE_IN_ATTR!==!1,$e=e.SAFE_FOR_TEMPLATES||!1,et=e.SAFE_FOR_XML!==!1,R=e.WHOLE_DOCUMENT||!1,rt=e.RETURN_DOM||!1,it=e.RETURN_DOM_FRAGMENT||!1,at=e.RETURN_TRUSTED_TYPE||!1,nt=e.FORCE_BODY||!1,ot=e.SANITIZE_DOM!==!1,st=e.SANITIZE_NAMED_PROPS||!1,lt=e.KEEP_CONTENT!==!1,ut=e.IN_PLACE||!1,Ge=le(e.ALLOWED_URI_REGEXP)?e.ALLOWED_URI_REGEXP:we,yt=typeof e.NAMESPACE==`string`?e.NAMESPACE:B,Ct=x(e,`MATHML_TEXT_INTEGRATION_POINTS`)&&e.MATHML_TEXT_INTEGRATION_POINTS&&typeof e.MATHML_TEXT_INTEGRATION_POINTS==`object`?E(e.MATHML_TEXT_INTEGRATION_POINTS):w({},[`mi`,`mo`,`mn`,`ms`,`mtext`]),wt=x(e,`HTML_INTEGRATION_POINTS`)&&e.HTML_INTEGRATION_POINTS&&typeof e.HTML_INTEGRATION_POINTS==`object`?E(e.HTML_INTEGRATION_POINTS):w({},[`annotation-xml`]);let t=x(e,`CUSTOM_ELEMENT_HANDLING`)&&e.CUSTOM_ELEMENT_HANDLING&&typeof e.CUSTOM_ELEMENT_HANDLING==`object`?E(e.CUSTOM_ELEMENT_HANDLING):s(null);if(F=s(null),x(t,`tagNameCheck`)&&At(t.tagNameCheck)&&(F.tagNameCheck=t.tagNameCheck),x(t,`attributeNameCheck`)&&At(t.attributeNameCheck)&&(F.attributeNameCheck=t.attributeNameCheck),x(t,`allowCustomizedBuiltInElements`)&&typeof t.allowCustomizedBuiltInElements==`boolean`&&(F.allowCustomizedBuiltInElements=t.allowCustomizedBuiltInElements),$e&&(Xe=!1),it&&(rt=!0),dt&&(N=w({},me),P=s(null),dt.html===!0&&(w(N,O),w(P,he)),dt.svg===!0&&(w(N,k),w(P,ge),w(P,ve)),dt.svgFilters===!0&&(w(N,ue),w(P,ge),w(P,ve)),dt.mathMl===!0&&(w(N,fe),w(P,_e),w(P,ve))),L.tagCheck=null,L.attributeCheck=null,x(e,`ADD_TAGS`)&&(typeof e.ADD_TAGS==`function`?L.tagCheck=e.ADD_TAGS:h(e.ADD_TAGS)&&(N===Ke&&(N=E(N)),w(N,e.ADD_TAGS,V))),x(e,`ADD_ATTR`)&&(typeof e.ADD_ATTR==`function`?L.attributeCheck=e.ADD_ATTR:h(e.ADD_ATTR)&&(P===qe&&(P=E(P)),w(P,e.ADD_ATTR,V))),x(e,`ADD_URI_SAFE_ATTR`)&&h(e.ADD_URI_SAFE_ATTR)&&w(ht,e.ADD_URI_SAFE_ATTR,V),x(e,`FORBID_CONTENTS`)&&h(e.FORBID_CONTENTS)&&(z===ft&&(z=E(z)),w(z,e.FORBID_CONTENTS,V)),x(e,`ADD_FORBID_CONTENTS`)&&h(e.ADD_FORBID_CONTENTS)&&(z===ft&&(z=E(z)),w(z,e.ADD_FORBID_CONTENTS,V)),lt&&(N[`#text`]=!0),R&&w(N,[`html`,`head`,`body`]),N.table&&(w(N,[`tbody`]),delete I.tbody),e.TRUSTED_TYPES_POLICY){if(typeof e.TRUSTED_TYPES_POLICY.createHTML!=`function`)throw oe(`TRUSTED_TYPES_POLICY configuration option must provide a "createHTML" hook.`);if(typeof e.TRUSTED_TYPES_POLICY.createScriptURL!=`function`)throw oe(`TRUSTED_TYPES_POLICY configuration option must provide a "createScriptURL" hook.`);A=e.TRUSTED_TYPES_POLICY,Te=A.createHTML(``)}else A===void 0&&(A=je(se,o)),A!==null&&typeof Te==`string`&&(Te=A.createHTML(``));a&&a(e),Ot=e},Mt=w({},[...k,...ue,...de]),Nt=w({},[...fe,...pe]),Pt=function(e){let t=Ce(e);(!t||!t.tagName)&&(t={namespaceURI:yt,tagName:`template`});let n=g(e.tagName),r=g(t.tagName);return xt[e.namespaceURI]?e.namespaceURI===vt?t.namespaceURI===B?n===`svg`:t.namespaceURI===_t?n===`svg`&&(r===`annotation-xml`||Ct[r]):!!Mt[n]:e.namespaceURI===_t?t.namespaceURI===B?n===`math`:t.namespaceURI===vt?n===`math`&&wt[r]:!!Nt[n]:e.namespaceURI===B?t.namespaceURI===vt&&!wt[r]||t.namespaceURI===_t&&!Ct[r]?!1:!Nt[n]&&(Tt[n]||!Mt[n]):!!(Et===`application/xhtml+xml`&&xt[e.namespaceURI]):!1},Ft=function(e){p(n.removed,{element:e});try{Ce(e).removeChild(e)}catch{be(e)}},It=function(e,t){try{p(n.removed,{attribute:t.getAttributeNode(e),from:t})}catch{p(n.removed,{attribute:null,from:t})}if(t.removeAttribute(e),e===`is`)if(rt||it)try{Ft(t)}catch{}else try{t.setAttribute(e,``)}catch{}},Lt=function(e){let t=null,n=null;if(nt)e=`<remove></remove>`+e;else{let t=v(e,/^[\r\n\t ]+/);n=t&&t[0]}Et===`application/xhtml+xml`&&yt===B&&(e=`<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>`+e+`</body></html>`);let i=A?A.createHTML(e):e;if(yt===B)try{t=new C().parseFromString(i,Et)}catch{}if(!t||!t.documentElement){t=De.createDocument(yt,`template`,null);try{t.documentElement.innerHTML=bt?Te:i}catch{}}let a=t.body||t.documentElement;return e&&n&&a.insertBefore(r.createTextNode(n),a.childNodes[0]||null),yt===B?Fe.call(t,R?`html`:`body`)[0]:R?t.documentElement:a},Rt=function(e){return j.call(e.ownerDocument||e,e,re.SHOW_ELEMENT|re.SHOW_COMMENT|re.SHOW_TEXT|re.SHOW_PROCESSING_INSTRUCTION|re.SHOW_CDATA_SECTION,null)},zt=function(e){return e instanceof ae&&(typeof e.nodeName!=`string`||typeof e.textContent!=`string`||typeof e.removeChild!=`function`||!(e.attributes instanceof ie)||typeof e.removeAttribute!=`function`||typeof e.setAttribute!=`function`||typeof e.namespaceURI!=`string`||typeof e.insertBefore!=`function`||typeof e.hasChildNodes!=`function`)},Bt=function(e){return typeof te==`function`&&e instanceof te};function Vt(e,t,r){u(e,e=>{e.call(n,t,r,Ot)})}let Ht=function(e){let t=null;if(Vt(M.beforeSanitizeElements,e,null),zt(e))return Ft(e),!0;let r=V(e.nodeName);if(Vt(M.uponSanitizeElement,e,{tagName:r,allowedTags:N}),et&&e.hasChildNodes()&&!Bt(e.firstElementChild)&&S(/<[/\w!]/g,e.innerHTML)&&S(/<[/\w!]/g,e.textContent)||et&&e.namespaceURI===B&&r===`style`&&Bt(e.firstElementChild)||e.nodeType===ke.progressingInstruction||et&&e.nodeType===ke.comment&&S(/<[/\w]/g,e.data))return Ft(e),!0;if(I[r]||!(L.tagCheck instanceof Function&&L.tagCheck(r))&&!N[r]){if(!I[r]&&Gt(r)&&(F.tagNameCheck instanceof RegExp&&S(F.tagNameCheck,r)||F.tagNameCheck instanceof Function&&F.tagNameCheck(r)))return!1;if(lt&&!z[r]){let t=Ce(e)||e.parentNode,n=Se(e)||e.childNodes;if(n&&t){let r=n.length;for(let i=r-1;i>=0;--i){let r=ye(n[i],!0);t.insertBefore(r,xe(e))}}}return Ft(e),!0}return e instanceof ne&&!Pt(e)||(r===`noscript`||r===`noembed`||r===`noframes`)&&S(/<\/no(script|embed|frames)/i,e.innerHTML)?(Ft(e),!0):($e&&e.nodeType===ke.text&&(t=e.textContent,u([Le,Re,ze],e=>{t=ee(t,e,` `)}),e.textContent!==t&&(p(n.removed,{element:e.cloneNode()}),e.textContent=t)),Vt(M.afterSanitizeElements,e,null),!1)},Ut=function(e,t,n){if(Je[t]||ot&&(t===`id`||t===`name`)&&(n in r||n in kt))return!1;let i=P[t]||L.attributeCheck instanceof Function&&L.attributeCheck(t,e);if(!(Xe&&!Je[t]&&S(Be,t))&&!(Ye&&S(Ve,t))){if(!i||Je[t]){if(!(Gt(e)&&(F.tagNameCheck instanceof RegExp&&S(F.tagNameCheck,e)||F.tagNameCheck instanceof Function&&F.tagNameCheck(e))&&(F.attributeNameCheck instanceof RegExp&&S(F.attributeNameCheck,t)||F.attributeNameCheck instanceof Function&&F.attributeNameCheck(t,e))||t===`is`&&F.allowCustomizedBuiltInElements&&(F.tagNameCheck instanceof RegExp&&S(F.tagNameCheck,n)||F.tagNameCheck instanceof Function&&F.tagNameCheck(n))))return!1}else if(!ht[t]&&!S(Ge,ee(n,Ue,``))&&!((t===`src`||t===`xlink:href`||t===`href`)&&e!==`script`&&y(n,`data:`)===0&&pt[e])&&!(Ze&&!S(He,ee(n,Ue,``)))&&n)return!1}return!0},Wt=w({},[`annotation-xml`,`color-profile`,`font-face`,`font-face-format`,`font-face-name`,`font-face-src`,`font-face-uri`,`missing-glyph`]),Gt=function(e){return!Wt[g(e)]&&S(We,e)},Kt=function(e){Vt(M.beforeSanitizeAttributes,e,null);let{attributes:t}=e;if(!t||zt(e))return;let r={attrName:``,attrValue:``,keepAttr:!0,allowedAttributes:P,forceKeepAttr:void 0},i=t.length;for(;i--;){let{name:a,namespaceURI:o,value:s}=t[i],c=V(a),l=s,d=a===`value`?l:b(l);if(r.attrName=c,r.attrValue=d,r.keepAttr=!0,r.forceKeepAttr=void 0,Vt(M.uponSanitizeAttribute,e,r),d=r.attrValue,st&&(c===`id`||c===`name`)&&y(d,ct)!==0&&(It(a,e),d=ct+d),et&&S(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i,d)){It(a,e);continue}if(c===`attributename`&&v(d,`href`)){It(a,e);continue}if(r.forceKeepAttr)continue;if(!r.keepAttr){It(a,e);continue}if(!Qe&&S(/\/>/i,d)){It(a,e);continue}$e&&u([Le,Re,ze],e=>{d=ee(d,e,` `)});let p=V(e.nodeName);if(!Ut(p,c,d)){It(a,e);continue}if(A&&typeof se==`object`&&typeof se.getAttributeType==`function`&&!o)switch(se.getAttributeType(p,c)){case`TrustedHTML`:d=A.createHTML(d);break;case`TrustedScriptURL`:d=A.createScriptURL(d);break}if(d!==l)try{o?e.setAttributeNS(o,a,d):e.setAttribute(a,d),zt(e)?Ft(e):f(n.removed)}catch{It(a,e)}}Vt(M.afterSanitizeAttributes,e,null)},qt=function(e){let t=null,n=Rt(e);for(Vt(M.beforeSanitizeShadowDOM,e,null);t=n.nextNode();)Vt(M.uponSanitizeShadowNode,t,null),Ht(t),Kt(t),t.content instanceof c&&qt(t.content);Vt(M.afterSanitizeShadowDOM,e,null)};return n.sanitize=function(e){let t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},r=null,a=null,o=null,s=null;if(bt=!e,bt&&(e=`<!-->`),typeof e!=`string`&&!Bt(e)&&(e=ce(e),typeof e!=`string`))throw oe(`dirty is not a string, aborting`);if(!n.isSupported)return e;if(tt||jt(t),n.removed=[],typeof e==`string`&&(ut=!1),ut){let t=e.nodeName;if(typeof t==`string`){let e=V(t);if(!N[e]||I[e])throw oe(`root node is forbidden and cannot be sanitized in-place`)}}else if(e instanceof te)r=Lt(`<!---->`),a=r.ownerDocument.importNode(e,!0),a.nodeType===ke.element&&a.nodeName===`BODY`||a.nodeName===`HTML`?r=a:r.appendChild(a);else{if(!rt&&!$e&&!R&&e.indexOf(`<`)===-1)return A&&at?A.createHTML(e):e;if(r=Lt(e),!r)return rt?null:at?Te:``}r&&nt&&Ft(r.firstChild);let l=Rt(ut?e:r);for(;o=l.nextNode();)Ht(o),Kt(o),o.content instanceof c&&qt(o.content);if(ut)return e;if(rt){if($e){r.normalize();let e=r.innerHTML;u([Le,Re,ze],t=>{e=ee(e,t,` `)}),r.innerHTML=e}if(it)for(s=Pe.call(r.ownerDocument);r.firstChild;)s.appendChild(r.firstChild);else s=r;return(P.shadowroot||P.shadowrootmode)&&(s=Ie.call(i,s,!0)),s}let d=R?r.outerHTML:r.innerHTML;return R&&N[`!doctype`]&&r.ownerDocument&&r.ownerDocument.doctype&&r.ownerDocument.doctype.name&&S(Ee,r.ownerDocument.doctype.name)&&(d=`<!DOCTYPE `+r.ownerDocument.doctype.name+`>
`+d),$e&&u([Le,Re,ze],e=>{d=ee(d,e,` `)}),A&&at?A.createHTML(d):d},n.setConfig=function(){jt(arguments.length>0&&arguments[0]!==void 0?arguments[0]:{}),tt=!0},n.clearConfig=function(){Ot=null,tt=!1},n.isValidAttribute=function(e,t,n){return Ot||jt({}),Ut(V(e),V(t),n)},n.addHook=function(e,t){typeof t==`function`&&p(M[e],t)},n.removeHook=function(e,t){if(t!==void 0){let n=d(M[e],t);return n===-1?void 0:m(M[e],n,1)[0]}return f(M[e])},n.removeHooks=function(e){M[e]=[]},n.removeAllHooks=function(){M=Me()},n}var j=Ne(),Pe=`poa-user-id`,Fe=`poa-user-name`,Ie=`poa-role`;function M(){return typeof crypto<`u`&&typeof crypto.randomUUID==`function`?crypto.randomUUID().replace(/-/g,``).slice(0,16):Array.from({length:16},()=>Math.floor(Math.random()*16).toString(16)).join(``)}function Le(){let e=localStorage.getItem(Pe);return e||(e=M(),localStorage.setItem(Pe,e)),e}function Re(){return localStorage.getItem(Fe)??`사용자`}function ze(e){localStorage.setItem(Fe,e.trim()||`사용자`)}function Be(){return Le()===`admin`||localStorage.getItem(Ie)===`admin`}function Ve(e){localStorage.setItem(Ie,e)}function He(){let e=new URLSearchParams(window.location.search).get(`role`);e&&Ve(e)}var Ue=class{execute(e){e.execute()}undo(){}redo(){}},We=class{name;constructor(e){this.name=e}},Ge=class extends We{tag;savedRange;ownerDocument;lastActionWasWrap=!1;wrappedElement=null;movedChildren=null;movedChildrenParent=null;movedChildrenAnchor=null;constructor(e,t,n){super(`format:${e}`),this.tag=e,this.savedRange=t.cloneRange(),this.ownerDocument=n}execute(){let e=this.savedRange.cloneRange();if(e.collapsed)return;let t=this.ownerDocument.getSelection();this.isTagActive(e)?(this.lastActionWasWrap=!1,this.removeFormat(e,t)):(this.lastActionWasWrap=!0,this.applyFormat(e,t))}undo(){this.lastActionWasWrap?this.undoWrap():this.undoRemove()}isTagActive(e){return this.findAncestor(e.commonAncestorContainer,this.tag)!==null}applyFormat(e,t){let n=this.ownerDocument.createElement(this.tag);try{let r=e.extractContents();if(n.appendChild(r),e.insertNode(n),this.wrappedElement=n,t){t.removeAllRanges();let e=this.ownerDocument.createRange();e.selectNodeContents(n),t.addRange(e)}}catch{}}removeFormat(e,t){let n=this.findAncestor(e.commonAncestorContainer,this.tag);if(!n||!n.parentNode)return;let r=n.parentNode,i=Array.from(n.childNodes),a=n.nextSibling;if(i.forEach(e=>r.insertBefore(e,n)),r.removeChild(n),this.movedChildren=i,this.movedChildrenParent=r,this.movedChildrenAnchor=a,t&&i.length>0){t.removeAllRanges();let e=this.ownerDocument.createRange();e.setStartBefore(i[0]),e.setEndAfter(i[i.length-1]),t.addRange(e)}}undoWrap(){if(!this.wrappedElement||!this.wrappedElement.parentNode)return;let e=this.wrappedElement.parentNode;Array.from(this.wrappedElement.childNodes).forEach(t=>e.insertBefore(t,this.wrappedElement)),e.removeChild(this.wrappedElement),this.wrappedElement=null}undoRemove(){if(!this.movedChildren||!this.movedChildrenParent)return;let e=this.ownerDocument.createElement(this.tag);this.movedChildren.forEach(t=>e.appendChild(t)),this.movedChildrenParent.insertBefore(e,this.movedChildrenAnchor),this.movedChildren=null,this.movedChildrenParent=null,this.movedChildrenAnchor=null}findAncestor(e,t){let n=e;for(;n;){if(n.nodeType===1&&n.tagName.toLowerCase()===t.toLowerCase())return n;n=n.parentNode}return null}},N=class{static async serialize(e){let t=new TextEncoder().encode(e);if(typeof CompressionStream>`u`)return t;let n=new CompressionStream(`gzip`),r=n.writable.getWriter();r.write(t).then(()=>r.close());let i=await new Response(n.readable).arrayBuffer();return new Uint8Array(i)}static async deserialize(e){if(!(e.length>=2&&e[0]===31&&e[1]===139)||typeof DecompressionStream>`u`)return new TextDecoder().decode(e);let t=new DecompressionStream(`gzip`),n=t.writable.getWriter();n.write(new Uint8Array(e)).then(()=>n.close());let r=await new Response(t.readable).arrayBuffer();return new TextDecoder().decode(r)}},Ke=class{entries=[];pointer=-1;maxSize=100;setInitial(e){let t=new TextEncoder().encode(e);this.entries=[{data:t,label:`initial`,isCheckpoint:!1}],this.pointer=0}async push(e,t,n=!1){this.entries.splice(this.pointer+1);let r=await N.serialize(e);this.entries.push({data:r,label:t,isCheckpoint:n}),this.pointer++,this.entries.length>this.maxSize+1&&(this.entries.shift(),this.pointer--)}async undo(){return this.canUndo()?(this.pointer--,N.deserialize(this.entries[this.pointer].data)):null}async redo(){return this.canRedo()?(this.pointer++,N.deserialize(this.entries[this.pointer].data)):null}canUndo(){return this.pointer>0}canRedo(){return this.pointer>=0&&this.pointer<this.entries.length-1}isInitialized(){return this.pointer>=0}getStackSize(){return this.entries.length}getCurrentLabel(){return this.pointer<0?null:this.entries[this.pointer].label}},P=class{config;commandManager;historyManager;root=null;inputTimer=null;inputHandler=()=>{this.inputTimer!==null&&clearTimeout(this.inputTimer),this.inputTimer=setTimeout(()=>{this.inputTimer=null,this.root&&this.historyManager.push(this.root.innerHTML,`input`).then(()=>{this.config.onHistoryPush?.()})},800)};keydownHandler=async e=>{(e.ctrlKey||e.metaKey)&&(e.key===`z`&&!e.shiftKey?(e.preventDefault(),await this.undo()):e.key===`y`||e.key===`z`&&e.shiftKey?(e.preventDefault(),await this.redo()):e.key===`b`?(e.preventDefault(),await this.bold()):e.key===`i`?(e.preventDefault(),await this.italic()):e.key===`u`&&(e.preventDefault(),await this.underline()))};constructor(e={}){this.config=e,this.commandManager=new Ue,this.historyManager=new Ke}mount(e){this.root=e,e.contentEditable=this.config.readonly?`false`:`true`,e.setAttribute(`role`,`textbox`),e.setAttribute(`aria-multiline`,`true`),this.config.placeholder&&(e.dataset.placeholder=this.config.placeholder),this.historyManager.setInitial(e.innerHTML),e.addEventListener(`input`,this.inputHandler),e.addEventListener(`keydown`,this.keydownHandler)}unmount(){this.root&&=(this.inputTimer!==null&&(clearTimeout(this.inputTimer),this.inputTimer=null),this.root.removeEventListener(`input`,this.inputHandler),this.root.removeEventListener(`keydown`,this.keydownHandler),this.root.contentEditable=`inherit`,this.root.removeAttribute(`role`),this.root.removeAttribute(`aria-multiline`),delete this.root.dataset.placeholder,null)}async execute(e){if(!this.root)throw Error(`EditorCore가 마운트되지 않았습니다.`);await this.flushInput(),this.commandManager.execute(e),await this.historyManager.push(this.root.innerHTML,e.name)}async undo(){if(!this.root)return;await this.flushInput();let e=await this.historyManager.undo();e!==null&&(this.root.innerHTML=j.sanitize(e))}async redo(){if(!this.root)return;let e=await this.historyManager.redo();e!==null&&(this.root.innerHTML=j.sanitize(e))}async flushInput(){this.inputTimer!==null&&(clearTimeout(this.inputTimer),this.inputTimer=null,this.root&&await this.historyManager.push(this.root.innerHTML,`input`))}async captureHistory(e){this.root&&await this.historyManager.push(this.root.innerHTML,e)}canUndo(){return this.historyManager.canUndo()}canRedo(){return this.historyManager.canRedo()}async bold(){await this.applyFormat(`strong`)}async italic(){await this.applyFormat(`em`)}async underline(){await this.applyFormat(`u`)}async applyFormatWithRange(e,t){if(!this.root)throw Error(`EditorCore가 마운트되지 않았습니다.`);let n=new Ge(e,t,this.root.ownerDocument);await this.execute(n)}async strike(){await this.applyFormat(`s`)}isMounted(){return this.root!==null}async applyFormat(e){if(!this.root)throw Error(`EditorCore가 마운트되지 않았습니다.`);let t=this.root.ownerDocument,n=t.getSelection();if(!n||n.rangeCount===0)return;let r=new Ge(e,n.getRangeAt(0),t);await this.execute(r)}},qe={bold:`strong`,italic:`em`,underline:`u`,strike:`s`},F=new class{listeners=new Map;on(e,t){this.listeners.has(e)||this.listeners.set(e,new Set),this.listeners.get(e).add(t)}off(e,t){this.listeners.get(e)?.delete(t)}emit(e,t){this.listeners.get(e)?.forEach(e=>e(t))}},I={FILE_NEW:`file:new`,FILE_OPENED:`file:opened`,FILE_SAVED:`file:saved`,FILE_DIRTY:`file:dirty`,AUTOSAVE_SAVED:`autosave:saved`,AUTOSAVE_RESTORED:`autosave:restored`,MENUBAR_CHANGE:`menubar:change`,VIEW_CHANGE:`view:change`,SETTINGS_CHANGED:`settings:changed`,PAGE_UPDATED:`page:updated`};function Je(e){return j.sanitize(e,{USE_PROFILES:{html:!0},FORBID_TAGS:[`script`,`object`,`embed`],FORBID_ATTR:[`onerror`,`onload`,`onclick`,`onmouseover`,`onfocus`,`onblur`]})}function L(e){return new DOMParser().parseFromString(e,`text/html`).body.textContent??``}function Ye(e){return e.split(`
`).map(e=>{let t=e.trim();return t===``?`<br>`:`<p>${Xe(t)}</p>`}).join(``)}function Xe(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function Ze(e){e.querySelectorAll(`input`).forEach(e=>{e.setAttribute(`value`,e.value)}),e.querySelectorAll(`textarea`).forEach(e=>{e.textContent=e.value}),e.querySelectorAll(`select`).forEach(e=>{let t=e.selectedIndex;Array.from(e.options).forEach((e,n)=>{n===t?e.setAttribute(`selected`,`selected`):e.removeAttribute(`selected`)})})}function Qe(e){return e.nodeType===Node.ELEMENT_NODE}var $e=new Set([`P`,`DIV`,`H1`,`H2`,`H3`,`H4`,`H5`,`H6`,`LI`,`BLOCKQUOTE`,`PRE`,`FIGURE`,`TD`,`TH`]);function et(e){return Qe(e)&&$e.has(e.tagName)}function R(e,t){let n=e;for(;n&&n!==t;){if(et(n))return n;n=n.parentNode}return null}function tt(e,t){if(t.collapsed){let n=R(t.startContainer,e);if(n)return[n];if(t.startContainer===e){let n=e.childNodes[t.startOffset],r=e.childNodes[t.startOffset-1];if(n&&et(n))return[n];if(r&&et(r))return[r]}return[]}let n=t.commonAncestorContainer;if(n!==e&&!n.contains(e)){let t=R(n,e);if(t)return[t]}let r=[];for(let n of Array.from(e.childNodes))et(n)&&t.intersectsNode(n)&&r.push(n);if(r.length>0)return r;let i=R(t.startContainer,e);return i?[i]:[]}function nt(e){let t=e.style.float||getComputedStyle(e).float;if(t===`left`)return`left`;if(t===`right`)return`right`;let n=e.style.marginLeft||getComputedStyle(e).marginLeft,r=e.style.marginRight||getComputedStyle(e).marginRight;return n===`auto`&&r===`auto`?`center`:`left`}function rt(e){let t=e.style.marginLeft||getComputedStyle(e).marginLeft,n=e.style.marginRight||getComputedStyle(e).marginRight;return t===`auto`&&n===`auto`?`center`:t===`auto`&&n!==`auto`?`right`:`left`}var it=new Set([`image/png`,`image/jpeg`,`image/gif`,`image/webp`,`image/bmp`]);function at(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function ot(e){return e.split(`
`).map(e=>{let t=e.trim();return t===``?`<br>`:`<p>${at(t)}</p>`}).join(``)}function st(e){return j.sanitize(e,{USE_PROFILES:{html:!0},ADD_ATTR:[`style`,`border`,`width`,`height`,`colspan`,`rowspan`,`cellpadding`,`cellspacing`],ADD_TAGS:[`table`,`tr`,`td`,`th`,`thead`,`tbody`,`tfoot`,`colgroup`,`col`]})}function ct(e){let t=new DOMParser().parseFromString(e,`text/html`);return t.querySelectorAll(`table`).forEach(e=>{e.style.borderCollapse=`collapse`,e.style.width||(e.style.width=`100%`),!e.style.border&&!e.getAttribute(`border`)&&(e.style.border=`1px solid #000000`)}),t.querySelectorAll(`td, th`).forEach(e=>{!e.style.border&&!e.style.borderTop&&(e.style.border=`1px solid #000000`),e.style.padding||(e.style.padding=`4px 8px`)}),t.body.innerHTML}function lt(e){return e.includes(`xmlns:x="urn:schemas-microsoft-com:office:excel"`)||e.includes(`mso-number-format`)||e.includes(`x:str`)}function ut(e){let t=new DOMParser().parseFromString(e,`text/html`);t.querySelectorAll(`[class^="xl"]`).forEach(e=>{e.removeAttribute(`class`)}),t.querySelectorAll(`td, th`).forEach(e=>{let t=(e.getAttribute(`style`)??``).split(`;`).filter(e=>!e.trim().startsWith(`mso-`)).join(`;`);e.setAttribute(`style`,t),!e.style.border&&!e.style.borderTop&&(e.style.border=`1px solid #000000`),e.style.padding||(e.style.padding=`4px 8px`)}),t.querySelectorAll(`table`).forEach(e=>{e.setAttribute(`border`,`1`),e.style.borderCollapse=`collapse`,e.style.width||(e.style.width=`100%`)});let n=t.querySelector(`table`);return n?st(n.outerHTML):``}var dt=class{root;options;pasteHandler=e=>{let t=e.clipboardData;if(!t)return;let n=t.getData(`text/html`);if(n){e.preventDefault();let t;if(t=lt(n)?ut(n):n.includes(`<table`)?st(ct(n)):Je(n),!t)return;this.insertAtCursor(t),this.options.onPaste?.(t);return}let r=t.getData(`text/plain`);if(r){e.preventDefault();let t=ot(r);if(!t)return;this.insertAtCursor(t),this.options.onPaste?.(t);return}let i=Array.from(t.items).find(e=>it.has(e.type));if(i){e.preventDefault();let t=i.getAsFile();if(!t)return;let n=new FileReader;n.onload=e=>{let t=e.target?.result;if(!t)return;let n=this.root.ownerDocument,r=n.createElement(`img`);r.src=t,r.style.maxWidth=`100%`,r.alt=`붙여넣기 이미지`;let i=n.getSelection();if(i&&i.rangeCount>0){let e=i.getRangeAt(0);e.deleteContents(),e.insertNode(r),e.setStartAfter(r),e.collapse(!0),i.removeAllRanges(),i.addRange(e)}else this.root.appendChild(r);this.options.onPasteImage?.()},n.readAsDataURL(t)}};constructor(e,t={}){this.root=e,this.options=t}register(){this.root.addEventListener(`paste`,this.pasteHandler)}unregister(){this.root.removeEventListener(`paste`,this.pasteHandler)}insertAtCursor(e){let t=this.root.ownerDocument.getSelection();if(!t||t.rangeCount===0)return;let n=t.getRangeAt(0);n.deleteContents();let r=n.createContextualFragment(e),i=r.lastChild;n.insertNode(r),i&&(n.setStartAfter(i),n.collapse(!0),t.removeAllRanges(),t.addRange(n))}},z=class{root;marks=[];currentIndex=-1;constructor(e){this.root=e}find(e,t={}){if(this.clearMarks(),!e.trim())return{count:0,current:-1};let n=this.buildRegex(e,t),r=this.collectTextNodes();for(let e=r.length-1;e>=0;e--){let t=r[e],i=t.nodeValue??``,a=[],o;for(;(o=n.exec(i))!==null;)a.push([o.index,o.index+o[0].length]);for(let e=a.length-1;e>=0;e--){let n=this.wrapRange(t,a[e][0],a[e][1]);n&&this.marks.unshift(n)}}return this.marks.length>0&&(this.currentIndex=0,this.applyHighlight()),{count:this.marks.length,current:this.marks.length>0?0:-1}}next(){return this.marks.length===0?{count:0,current:-1}:(this.currentIndex=(this.currentIndex+1)%this.marks.length,this.applyHighlight(),{count:this.marks.length,current:this.currentIndex})}prev(){return this.marks.length===0?{count:0,current:-1}:(this.currentIndex=(this.currentIndex-1+this.marks.length)%this.marks.length,this.applyHighlight(),{count:this.marks.length,current:this.currentIndex})}replaceCurrent(e){return this.marks.length===0||this.currentIndex<0?{count:0,current:-1}:(this.marks[this.currentIndex].replaceWith(this.root.ownerDocument.createTextNode(e)),this.marks.splice(this.currentIndex,1),this.marks.length===0?(this.currentIndex=-1,{count:0,current:-1,replaced:!0}):(this.currentIndex=Math.min(this.currentIndex,this.marks.length-1),this.applyHighlight(),{count:this.marks.length,current:this.currentIndex,replaced:!0}))}replaceAll(e,t,n={}){this.find(e,n);let r=this.marks.length,i=this.root.ownerDocument;for(let e of this.marks)e.replaceWith(i.createTextNode(t));return this.marks=[],this.currentIndex=-1,r}clearMarks(){for(let e of this.marks){if(!e.parentNode)continue;let t=e.ownerDocument.createDocumentFragment();for(;e.firstChild;)t.appendChild(e.firstChild);e.parentNode.replaceChild(t,e)}this.marks=[],this.currentIndex=-1}buildRegex(e,t){let n=e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`),r=t.wholeWord?`\\b${n}\\b`:n;return new RegExp(r,t.caseSensitive?`g`:`gi`)}collectTextNodes(){let e=[],t=this.root.ownerDocument.createTreeWalker(this.root,NodeFilter.SHOW_TEXT),n;for(;(n=t.nextNode())!==null;)n.nodeValue?.trim()&&e.push(n);return e}wrapRange(e,t,n){try{let r=e.ownerDocument,i=r.createRange();i.setStart(e,t),i.setEnd(e,n);let a=r.createElement(`mark`);return a.dataset.poaMark=`true`,i.surroundContents(a),a}catch{return null}}applyHighlight(){this.marks.forEach((e,t)=>{let n=t===this.currentIndex;e.style.background=n?`#F59E0B`:`#FEF3C7`,e.style.color=n?`#FFFFFF`:``,e.style.outline=``}),this.marks[this.currentIndex]?.scrollIntoView?.({block:`nearest`,behavior:`smooth`})}},ft=new Set([`jpg`,`jpeg`,`png`,`gif`,`webp`,`svg`]),pt=class{root;savedRange=null;constructor(e){this.root=e}saveSelection(){let e=this.root.ownerDocument.getSelection();e&&e.rangeCount>0&&(this.savedRange=e.getRangeAt(0).cloneRange())}insertFromUrl(e){if(!e.alt.trim())throw Error(`alt 텍스트는 필수입니다. 접근성을 위해 이미지 설명을 입력하세요.`);let t=this.buildImg(e);this.insertNode(t)}async uploadAndInsert(e,t,n){this.validateExtension(e.name);let r=await this.doUpload(e,n);this.insertFromUrl({...t,src:r})}validateExtension(e){let t=e.split(`.`).pop()?.toLowerCase()??``;if(!ft.has(t))throw Error(`지원하지 않는 파일 형식입니다. (허용: ${[...ft].join(`, `)})`)}async doUpload(e,t){let n=new FormData;n.append(t.fieldName??`file`,e);let r=await fetch(t.uploadUrl,{method:`POST`,headers:t.headers,body:n});if(!r.ok)throw Error(`업로드 실패: HTTP ${r.status}`);let i=await r.json();if(!i.url)throw Error(`서버에서 URL을 반환하지 않았습니다.`);return i.url}buildImg(e){let t=this.root.ownerDocument.createElement(`img`);return t.src=e.src,t.alt=e.alt,e.title&&(t.title=e.title),e.width&&(t.style.width=e.width),e.height&&(t.style.height=e.height),e.border&&(t.style.border=e.border),(e.align===`left`||e.align===`right`)&&(t.style.float=e.align),e.id&&(t.id=e.id),e.className&&(t.className=e.className),t}insertNode(e){let t=this.root.ownerDocument,n=t.getSelection(),r;this.savedRange?(r=this.savedRange.cloneRange(),this.savedRange=null):n&&n.rangeCount>0?r=n.getRangeAt(0):(r=t.createRange(),r.selectNodeContents(this.root),r.collapse(!1)),r.deleteContents(),r.insertNode(e),r.setStartAfter(e),r.collapse(!0),n?.removeAllRanges(),n?.addRange(r)}},mt=[{description:`HTML 파일`,accept:{"text/html":[`.html`,`.htm`]}}],ht=[{description:`HTML 파일`,accept:{"text/html":[`.html`,`.htm`]}},{description:`텍스트 파일`,accept:{"text/plain":[`.txt`]}}],gt=class{fileHandle=null;dirty=!1;currentName=`새 문서`;beforeUnloadHandler=e=>{this.dirty&&(e.preventDefault(),e.returnValue=``)};constructor(){window.addEventListener(`beforeunload`,this.beforeUnloadHandler)}destroy(){window.removeEventListener(`beforeunload`,this.beforeUnloadHandler)}isDirty(){return this.dirty}markDirty(){this.dirty=!0,F.emit(I.FILE_DIRTY,!0)}markClean(){this.dirty=!1,F.emit(I.FILE_DIRTY,!1)}getCurrentName(){return this.currentName}hasFileSystemAccess(){return typeof window<`u`&&`showOpenFilePicker`in window}newDocument(){this.fileHandle=null,this.currentName=`새 문서`,this.markClean(),F.emit(I.FILE_NEW,void 0)}async openFile(){return this.hasFileSystemAccess()?this.openWithFSA():this.openWithInput()}async openWithFSA(){try{let[e]=await window.showOpenFilePicker({types:ht,multiple:!1}),t=await e.getFile(),n=await t.text(),r=this.toHtml(t.name,n);this.fileHandle=e,this.currentName=t.name,this.markClean();let i={name:t.name,html:r};return F.emit(I.FILE_OPENED,i),i}catch(e){if(e.name!==`AbortError`)throw e;return null}}openWithInput(){return new Promise(e=>{let t=document.createElement(`input`);t.type=`file`,t.accept=`.html,.htm,.txt`,t.onchange=async()=>{let n=t.files?.[0];if(!n){e(null);return}let r=await n.text(),i=this.toHtml(n.name,r);this.fileHandle=null,this.currentName=n.name,this.markClean();let a={name:n.name,html:i};F.emit(I.FILE_OPENED,a),e(a)},t.addEventListener(`cancel`,()=>e(null)),t.click()})}async saveFile(e){return this.fileHandle?this.writeToHandle(this.fileHandle,e,this.currentName):this.saveAsFile(e)}async saveAsFile(e,t=`document.html`){return this.hasFileSystemAccess()?this.saveWithFSA(e,t):this.saveWithDownload(e,t)}async saveWithFSA(e,t){try{let n=await window.showSaveFilePicker({suggestedName:t,types:mt});return this.writeToHandle(n,e,n.name)}catch(e){if(e.name!==`AbortError`)throw e;return!1}}async writeToHandle(e,t,n){let r=await e.createWritable();return await r.write(t),await r.close(),this.fileHandle=e,this.currentName=n,this.markClean(),F.emit(I.FILE_SAVED,{name:n}),!0}saveWithDownload(e,t){let n=t.endsWith(`.txt`),r=n?L(e):e,i=new Blob([r],{type:`${n?`text/plain`:`text/html`};charset=utf-8`}),a=URL.createObjectURL(i),o=document.createElement(`a`);return o.href=a,o.download=t,o.click(),URL.revokeObjectURL(a),this.markClean(),F.emit(I.FILE_SAVED,{name:t}),!0}printDocument(e,t){let n=t??{top:25,right:30,bottom:25,left:30},r=document.createElement(`iframe`);r.style.cssText=`position:fixed;top:0;left:0;width:0;height:0;visibility:hidden;border:none;`,document.body.appendChild(r);let i=r.contentWindow,a=r.contentDocument;if(!i||!a){r.remove();return}let o=Array.from(document.querySelectorAll(`link[rel="stylesheet"]`)).map(e=>e.outerHTML).join(`
`),s=`
<style>
...
${o}
${s}
</head><body>${e}</body></html>`),a.close();let c=()=>{r.remove()};i.onafterprint=c,setTimeout(()=>{r.parentNode&&c()},2e3),i.focus(),i.print()}htmlToPlainText(e){return L(e)}toHtml(e,t){if(e.endsWith(`.txt`))return Ye(t);let n=Je(t);return this.normalizeTableCells(n)}normalizeTableCells(e){let t=new DOMParser().parseFromString(e,`text/html`);return t.querySelectorAll(`td, th`).forEach(e=>{e.style.verticalAlign||(e.style.verticalAlign=`middle`)}),t.body.innerHTML}},_t=(e,t)=>t.some(t=>e instanceof t),vt,B;function yt(){return vt||=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction]}function bt(){return B||=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey]}var xt=new WeakMap,St=new WeakMap,Ct=new WeakMap;function wt(e){let t=new Promise((t,n)=>{let r=()=>{e.removeEventListener(`success`,i),e.removeEventListener(`error`,a)},i=()=>{t(kt(e.result)),r()},a=()=>{n(e.error),r()};e.addEventListener(`success`,i),e.addEventListener(`error`,a)});return Ct.set(t,e),t}function Tt(e){if(xt.has(e))return;let t=new Promise((t,n)=>{let r=()=>{e.removeEventListener(`complete`,i),e.removeEventListener(`error`,a),e.removeEventListener(`abort`,a)},i=()=>{t(),r()},a=()=>{n(e.error||new DOMException(`AbortError`,`AbortError`)),r()};e.addEventListener(`complete`,i),e.addEventListener(`error`,a),e.addEventListener(`abort`,a)});xt.set(e,t)}var Et={get(e,t,n){if(e instanceof IDBTransaction){if(t===`done`)return xt.get(e);if(t===`store`)return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return kt(e[t])},set(e,t,n){return e[t]=n,!0},has(e,t){return e instanceof IDBTransaction&&(t===`done`||t===`store`)?!0:t in e}};function Dt(e){Et=e(Et)}function V(e){return bt().includes(e)?function(...t){return e.apply(At(this),t),kt(this.request)}:function(...t){return kt(e.apply(At(this),t))}}function Ot(e){return typeof e==`function`?V(e):(e instanceof IDBTransaction&&Tt(e),_t(e,yt())?new Proxy(e,Et):e)}function kt(e){if(e instanceof IDBRequest)return wt(e);if(St.has(e))return St.get(e);let t=Ot(e);return t!==e&&(St.set(e,t),Ct.set(t,e)),t}var At=e=>Ct.get(e);function jt(e,t,{blocked:n,upgrade:r,blocking:i,terminated:a}={}){let o=indexedDB.open(e,t),s=kt(o);return r&&o.addEventListener(`upgradeneeded`,e=>{r(kt(o.result),e.oldVersion,e.newVersion,kt(o.transaction),e)}),n&&o.addEventListener(`blocked`,e=>n(e.oldVersion,e.newVersion,e)),s.then(e=>{a&&e.addEventListener(`close`,()=>a()),i&&e.addEventListener(`versionchange`,e=>i(e.oldVersion,e.newVersion,e))}).catch(()=>{}),s}var Mt=[`get`,`getKey`,`getAll`,`getAllKeys`,`count`],Nt=[`put`,`add`,`delete`,`clear`],Pt=new Map;function Ft(e,t){if(!(e instanceof IDBDatabase&&!(t in e)&&typeof t==`string`))return;if(Pt.get(t))return Pt.get(t);let n=t.replace(/FromIndex$/,``),r=t!==n,i=Nt.includes(n);if(!(n in(r?IDBIndex:IDBObjectStore).prototype)||!(i||Mt.includes(n)))return;let a=async function(e,...t){let a=this.transaction(e,i?`readwrite`:`readonly`),o=a.store;return r&&(o=o.index(t.shift())),(await Promise.all([o[n](...t),i&&a.done]))[0]};return Pt.set(t,a),a}Dt(e=>({...e,get:(t,n,r)=>Ft(t,n)||e.get(t,n,r),has:(t,n)=>!!Ft(t,n)||e.has(t,n)}));var It=[`continue`,`continuePrimaryKey`,`advance`],Lt={},Rt=new WeakMap,zt=new WeakMap,Bt={get(e,t){if(!It.includes(t))return e[t];let n=Lt[t];return n||=Lt[t]=function(...e){Rt.set(this,zt.get(this)[t](...e))},n}};async function*Vt(...e){let t=this;if(t instanceof IDBCursor||(t=await t.openCursor(...e)),!t)return;t=t;let n=new Proxy(t,Bt);for(zt.set(n,t),Ct.set(n,At(t));t;)yield n,t=await(Rt.get(n)||t.continue()),Rt.delete(n)}function Ht(e,t){return t===Symbol.asyncIterator&&_t(e,[IDBIndex,IDBObjectStore,IDBCursor])||t===`iterate`&&_t(e,[IDBIndex,IDBObjectStore])}Dt(e=>({...e,get(t,n,r){return Ht(t,n)?Vt:e.get(t,n,r)},has(t,n){return Ht(t,n)||e.has(t,n)}}));var Ut=`poa-editor-autosave`,Wt=`snapshots`,Gt=10,Kt=300*1e3,qt=class{timer=null;intervalMs;constructor(e=Kt){this.intervalMs=e}start(e){this.stop(),this.timer=setInterval(()=>{this.saveNow(e())},this.intervalMs)}stop(){this.timer!==null&&(clearInterval(this.timer),this.timer=null)}isRunning(){return this.timer!==null}async saveNow(e){let t=(await this.openDB()).transaction(Wt,`readwrite`);await t.store.put({html:e,savedAt:Date.now()});let n=await t.store.getAllKeys();n.length>Gt&&await t.store.delete(n[0]),await t.done,F.emit(I.AUTOSAVE_SAVED,{savedAt:Date.now()})}async listSnapshots(){let e=await this.openDB(),[t,n]=await Promise.all([e.getAllKeys(Wt),e.getAll(Wt)]);return n.map((e,n)=>({id:t[n],html:e.html,savedAt:e.savedAt})).reverse()}async restoreSnapshot(e){return(await(await this.openDB()).get(Wt,e))?.html??null}async clearAll(){await(await this.openDB()).clear(Wt)}async openDB(){return jt(Ut,1,{upgrade(e){e.objectStoreNames.contains(Wt)||e.createObjectStore(Wt,{autoIncrement:!0})}})}},Jt=`poa-settings`,Yt={fontFamily:`맑은 고딕`,fontSize:11,lineHeight:1.5,autoSaveEnabled:!0,autoSaveInterval:5,spellCheck:!1,changeWarning:!0};function Xt(){try{let e=localStorage.getItem(Jt);return e?{...Yt,...JSON.parse(e)}:{...Yt}}catch{return{...Yt}}}function Zt(e){try{localStorage.setItem(Jt,JSON.stringify(e))}catch{}}var Qt=[`맑은 고딕`,`나눔고딕`,`나눔명조`,`굴림`,`돋움`,`바탕`,`궁서`,`Arial`,`Georgia`,`Times New Roman`,`Verdana`],$t=[8,9,10,11,12,14,16,18,20,24,28,32],en=[1,1.2,1.4,1.5,1.6,1.8,2,2.5],tn=[1,2,3,5,10,15,30],nn=`
:host { display: none; }
...
`;function rn(e,t,n){return`<option value="${e}"${n?` selected`:``}>${t}</option>`}var an=class extends HTMLElement{shadow;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${nn}</style>
    ...
    <div class="body">
      <div class="section">
        ...
        <div class="row">
          ...
          <div class="row-ctrl">
            <select id="sel-font-family">${Qt.map(e=>rn(e,e,!1)).join(``)}</select>
          </div>
        </div>
        <div class="row">
          <span class="row-label">글자 크기</span>
          <div class="row-ctrl">
            <select id="sel-font-size">${$t.map(e=>rn(String(e),`${e}pt`,!1)).join(``)}</select>
          </div>
        </div>
        <div class="row">
          <span class="row-label">줄 간격</span>
          <div class="row-ctrl">
            <select id="sel-line-height">${en.map(e=>rn(String(e),String(e),!1)).join(``)}</select>
          </div>
        </div>
      </div>
      <div class="section">
        ...
        <div class="row" id="row-interval">
          ...
          <div class="row-ctrl">
            <select id="sel-interval">${tn.map(e=>rn(String(e),`${e}분`,!1)).join(``)}</select>
          </div>
        </div>
      </div>
      <div class="section">
...
<div style="display:flex;justify-content:flex-end;gap:8px;margin-top:16px;">
  ...
  <button id="cp-ok" style="height:28px;padding:0 14px;border:1px solid #1565c0;border-radius:3px;background:#1565c0;color:#fff;cursor:pointer;">적용</button>
</div>`,a.appendChild(o),t.body.appendChild(a),o.querySelector(`#cp-bs`).value=i.borderStyle??`solid`;let d=o.querySelectorAll(`[data-va]`);d.forEach(e=>{e.addEventListener(`click`,()=>{d.forEach(e=>{e.style.cssText=`height:26px;padding:0 10px;border:1px solid #ccc;border-radius:3px;font-size:12px;cursor:pointer;background:#fff;color:#374151;transition:all .1s;`}),e.style.cssText=`height:26px;padding:0 10px;border:1px solid #1565c0;border-radius:3px;font-size:12px;cursor:pointer;background:#EFF6FF;color:#1565c0;font-weight:600;`})});let f=()=>a.remove();o.querySelector(`#cp-cancel`).addEventListener(`click`,f),a.addEventListener(`click`,e=>{e.target===a&&f()}),o.querySelector(`#cp-ok`).addEventListener(`click`,()=>{let e=o.querySelector(`[data-va][style*="#EFF6FF"]`),t={borderStyle:o.querySelector(`#cp-bs`).value,borderWidth:parseInt(o.querySelector(`#cp-bw`).value,10)||0,borderColor:o.querySelector(`#cp-bc`).value,indent:parseInt(o.querySelector(`#cp-ind`).value,10)||0,bgColor:o.querySelector(`#cp-bg`).value,fontSize:parseInt(o.querySelector(`#cp-fs`).value,10)||0,verticalAlign:e?.dataset.va??u,id:o.querySelector(`#cp-id`).value.trim(),className:o.querySelector(`#cp-cls`).value.trim()};for(let e of r)U.applyCellProperties(e,t);this.cb.onModified?.(),f()})}findCell(e){let t=e;for(;t;){if(t.nodeType===Node.ELEMENT_NODE){let e=t.tagName.toLowerCase();if(e===`td`||e===`th`)return t;if(e===`table`)break}t=t.parentNode}return null}},yn=`padding:6px 8px;overflow:hidden;word-break:break-word;`;function bn(e){return Array.from(e.querySelectorAll(`td,th`))}function xn(e){return Array.from(e.querySelectorAll(`thead td,thead th`))}function Sn(e){return Array.from(e.querySelectorAll(`tbody tr`))}function Cn(e){return`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="40" height="40">${e}</svg>`}var wn={"border-all":Cn(`
    ...
    <line x1="3"  y1="25" x2="37" y2="25" stroke="#bbb" stroke-width="1"/>`),"border-thick":Cn(`
    ...
    <line x1="2"  y1="25" x2="38" y2="25" stroke="#aaa" stroke-width="1"/>`),"header-light":Cn(`
    ...
    <line x1="25" y1="3" x2="25" y2="37" stroke="#ccc" stroke-width="1"/>`),"header-dark":Cn(`
    ...
    <line x1="25" y1="3" x2="25" y2="37" stroke="#888" stroke-width="1"/>`),"stripe-light":Cn(`
    ...
    <line x1="25" y1="3" x2="25" y2="37" stroke="#ddd" stroke-width="1"/>`),"stripe-dark":Cn(`
    ...
    <line x1="14" y1="3" x2="14" y2="37" stroke="#bbb" stroke-width="1"/>
    <line x1="25" y1="3" x2="25" y2="37" stroke="#bbb" stroke-width="1"/>`),borderless:Cn(`
    ...
    <line x1="3"  y1="25" x2="37" y2="25" stroke="#e0e0e0" stroke-width="1" stroke-dasharray="2,2"/>`),dashed:Cn(`
    ...
    <line x1="3"  y1="25" x2="37" y2="25" stroke="#999" stroke-width="1" stroke-dasharray="3,2"/>`)},Tn=[{id:`border-all`,label:`전체 테두리`,icon:wn[`border-all`],baseOptions:{width:`100%`,border:1,borderColor:`#cccccc`,headerPosition:`none`},apply:e=>{for(let t of bn(e))t.style.cssText=`border:1px solid #ccc;${yn}`}},{id:`border-thick`,label:`굵은 외부`,icon:wn[`border-thick`],baseOptions:{width:`100%`,border:1,borderColor:`#aaaaaa`,headerPosition:`none`},apply:e=>{for(let t of bn(e))t.style.cssText=`border:1px solid #aaa;${yn}`;e.style.boxShadow=`0 0 0 2px #333333`}},{id:`header-light`,label:`헤더 강조`,icon:wn[`header-light`],baseOptions:{width:`100%`,border:1,borderColor:`#cccccc`,headerPosition:`top`},apply:e=>{for(let t of bn(e))t.style.cssText=`border:1px solid #ccc;${yn}`;for(let t of xn(e))t.style.cssText=`border:1px solid #ccc;${yn}background:#f0f0f0;font-weight:bold;`}},{id:`header-dark`,label:`헤더 진한`,icon:wn[`header-dark`],baseOptions:{width:`100%`,border:1,borderColor:`#aaaaaa`,headerPosition:`top`},apply:e=>{for(let t of bn(e))t.style.cssText=`border:1px solid #aaa;${yn}`;for(let t of xn(e))t.style.cssText=`border:1px solid #555;${yn}background:#333333;color:#ffffff;font-weight:bold;`}},{id:`stripe-light`,label:`줄무늬`,icon:wn[`stripe-light`],baseOptions:{width:`100%`,border:1,borderColor:`#dddddd`,headerPosition:`none`},apply:e=>{for(let t of bn(e))t.style.cssText=`border:1px solid #ddd;${yn}`;Sn(e).forEach((e,t)=>{let n=t%2==0?`#f9f9f9`:``;for(let t of Array.from(e.querySelectorAll(`td,th`)))t.style.backgroundColor=n})}},{id:`stripe-dark`,label:`진한 줄무늬`,icon:wn[`stripe-dark`],baseOptions:{width:`100%`,border:1,borderColor:`#bbbbbb`,headerPosition:`none`},apply:e=>{for(let t of bn(e))t.style.cssText=`border:1px solid #bbb;${yn}`;Sn(e).forEach((e,t)=>{let n=t%2==0?`#e0e0e0`:``;for(let t of Array.from(e.querySelectorAll(`td,th`)))t.style.backgroundColor=n})}},{id:`borderless`,label:`테두리 없음`,icon:wn.borderless,baseOptions:{width:`100%`,border:0,headerPosition:`none`},apply:e=>{for(let t of bn(e))t.style.cssText=`border:none;${yn}`;e.removeAttribute(`border`)}},{id:`dashed`,label:`점선 테두리`,icon:wn.dashed,baseOptions:{width:`100%`,border:1,borderColor:`#999999`,headerPosition:`none`},apply:e=>{for(let t of bn(e))t.style.cssText=`border:1px dashed #999;${yn}`}}];function En(e,t){Tn.find(t=>t.id===e)?.apply(t)}var Dn=new Set([`http:`,`https:`,`mailto:`,`tel:`]);function On(e){if(e.startsWith(`#`))return e.length>1;try{let t=new URL(e);return Dn.has(t.protocol)}catch{return!1}}var kn=class{root;savedRange=null;constructor(e){this.root=e}saveSelection(){let e=this.root.ownerDocument.getSelection();e&&e.rangeCount>0&&(this.savedRange=e.getRangeAt(0).cloneRange())}insertLink(e){if(!On(e.href))throw Error(`유효하지 않은 URL입니다.`);let t=this.root.ownerDocument.createElement(`a`);t.href=e.href,e.title&&(t.title=e.title),e.target===`_blank`&&(t.target=`_blank`,t.rel=`noopener noreferrer`),t.textContent=this.savedRange?.toString().trim()||e.text.trim()||e.href,e.target===`_self`&&(t.target=`_self`),this.insertNode(t)}updateLink(e,t){if(t.href!==void 0){if(!On(t.href))throw Error(`유효하지 않은 URL입니다.`);e.href=t.href}t.text!==void 0&&(e.textContent=t.text),t.title!==void 0&&(e.title=t.title),t.target!==void 0&&(t.target===`_blank`?(e.target=`_blank`,e.rel=`noopener noreferrer`):(e.target=`_self`,e.removeAttribute(`rel`)))}removeLink(e){let t=e.parentNode;if(t){for(;e.firstChild;)t.insertBefore(e.firstChild,e);t.removeChild(e)}}getFocusedAnchor(){let e=this.root.ownerDocument.getSelection();if(!e||e.rangeCount===0)return null;let t=e.getRangeAt(0).startContainer;for(;t&&t!==this.root;){if(t.nodeType===Node.ELEMENT_NODE&&t.tagName===`A`)return t;t=t.parentNode}return null}insertNode(e){let t=this.root.ownerDocument,n=t.getSelection(),r;this.savedRange?(r=this.savedRange.cloneRange(),this.savedRange=null):n&&n.rangeCount>0?r=n.getRangeAt(0):(r=t.createRange(),r.selectNodeContents(this.root),r.collapse(!1)),r.deleteContents(),r.insertNode(e),r.setStartAfter(e),r.collapse(!0),n?.removeAllRanges(),n?.addRange(r)}};function An(){let e=new Uint8Array(6);return crypto.getRandomValues(e),Array.from(e,e=>e.toString(16).padStart(2,`0`)).join(``)}var jn=class{root;savedRange=null;constructor(e){this.root=e}saveSelection(){let e=this.root.ownerDocument.getSelection();e&&e.rangeCount>0&&(this.savedRange=e.getRangeAt(0).cloneRange())}insert(e){let t=`bm-${An()}`,n=this.root.ownerDocument.createElement(`a`);return n.id=t,n.setAttribute(`name`,t),n.className=`poa-bookmark`,n.setAttribute(`data-label`,e),n.title=e||t,n.textContent=`[${e||t}]`,n.contentEditable=`false`,this.insertAtRange(n),t}getAll(){return Array.from(this.root.querySelectorAll(`a.poa-bookmark[id^="bm-"]`)).map(e=>({id:e.id,label:e.getAttribute(`data-label`)??e.id,element:e}))}update(e,t){let n=this.root.querySelector(`a[id="${e}"]`);if(!n)throw Error(`책갈피 '${e}'를 찾을 수 없습니다.`);n.setAttribute(`data-label`,t),n.title=t,n.textContent=`[${t||e}]`}remove(e){this.root.querySelector(`a[id="${e}"]`)?.remove()}insertAtRange(e){let t=this.root.ownerDocument,n=t.getSelection(),r;this.savedRange?(r=this.savedRange.cloneRange(),this.savedRange=null):n&&n.rangeCount>0?r=n.getRangeAt(0):(r=t.createRange(),r.selectNodeContents(this.root),r.collapse(!1)),r.collapse(!0),r.insertNode(e),r.setStartAfter(e),r.collapse(!0),n?.removeAllRanges(),n?.addRange(r)}},Mn=[{dir:`nw`,cursor:`nw-resize`,top:`0`,left:`0`},{dir:`n`,cursor:`n-resize`,top:`0`,left:`50%`},{dir:`ne`,cursor:`ne-resize`,top:`0`,left:`100%`},{dir:`e`,cursor:`e-resize`,top:`50%`,left:`100%`},{dir:`se`,cursor:`se-resize`,top:`100%`,left:`100%`},{dir:`s`,cursor:`s-resize`,top:`100%`,left:`50%`},{dir:`sw`,cursor:`sw-resize`,top:`100%`,left:`0`},{dir:`w`,cursor:`w-resize`,top:`50%`,left:`0`}],Nn=20,Pn=class{root;cb;overlay=null;activeImg=null;dragging=!1;dragDir=`se`;dragStartX=0;dragStartY=0;dragStartW=0;dragStartH=0;constructor(e,t={}){this.root=e,this.cb=t}attach(){this.root.style.position||(this.root.style.position=`relative`),this.root.addEventListener(`click`,this.onRootClick,!0),this.root.addEventListener(`contextmenu`,this.onContextMenu),this.root.addEventListener(`input`,this.onContentInput),document.addEventListener(`mousemove`,this.onMouseMove),document.addEventListener(`mouseup`,this.onMouseUp)}detach(){this.deactivate(),this.root.removeEventListener(`click`,this.onRootClick,!0),this.root.removeEventListener(`contextmenu`,this.onContextMenu),this.root.removeEventListener(`input`,this.onContentInput),document.removeEventListener(`mousemove`,this.onMouseMove),document.removeEventListener(`mouseup`,this.onMouseUp)}getActiveImage(){return this.activeImg}syncOverlay(){this.updatePos()}deactivate(){this.overlay?.remove(),this.overlay=null,this.activeImg&&(this.activeImg=null,this.cb.onDeactivate?.())}activate(e){this.activeImg!==e&&(this.overlay?.remove(),this.activeImg=e,this.createOverlay(),this.cb.onActivate?.(e))}createOverlay(){if(!this.activeImg)return;let e=document.createElement(`div`);e.className=`poa-img-resize-overlay`,e.dataset.poaTemp=`true`,e.style.cssText=`position:absolute;border:2px solid #0078d7;pointer-events:none;z-index:10;box-sizing:border-box;`;for(let t of Mn){let n=document.createElement(`div`);n.dataset.dir=t.dir,n.style.cssText=`position:absolute;width:8px;height:8px;background:#0078d7;border:1px solid #fff;border-radius:1px;box-sizing:border-box;cursor:${t.cursor};top:${t.top};left:${t.left};transform:translate(-50%,-50%);pointer-events:all;z-index:11;`,n.addEventListener(`mousedown`,this.onHandleMouseDown),e.appendChild(n)}this.root.appendChild(e),this.overlay=e,this.updatePos()}updatePos(){if(!this.overlay||!this.activeImg)return;let e=this.activeImg.getBoundingClientRect(),t=this.root.getBoundingClientRect(),n=e.top-t.top+this.root.scrollTop,r=e.left-t.left+this.root.scrollLeft;Object.assign(this.overlay.style,{top:`${n}px`,left:`${r}px`,width:`${e.width}px`,height:`${e.height}px`})}onRootClick=e=>{let t=e.target;this.overlay?.contains(t)||(t.tagName===`IMG`?this.activate(t):this.deactivate())};onContextMenu=e=>{let t=e.target;if(t.tagName!==`IMG`)return;e.preventDefault();let n=t;this.activate(n),this.cb.onContextMenu?.(n,e.clientX,e.clientY)};onContentInput=()=>{this.activeImg&&!this.root.contains(this.activeImg)&&this.deactivate()};onHandleMouseDown=e=>{if(!this.activeImg)return;let t=e.currentTarget.dataset.dir;e.preventDefault(),e.stopPropagation();let n=this.activeImg.getBoundingClientRect();this.dragging=!0,this.dragDir=t,this.dragStartX=e.clientX,this.dragStartY=e.clientY,this.dragStartW=n.width,this.dragStartH=n.height,document.body.style.cursor=e.currentTarget.style.cursor,document.body.style.userSelect=`none`};onMouseMove=e=>{if(!this.dragging||!this.activeImg)return;let t=e.clientX-this.dragStartX,n=e.clientY-this.dragStartY,r=this.dragDir,i=this.root.clientWidth,a=this.dragStartW,o=this.dragStartH;(r===`e`||r===`ne`||r===`se`)&&(a=this.dragStartW+t),(r===`w`||r===`nw`||r===`sw`)&&(a=this.dragStartW-t),(r===`s`||r===`se`||r===`sw`)&&(o=this.dragStartH+n),(r===`n`||r===`ne`||r===`nw`)&&(o=this.dragStartH-n);let s=r===`nw`||r===`ne`||r===`sw`||r===`se`;if(e.shiftKey&&s&&this.dragStartH>0){let e=this.dragStartW/this.dragStartH;Math.abs(t)>=Math.abs(n)?o=a/e:a=o*e}a=Math.max(Nn,Math.min(i,a)),o=Math.max(Nn,o),this.activeImg.style.width=`${Math.round(a)}px`,this.activeImg.style.height=`${Math.round(o)}px`,this.updatePos(),this.cb.onResize?.(this.activeImg)};onMouseUp=()=>{this.dragging&&(this.dragging=!1,document.body.style.cursor=``,document.body.style.userSelect=``,this.activeImg&&(this.updatePos(),this.cb.onResizeEnd?.()))}},Fn=794,In=1123,Ln=24,Rn={top:60,right:80,bottom:60,left:80},zn=`poa-print-styles`,Bn=class{container=null;mount(e,t,n=[],r=Rn){this.container=e,e.innerHTML=``;let i=document.createElement(`div`);i.className=`poa-page-main`,i.style.cssText=`flex:1;overflow-y:auto;padding:20px;display:flex;flex-direction:column;align-items:center;background:#e8e8e8;`,this.injectPrintStyles(r);let a=this.splitByPageBreaks(t);for(let e of a)i.appendChild(this.buildPage(e,r));e.appendChild(i),n.length>0&&e.appendChild(this.buildSidebar(n))}unmount(){this.container&&=(this.container.innerHTML=``,null),document.getElementById(zn)?.remove()}getPageCount(e){return this.splitByPageBreaks(e).length}buildPage(e,t){let n=document.createElement(`div`);return n.className=`poa-a4-page`,n.style.cssText=[`width:${Fn}px`,`min-height:${In}px`,`background:#fff`,`box-shadow:0 2px 8px rgba(0,0,0,.2)`,`padding:${t.top}px ${t.right}px ${t.bottom}px ${t.left}px`,`box-sizing:border-box`,`margin-bottom:20px`,`position:relative`,`font-size:14px`,`line-height:1.6`].join(`;`),n.innerHTML=e,n}buildSidebar(e){let t=document.createElement(`div`);t.className=`poa-page-sidebar`,t.style.cssText=[`width:180px`,`flex-shrink:0`,`overflow-y:auto`,`background:#fafafa`,`border-left:1px solid #ddd`,`padding:12px`].join(`;`);let n=document.createElement(`div`);n.style.cssText=`font-size:12px;font-weight:600;color:#555;margin-bottom:8px;padding-bottom:6px;border-bottom:1px solid #eee;`,n.textContent=`책갈피`,t.appendChild(n);for(let n of e){let e=document.createElement(`a`);e.href=`#${n.id}`,e.textContent=n.label,e.style.cssText=`display:block;font-size:12px;color:#1976d2;text-decoration:none;padding:5px 0;border-bottom:1px solid #f0f0f0;`,e.addEventListener(`mouseenter`,()=>{e.style.textDecoration=`underline`}),e.addEventListener(`mouseleave`,()=>{e.style.textDecoration=`none`}),t.appendChild(e)}return t}splitByPageBreaks(e){let t=e.split(/<hr[^>]*class="[^"]*poa-page-break[^"]*"[^>]*\/?>|<div[^>]*class="[^"]*poa-page-break[^"]*"[^>]*>[\s\S]*?<\/div>/gi);return t.length>0?t:[e]}injectPrintStyles(e){if(document.getElementById(zn))return;let t=document.createElement(`style`);t.id=zn,t.textContent=`
@media print {
...
`,Vi=class extends HTMLElement{shadow;targetCell=null;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${Bi}</style>
...
`,Ui=class extends HTMLElement{shadow;activeTab=`video`;constructor(){super(),this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${Hi}</style>`}open(e=`video`){this.activeTab=e,this.setAttribute(`open`,``),this.render()}close(){this.removeAttribute(`open`)}render(){this.shadow.innerHTML=`<style>${Hi}</style>
<div class="overlay" id="overlay">
  ...
  </svg>`},Gi={text:`텍스트`,textarea:`여러 줄`,checkbox:`체크박스`,radio:`라디오`,select:`목록 선택`,button:`버튼`,date:`날짜 선택`},Ki=[`text`,`textarea`,`checkbox`,`radio`,`select`,`button`,`date`],qi=`
...
`;function q(e,t,n=``){return`<div class="field">
    <label>${e}</label>${t}${n?`<div class="hint">${n}</div>`:``}
  </div>`}function J(e,t=``,n=`text`){return`<input type="${n}" id="${e}" placeholder="${t}">`}function Ji(e,t){return`<select id="${e}">${t.map(([e,t])=>`<option value="${e}">${t}</option>`).join(``)}</select>`}var Yi=class extends HTMLElement{shadow;activeType=`text`;connectedCallback(){this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${qi}</style>${this._tpl()}`,this._buildTypeCards(),this._bindEvents(),this._setType(`text`)}open(e){let t=this.shadow.getElementById(`dlg-title`),n=this.shadow.getElementById(`btn-confirm`);t.textContent=e?`입력 요소 편집`:`입력 요소 추가`,n.textContent=e?`수정하기`:`추가하기`,e?(this._setType(e.type),this._fillFields(e)):(this._setType(`text`),this._clearFields()),this.setAttribute(`open`,``),this.shadow.getElementById(`f-label`)?.focus()}close(){this.removeAttribute(`open`)}_tpl(){return`<div class="dlg">
  <div class="hdr">
  ...
  <div class="ftr">
    ...
    <div class="adv-body" data-adv-body>${e}</div>`}_secText(){return`<div class="specific-section" id="sec-text">
      ${q(`항목 이름`,J(`f-label`,`예) 이름, 이메일 주소…`),`사용자에게 보여지는 항목 설명입니다`)}
      ${q(`안내 문구`,J(`f-text-ph`,`예) 홍길동`),`입력창 안에 표시되는 도움말입니다`)}
      ${this._adv(`
        <div class="chk-row" style="margin-bottom:10px">
          <input type="checkbox" id="f-aria-req"><label for="f-aria-req">필수 입력 항목으로 표시</label>
        </div>
        ${q(`최대 글자 수`,J(`f-text-ml`,`제한 없음`,`number`))}
        ${q(`기본값`,J(`f-text-val`,`미리 채울 내용`))}
        ${q(`name 속성`,J(`f-name`,`자동 생성`))}
      `)}
    </div>`}_secTextarea(){return`<div class="specific-section" id="sec-textarea">
      ${q(`항목 이름`,J(`f-ta-label`,`예) 내용, 자기소개…`))}
      ${q(`안내 문구`,J(`f-ta-ph`,`예) 간단하게 소개해 주세요`))}
      ${q(`줄 수`,`<input type="number" id="f-ta-rows" value="4" min="2" max="20" style="width:80px">`,`입력창의 기본 높이를 줄 수로 조정합니다`)}
      ${this._adv(`
        <div class="chk-row" style="margin-bottom:10px">
          <input type="checkbox" id="f-ta-req"><label for="f-ta-req">필수 입력 항목으로 표시</label>
        </div>
        ${q(`name 속성`,J(`f-ta-name`,`자동 생성`))}
      `)}
    </div>`}_secCheckbox(){return`<div class="specific-section" id="sec-checkbox">
      ${q(`체크박스 텍스트`,J(`f-cb-lbl`,`예) 개인정보 수집에 동의합니다`),`체크박스 옆에 표시되는 설명입니다`)}
      <div class="field">
        <div class="chk-row">
      ...
      ${this._adv(`
        ...
        ${q(`name 속성`,J(`f-cb-name`,`자동 생성`))}
      `)}
    </div>`}_secRadio(){return`<div class="specific-section" id="sec-radio">
      ${q(`그룹 제목`,J(`f-radio-label`,`예) 성별, 선호 연락 방법…`),`라디오 버튼 그룹 위에 표시되는 제목입니다`)}
      <div class="field">
        <label>선택지 목록</label>
      ...
      ${this._adv(`
        ...
        ${q(`name 속성`,J(`f-btn-name`,`자동 생성`))}
      `)}
    </div>`}_secDate(){return`<div class="specific-section" id="sec-date">
      ${q(`항목 이름`,J(`f-date-label`,`예) 생년월일, 예약일…`))}
      <div class="field">
        <div class="chk-row">
      ...
      ${this._adv(`
        ${q(`선택 가능한 시작일`,J(`f-date-min`,`YYYY-MM-DD`))}
        ${q(`선택 가능한 종료일`,J(`f-date-max`,`YYYY-MM-DD`))}
        ${q(`기본 날짜`,J(`f-date-val`,`YYYY-MM-DD`))}
        ${q(`name 속성`,J(`f-date-name`,`자동 생성`))}
      `)}
    </div>`}_buildTypeCards(){let e=this.shadow.getElementById(`type-grid`);for(let t of Ki){let n=document.createElement(`button`);n.type=`button`,n.className=`type-card`,n.dataset.type=t,n.innerHTML=`${Wi[t]}<span>${Gi[t]}</span>`,n.addEventListener(`click`,e=>{e.stopPropagation(),this._setType(t)}),e.appendChild(n)}}_bindEvents(){this.shadow.querySelector(`.x-btn`).addEventListener(`click`,()=>this.close()),this.shadow.getElementById(`btn-cancel`).addEventListener(`click`,()=>this.close()),this.shadow.getElementById(`btn-confirm`).addEventListener(`click`,()=>this._confirm()),this.shadow.getElementById(`add-radio-opt`).addEventListener(`click`,()=>{this._addRadioRow(),this._updatePreview()}),this.shadow.getElementById(`add-select-opt`).addEventListener(`click`,()=>{this._addSelectRow(),this._updatePreview()}),this.shadow.addEventListener(`click`,e=>{let t=e.target.closest(`[data-adv]`);t&&(t.classList.toggle(`open`),t.nextElementSibling?.classList.toggle(`show`))}),this.addEventListener(`click`,e=>{e.composedPath()[0]===this&&this.close()}),this.shadow.addEventListener(`input`,()=>this._updatePreview()),this.shadow.addEventListener(`change`,()=>this._updatePreview())}_setType(e){this.activeType=e,this.shadow.querySelectorAll(`.type-card`).forEach(t=>{t.classList.toggle(`active`,t.dataset.type===e)}),this.shadow.querySelectorAll(`.specific-section`).forEach(t=>{t.style.display=t.id===`sec-${e}`?`block`:`none`}),this._updatePreview()}_addRadioRow(e){let t=this.shadow.getElementById(`radio-opts`),n=document.createElement(`div`);n.className=`opt-row`;let r=document.createElement(`input`);r.type=`text`,r.className=`opt-label`,r.placeholder=`선택지 텍스트`,r.value=e?.label??``,r.addEventListener(`input`,()=>this._updatePreview());let i=document.createElement(`button`);i.type=`button`,i.title=`기본 선택`,i.style.cssText=`flex:none;width:28px;height:28px;border:1px solid #e5e7eb;border-radius:6px;background:none;cursor:pointer;font-size:14px;color:#d1d5db;`,i.textContent=`★`,e?.defaultChecked&&(i.style.color=`#f59e0b`,i.dataset.default=`1`),i.addEventListener(`click`,()=>{t.querySelectorAll(`button[title="기본 선택"]`).forEach(e=>{e.style.color=`#d1d5db`,delete e.dataset.default}),i.style.color=`#f59e0b`,i.dataset.default=`1`,this._updatePreview()});let a=document.createElement(`button`);a.type=`button`,a.className=`del-btn`,a.title=`삭제`,a.textContent=`✕`,a.addEventListener(`click`,()=>{n.remove(),this._updatePreview()}),n.appendChild(r),n.appendChild(i),n.appendChild(a),t.appendChild(n)}_addSelectRow(e){let t=this.shadow.getElementById(`select-opts`),n=document.createElement(`div`);n.className=`opt-row`;let r=document.createElement(`input`);r.type=`text`,r.className=`opt-label`,r.placeholder=`항목 텍스트`,r.value=e?.label??``,r.addEventListener(`input`,()=>this._updatePreview());let i=document.createElement(`button`);i.type=`button`,i.title=`기본 선택`,i.style.cssText=`flex:none;width:28px;height:28px;border:1px solid #e5e7eb;border-radius:6px;background:none;cursor:pointer;font-size:14px;color:#d1d5db;`,i.textContent=`★`,e?.selected&&(i.style.color=`#f59e0b`,i.dataset.default=`1`),i.addEventListener(`click`,()=>{t.querySelectorAll(`button[title="기본 선택"]`).forEach(e=>{e.style.color=`#d1d5db`,delete e.dataset.default}),i.style.color=`#f59e0b`,i.dataset.default=`1`,this._updatePreview()});let a=document.createElement(`button`);a.type=`button`,a.className=`del-btn`,a.title=`삭제`,a.textContent=`✕`,a.addEventListener(`click`,()=>{n.remove(),this._updatePreview()}),n.appendChild(r),n.appendChild(i),n.appendChild(a),t.appendChild(n)}_clearFields(){let e=(e,t)=>{let n=this.shadow.getElementById(e);n&&(n.value=t)},t=(e,t)=>{let n=this.shadow.getElementById(e);n&&(n.checked=t)};e(`f-label`,``),e(`f-text-ph`,``),e(`f-text-ml`,``),e(`f-text-val`,``),e(`f-name`,``),e(`f-ta-label`,``),e(`f-ta-ph`,``),e(`f-ta-rows`,`4`),e(`f-ta-name`,``),e(`f-cb-lbl`,``),e(`f-cb-name`,``),e(`f-radio-label`,``),e(`f-radio-gn`,``),e(`f-sel-label`,``),e(`f-sel-name`,``),e(`f-btn-text`,``),e(`f-btn-name`,``),e(`f-date-label`,``),e(`f-date-min`,``),e(`f-date-max`,``),e(`f-date-val`,``),e(`f-date-name`,``),t(`f-aria-req`,!1),t(`f-ta-req`,!1),t(`f-cb-checked`,!1),t(`f-cb-req`,!1),t(`f-sel-multi`,!1),t(`f-date-req`,!1);let n=this.shadow.querySelector(`input[name="btn-type"][value="button"]`);n&&(n.checked=!0);let r=this.shadow.getElementById(`f-btn-style`);r&&(r.value=`default`),this.shadow.getElementById(`radio-opts`).innerHTML=``,this._addRadioRow(),this._addRadioRow(),this.shadow.getElementById(`select-opts`).innerHTML=``,this._addSelectRow(),this._addSelectRow(),this.shadow.querySelectorAll(`[data-adv]`).forEach(e=>{e.classList.remove(`open`),e.nextElementSibling?.classList.remove(`show`)})}_fillFields(e){switch(this._clearFields(),e.type){case`text`:this._sv(`f-label`,e.label),this._sv(`f-text-ph`,e.placeholder),this._sv(`f-text-ml`,e.maxlength==null?``:String(e.maxlength)),this._sv(`f-text-val`,e.value),this._sv(`f-name`,e.name),this._sc(`f-aria-req`,e.ariaRequired);break;case`textarea`:this._sv(`f-ta-label`,e.label),this._sv(`f-ta-ph`,e.placeholder),this._sv(`f-ta-rows`,String(e.rows??4)),this._sv(`f-ta-name`,e.name),this._sc(`f-ta-req`,e.ariaRequired);break;case`checkbox`:this._sv(`f-cb-lbl`,e.checkLabel??e.label),this._sv(`f-cb-name`,e.name),this._sc(`f-cb-checked`,e.checked),this._sc(`f-cb-req`,e.ariaRequired);break;case`radio`:this._sv(`f-radio-label`,e.label),this._sv(`f-radio-gn`,e.groupName),this.shadow.getElementById(`radio-opts`).innerHTML=``,(e.options??[]).forEach(e=>this._addRadioRow(e)),e.options?.length||(this._addRadioRow(),this._addRadioRow());break;case`select`:this._sv(`f-sel-label`,e.label),this._sv(`f-sel-name`,e.name),this._sc(`f-sel-multi`,e.multiple),this.shadow.getElementById(`select-opts`).innerHTML=``,(e.options??[]).forEach(e=>this._addSelectRow(e)),e.options?.length||(this._addSelectRow(),this._addSelectRow());break;case`button`:this._sv(`f-btn-text`,e.text),this._sv(`f-btn-name`,e.name);let t=this.shadow.querySelector(`input[name="btn-type"][value="${e.btnType??`button`}"]`);t&&(t.checked=!0);let n=this.shadow.getElementById(`f-btn-style`);n&&(n.value=e.btnStyle??`default`);break;case`date`:this._sv(`f-date-label`,e.label),this._sv(`f-date-min`,e.min),this._sv(`f-date-max`,e.max),this._sv(`f-date-val`,e.value),this._sv(`f-date-name`,e.name),this._sc(`f-date-req`,e.ariaRequired);break}}_sv(e,t){let n=this.shadow.getElementById(e);n&&t!=null&&(n.value=t)}_sc(e,t){let n=this.shadow.getElementById(e);n&&(n.checked=t??!1)}_v(e){return(this.shadow.getElementById(e)?.value??``).trim()}_c(e){return this.shadow.getElementById(e)?.checked??!1}_buildConfig(){let e=Vr(this.activeType);switch(this.activeType){case`text`:return{type:`text`,label:this._v(`f-label`)||void 0,name:this._v(`f-name`)||void 0,id:e,placeholder:this._v(`f-text-ph`)||void 0,maxlength:Number(this._v(`f-text-ml`))||void 0,value:this._v(`f-text-val`)||void 0,ariaRequired:this._c(`f-aria-req`)||void 0,autoLabel:!0};case`textarea`:return{type:`textarea`,label:this._v(`f-ta-label`)||void 0,name:this._v(`f-ta-name`)||void 0,id:e,placeholder:this._v(`f-ta-ph`)||void 0,rows:Number(this._v(`f-ta-rows`))||4,ariaRequired:this._c(`f-ta-req`)||void 0,autoLabel:!0};case`checkbox`:return{type:`checkbox`,checkLabel:this._v(`f-cb-lbl`)||void 0,name:this._v(`f-cb-name`)||void 0,id:e,checked:this._c(`f-cb-checked`)||void 0,ariaRequired:this._c(`f-cb-req`)||void 0};case`radio`:{let t=[];this.shadow.getElementById(`radio-opts`).querySelectorAll(`.opt-row`).forEach(e=>{let n=e.querySelector(`.opt-label`).value.trim(),r=!!e.querySelector(`button[title="기본 선택"]`)?.dataset.default;n&&t.push({label:n,value:n,defaultChecked:r||void 0})});let n=this._v(`f-radio-gn`)||e;return{type:`radio`,label:this._v(`f-radio-label`)||void 0,name:n,groupName:n,id:e,options:t,autoLabel:!0}}case`select`:{let t=[];return this.shadow.getElementById(`select-opts`).querySelectorAll(`.opt-row`).forEach(e=>{let n=e.querySelector(`.opt-label`).value.trim(),r=!!e.querySelector(`button[title="기본 선택"]`)?.dataset.default;n&&t.push({label:n,value:n,selected:r||void 0})}),{type:`select`,label:this._v(`f-sel-label`)||void 0,name:this._v(`f-sel-name`)||void 0,id:e,multiple:this._c(`f-sel-multi`)||void 0,options:t,autoLabel:!0}}case`button`:{let t=this.shadow.querySelector(`input[name="btn-type"]:checked`)?.value??`button`,n=this.shadow.getElementById(`f-btn-style`)?.value??`default`;return{type:`button`,text:this._v(`f-btn-text`)||`버튼`,name:this._v(`f-btn-name`)||void 0,id:e,btnType:t,btnStyle:n}}case`date`:return{type:`date`,label:this._v(`f-date-label`)||void 0,name:this._v(`f-date-name`)||void 0,id:e,min:this._v(`f-date-min`)||void 0,max:this._v(`f-date-max`)||void 0,value:this._v(`f-date-val`)||void 0,ariaRequired:this._c(`f-date-req`)||void 0,autoLabel:!0}}}_updatePreview(){let e=this.shadow.getElementById(`preview-box`);if(e)try{let t=Ur(this._buildConfig());e.innerHTML=j.sanitize(t,{USE_PROFILES:{html:!0},ADD_ATTR:[`disabled`,`readonly`,`checked`,`selected`,`multiple`,`required`,`placeholder`,`maxlength`,`rows`,`cols`,`min`,`max`,`for`,`aria-required`,`aria-describedby`,`style`],FORBID_ATTR:[`onerror`,`onload`,`onclick`,`onmouseover`]})}catch{e.innerHTML=``}}_confirm(){let e=this._buildConfig();this.dispatchEvent(new CustomEvent(`poa-form-insert`,{bubbles:!0,composed:!0,detail:{config:e}})),this.close()}},Xi=`http://localhost:8080/api/v1`;function Zi(e){return`s-${e}`}function Qi(e){if(!e.startsWith(`s-`))return null;let t=Number(e.slice(2));return Number.isFinite(t)?t:null}function $i(e){return{id:Zi(e.id),type:`folder`,name:e.name,parentId:e.parentId===null?null:Zi(e.parentId),isPublic:e.isPublic,createdBy:e.createdBy??null,createdAt:new Date(e.createdAt).getTime(),updatedAt:new Date(e.updatedAt).getTime(),order:e.orderIndex}}function ea(e){return{id:Zi(e.id),type:`template`,name:e.name,parentId:e.folderId===null?null:Zi(e.folderId),content:e.content??``,isPublic:e.isPublic,...e.isTemp?{isTemp:!0}:{},createdBy:e.createdBy??null,createdAt:new Date(e.createdAt).getTime(),updatedAt:new Date(e.updatedAt).getTime(),order:e.orderIndex}}async function Y(e,t){let n=await fetch(`${Xi}${e}`,{...t,headers:{"Content-Type":`application/json`,"Poa-User-Id":Le(),...t?.headers??{}}});if(n.status===204)return;let r=await n.json();if(!r.success)throw Error(r.message??`API 오류`);return r.data}var X={async getFolders(){return(await Y(`/folders`)).map($i)},async createFolder(e){return $i(await Y(`/folders`,{method:`POST`,body:JSON.stringify(e)}))},async updateFolder(e,t){return $i(await Y(`/folders/${e}`,{method:`PUT`,body:JSON.stringify(t)}))},async deleteFolder(e){await Y(`/folders/${e}`,{method:`DELETE`})},async getTemplates(e){return(await Y(`/templates${e===void 0?``:`?folderId=${e}`}`)).map(ea)},async getTemplate(e){return ea(await Y(`/templates/${e}`))},async createTemplate(e){return ea(await Y(`/templates`,{method:`POST`,body:JSON.stringify(e)}))},async updateTemplate(e,t){return ea(await Y(`/templates/${e}`,{method:`PUT`,body:JSON.stringify(t)}))},async deleteTemplate(e){await Y(`/templates/${e}`,{method:`DELETE`})},async deleteTempTemplates(){await Y(`/templates/temp`,{method:`DELETE`})},async adminCleanup(){let e=()=>Y(`/admin/cleanup`,{method:`DELETE`});try{await e()}catch(t){console.error(`서버 정리 오류 (1차 시도):`,t),await new Promise(e=>setTimeout(e,500)),await e()}},async getAllNodes(){let[e,t]=await Promise.all([this.getFolders(),this.getTemplates()]);return[...e,...t]}},ta=`poa-templates`;function na(){return`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,7)}`}var ra=[{name:`공지사항 기본 양식`,content:`<h2>공지사항</h2><p><strong>제목:</strong>&nbsp;</p><p><strong>내용:</strong>&nbsp;</p><p><strong>담당자:</strong>&nbsp;</p><p><strong>날짜:</strong>&nbsp;</p>`},{name:`회의록 양식`,content:`<h2>회의록</h2><p><strong>일시:</strong>&nbsp;</p><p><strong>장소:</strong>&nbsp;</p><p><strong>참석자:</strong>&nbsp;</p><hr><h3>안건</h3><ol><li></li></ol><h3>결정사항</h3><ol><li></li></ol><h3>다음 회의</h3><p>&nbsp;</p>`},{name:`주간 보고서 양식`,content:`<h2>주간 보고서</h2><p><strong>기간:</strong>&nbsp;</p><p><strong>작성자:</strong>&nbsp;</p><hr><h3>이번 주 완료 업무</h3><ul><li></li></ul><h3>다음 주 계획</h3><ul><li></li></ul><h3>이슈 및 건의사항</h3><p>&nbsp;</p>`}],ia=class{nodes=[];constructor(){this._load(),this.nodes.length===0&&this._seed(),this._syncFromServer()}_load(){try{let e=localStorage.getItem(ta);this.nodes=e?JSON.parse(e):[]}catch{this.nodes=[]}this._cleanTemp(),this._cleanDuplicates()}_cleanDuplicates(){let e=new Map,t=new Map;for(let n of[...this.nodes].sort((e,t)=>e.createdAt-t.createdAt)){let r=`${n.type}|${n.parentId??``}|${n.name}`,i=e.get(r);i?t.set(n.id,i):e.set(r,n.id)}t.size!==0&&(this.nodes=this.nodes.filter(e=>!t.has(e.id)).map(e=>e.parentId&&t.has(e.parentId)?{...e,parentId:t.get(e.parentId)}:e),this._persist())}_cleanTemp(){let e=this.nodes.length;this.nodes=this.nodes.filter(e=>e.type===`template`?!(e.isTemp||e.name.startsWith(`임시_`)||e.name.startsWith(`preview_`)):!0),this.nodes.length!==e&&this._persist()}_persist(){try{localStorage.setItem(ta,JSON.stringify(this.nodes))}catch{this._evict();try{localStorage.setItem(ta,JSON.stringify(this.nodes))}catch{}}}_evict(){let e=this.nodes.filter(e=>e.type===`template`).sort((e,t)=>e.updatedAt-t.updatedAt)[0];e&&(this.nodes=this.nodes.filter(t=>t.id!==e.id))}_seed(){let e=new Set(this.nodes.map(e=>e.name)),t=this.nodes.find(e=>e.type===`folder`&&e.name===`공용 템플릿`&&e.parentId===null);t||(t={id:na(),type:`folder`,name:`공용 템플릿`,parentId:null,isPublic:!0,createdAt:Date.now(),updatedAt:Date.now(),order:0},this.nodes.push(t)),e.has(`내 템플릿`)||this.nodes.push({id:na(),type:`folder`,name:`내 템플릿`,parentId:null,isPublic:!1,createdAt:Date.now(),updatedAt:Date.now(),order:1}),ra.forEach((n,r)=>{if(e.has(n.name))return;let i=String(j.sanitize(n.content,{USE_PROFILES:{html:!0}}));this.nodes.push({id:na(),type:`template`,name:n.name,parentId:t.id,content:i,isPublic:!0,createdAt:Date.now(),updatedAt:Date.now(),order:r})}),this._persist()}reload(){this._load()}async _syncFromServer(){try{let e=await X.getAllNodes();if(e.length===0)return;try{localStorage.removeItem(ta)}catch{}let t=this.nodes.filter(e=>e.isTemp);this.nodes=[...e,...t],this._persist()}catch{console.warn(`API 서버 연결 실패. LocalStorage 모드로 동작합니다.`)}}getAll(){return[...this.nodes]}getById(e){return this.nodes.find(t=>t.id===e)??null}getChildren(e){return this.nodes.filter(t=>t.parentId===e).sort((e,t)=>e.order-t.order||e.name.localeCompare(t.name))}getRoots(){return this.getChildren(null)}getFolders(){return this.nodes.filter(e=>e.type===`folder`)}addFolder(e,t,n=!1){let r={id:na(),type:`folder`,name:e,parentId:t,isPublic:n,createdBy:n?null:Le(),createdAt:Date.now(),updatedAt:Date.now(),order:this.getChildren(t).length};this.nodes.push(r),this._persist();let i=t?Qi(t):null;return X.createFolder({parentId:i,name:r.name,isPublic:r.isPublic,orderIndex:r.order}).then(e=>{r.id=e.id,this._persist()}).catch(()=>{}),r}addTemplate(e,t,n,r=!1,i=!1){let a=String(j.sanitize(t,{USE_PROFILES:{html:!0}})),o={id:na(),type:`template`,name:e,parentId:n,content:a,isPublic:r,...i?{isTemp:!0}:{},createdBy:r?null:Le(),createdAt:Date.now(),updatedAt:Date.now(),order:this.getChildren(n).length};if(this.nodes.push(o),this._persist(),!i){let e=n?Qi(n):null;X.createTemplate({folderId:e,name:o.name,content:o.content??``,isPublic:o.isPublic,isTemp:!1,orderIndex:o.order}).then(e=>{o.id=e.id,this._persist()}).catch(()=>{})}return o}rename(e,t){let n=this.nodes.find(t=>t.id===e);if(!n||!t.trim())return!1;n.name=t.trim(),n.updatedAt=Date.now(),this._persist();let r=Qi(e);return r!==null&&(n.type===`folder`?X.updateFolder(r,{parentId:n.parentId?Qi(n.parentId)??null:null,name:n.name,isPublic:n.isPublic,orderIndex:n.order}).catch(()=>{}):X.updateTemplate(r,{folderId:n.parentId?Qi(n.parentId)??null:null,name:n.name,isPublic:n.isPublic,orderIndex:n.order}).catch(()=>{})),!0}delete(e){let t=this.nodes.find(t=>t.id===e)?.type,n=Qi(e);for(let t of this.getChildren(e))this.delete(t.id);this.nodes=this.nodes.filter(t=>t.id!==e),this._persist(),n!==null&&(t===`folder`?X.deleteFolder(n):X.deleteTemplate(n)).catch(()=>{})}move(e,t){let n=this.nodes.find(t=>t.id===e);if(!n||this._isDescendant(t,e))return!1;n.parentId=t,n.order=this.getChildren(t).filter(t=>t.id!==e).length,n.updatedAt=Date.now(),this._persist();let r=Qi(e);if(r!==null){let e=t?Qi(t)??null:null;n.type===`folder`?X.updateFolder(r,{parentId:e,name:n.name,isPublic:n.isPublic,orderIndex:n.order}).catch(()=>{}):X.updateTemplate(r,{folderId:e,name:n.name,isPublic:n.isPublic,orderIndex:n.order}).catch(()=>{})}return!0}_isDescendant(e,t){if(e===null)return!1;if(e===t)return!0;let n=this.nodes.find(t=>t.id===e);return n?this._isDescendant(n.parentId,t):!1}},aa=`
<svg
...
`;function Wo(e,t){return e.replace(/width="24"/,`width="${t}"`).replace(/height="24"/,`height="${t}"`)}function Z(e){return Wo(e,16)}function Go(e){return Wo(e,14)}function Ko(e){return Wo(e,12)}var Q={bold:Z(fa),italic:Z(Va),underline:Z(Bo),strike:Z(Do),undo:Z(Vo),redo:Z(po),alignLeft:Z(Lo),alignCenter:Z(Po),alignRight:Z(Fo),alignJustify:Z(Io),indent:Z(Ya),outdent:Z(Ja),foreColor:Z(ua),backColor:Z(Ia),lineHeight:Z(da),letterSpacing:Z(ro),fileNew:Z(Oa),fileOpen:Z(Ma),save:Z(_o),fileSaveAs:Z(Da),print:Z(uo),settings:Z(xo),clock:Z(Sa),cut:Z(vo),copy:Z(Ta),paste:Z(xa),pastePlain:Z(ba),selectAll:Z(Eo),search:Z(yo),imageEdit:Z(La),image:Z(Ra),images:Z(za),videoTag:Z(ja),embedVideo:Z(va),link:Z(qa),linkOff:Z(Ka),bookmark:Z(ma),signature:Z(so),emoji:Z(wo),tooltip:Z($a),tooltipList:Z(eo),calendar:Z(ha),hr:Z(to),symbol:Z(io),youtube:Z(no),pageBreak:Z(bo),template:Z(Ga),formField:Z(fo),viewDesign:Z(Ua),viewHtml:Z(Ca),viewPreview:Z(Ea),viewText:Z(zo),viewPage:Z(ka),fullscreen:Z(Qa),ruler:Z(go),grid:Z(Pa),hiddenBorder:Z(Eo),table:Z(No),tableProps:Z(Mo),cellProps:Z(Wa),mergeCells:Z(Ao),splitCell:Z(jo),rowAbove:Z(la),rowBelow:Z(oa),colLeft:Z(sa),colRight:Z(ca),rowDelete:Z(ho),colDelete:Z(wa),tableDelete:Z(Ro),painterCopy:Z(ao),painterPaste:Z(oo),formatClear:Z(mo),ul:Z(Za),ol:Z(Xa),sup:Z(ko),sub:Z(Oo),a11y:Z(aa),privacy:Z(So),form:Z(To),calc:Z(Co),userMode:Z(Ho),shortcuts:Z(Ha),guide:Z(pa),about:Z(Ba),folder:Z(Na),folderOpen:Z(Ma),file:Z(Aa),fileText16:Z(ka),users16:Z(Uo),user16:Z(Ho),userCircle:Z(ya),plus:Z(lo),pencil:Z(co),trash:Z(Ro),link16:Z(qa),chevronRight:Z(_a),chevronDown:Z(ga),folder14:Go(Na),folderOpen14:Go(Ma),file14:Go(Aa),fileText14:Go(ka),users14:Go(Uo),user14:Go(Ho),chevronRight12:Ko(_a),chevronDown12:Ko(ga),users12:Ko(Uo),user12:Ko(Ho),fieldText:Go(zo),fieldNumber:Go(Fa),fieldDate:Go(ha),layoutTemplate48:Wo(Ga,48)},qo={"file:new":`fileNew`,"file:open":`fileOpen`,"file:save":`save`,"file:saveas":`fileSaveAs`,"file:print":`print`,settings:`settings`,"edit:cut":`cut`,"edit:copy":`copy`,"edit:paste":`paste`,"edit:paste-plain":`pastePlain`,"edit:select-all":`selectAll`,"find-replace":`search`,"edit:image-edit":`imageEdit`,image:`image`,"insert:multi-image":`images`,"insert:video":`videoTag`,"insert:embed":`embedVideo`,"insert:link":`link`,"insert:link-remove":`linkOff`,"insert:bookmark":`bookmark`,"insert:signature":`signature`,"insert:emoji":`emoji`,"insert:tooltip":`tooltip`,"insert:tooltip-list":`tooltipList`,"insert:datetime":`calendar`,"insert:hr":`hr`,"insert:symbol":`symbol`,"insert:pagebreak":`pageBreak`,"misc:template":`template`,"view:design":`viewDesign`,"view:html":`viewHtml`,"view:preview":`viewPreview`,"view:text":`viewText`,"view:page":`viewPage`,"view:fullscreen":`fullscreen`,"view:ruler":`ruler`,"view:grid":`grid`,"view:hidden-border":`hiddenBorder`,table:`table`,"table:table-props":`tableProps`,"table:cell-props":`cellProps`,"table:merge":`mergeCells`,"table:split-cell":`splitCell`,"table:row-above":`rowAbove`,"table:row-below":`rowBelow`,"table:col-left":`colLeft`,"table:col-right":`colRight`,"table:row-delete":`rowDelete`,"table:col-delete":`colDelete`,"table:delete":`tableDelete`,"table:align-left":`alignLeft`,"table:align-center":`alignCenter`,"table:align-right":`alignRight`,"format:painter-copy":`painterCopy`,"format:painter-paste":`painterPaste`,"format:clear":`formatClear`,"format:ul":`ul`,"format:ol":`ol`,"format:sup":`sup`,"format:sub":`sub`,"misc:a11y":`a11y`,"misc:privacy":`privacy`,"misc:form":`form`,"misc:calc":`calc`,"misc:user-mode":`userMode`,"help:shortcuts":`shortcuts`,"help:guide":`guide`,"help:about":`about`},Jo=`
*, *::before, *::after { box-sizing: border-box; }
...
`,Yo=class extends HTMLElement{shadow;mgr;expanded=new Set;selectedId=null;editingId=null;ctxMenu=null;filterQuery=``;connectedCallback(){this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${Jo}</style><div id="tree"></div>`}setManager(e){this.mgr=e,e.getRoots().filter(e=>e.type===`folder`).forEach(e=>this.expanded.add(e.id)),this.render()}setFilter(e){this.filterQuery=e.trim().toLowerCase(),this.render()}render(){if(!this.mgr)return;let e=this.shadow.getElementById(`tree`);e.innerHTML=``;let t=this.mgr.getAll(),n=this.filterQuery,r=t.filter(e=>e.parentId===null&&e.isPublic),i=t.filter(e=>e.parentId===null&&!e.isPublic);e.appendChild(this._renderSection(`공용 템플릿`,`public`,r,n)),e.appendChild(this._renderSection(`내 템플릿`,`private`,i,n))}getSelected(){return this.selectedId?this.mgr.getById(this.selectedId):null}addFolder(e,t=!1){e&&this.expanded.add(e);let n=this.mgr.addFolder(`새 폴더`,e,t);this.editingId=n.id,this.render()}_renderSection(e,t,n,r){let i=document.createElement(`div`);t===`private`&&i.classList.add(`section-private`);let a=document.createElement(`div`);a.className=`section-hdr`,a.innerHTML=`${t===`public`?Q.users12:Q.user12}<span>${e}</span>`,i.appendChild(a);let o=r?n.filter(e=>this._subtreeMatches(e,r)):n;if(o.length===0){let e=document.createElement(`div`);e.className=`empty-section`,r?e.textContent=`검색 결과 없음`:e.textContent=t===`public`?`등록된 공용 템플릿이 없습니다.`:`등록된 개인 템플릿이 없습니다.`,i.appendChild(e)}else o.forEach(e=>i.appendChild(this._renderNode(e,0,r)));return i}_subtreeMatches(e,t){return e.name.toLowerCase().includes(t)?!0:this.mgr.getChildren(e.id).some(e=>this._subtreeMatches(e,t))}_renderNode(e,t,n){let r=document.createElement(`div`),i=document.createElement(`div`),a=e.type===`folder`,o=this.expanded.has(e.id);i.className=`node-row ${a?`folder-row`:`tmpl-row`}${this.selectedId===e.id?` selected`:``}`,i.style.paddingLeft=`${t*20+8}px`;let s=document.createElement(`span`);a?(s.className=`chevron`,s.innerHTML=o?Q.chevronDown12:Q.chevronRight12):s.className=`chevron-spacer`,i.appendChild(s);let c=document.createElement(`span`);if(c.className=`node-icon${a&&o?` open`:``}`,a?c.innerHTML=o?Q.folderOpen14:Q.folder14:c.innerHTML=e.isPublic?Q.fileText14:Q.file14,i.appendChild(c),this.editingId===e.id){let t=document.createElement(`input`);t.type=`text`,t.className=`inline-input`,t.value=e.name,t.addEventListener(`keydown`,n=>{n.key===`Enter`&&this._commitEdit(e.id,t.value),n.key===`Escape`&&(this.editingId=null,this.render()),n.stopPropagation()}),t.addEventListener(`blur`,()=>this._commitEdit(e.id,t.value)),i.appendChild(t),requestAnimationFrame(()=>{t.focus(),t.select()})}else{let t=document.createElement(`span`);t.className=`label`,t.textContent=e.name,i.appendChild(t)}if(i.addEventListener(`click`,t=>{t.stopPropagation(),this._select(e)}),i.addEventListener(`dblclick`,t=>{t.stopPropagation(),e.type===`template`&&this._emit(`poa-tmpl-dblclick`,{node:e})}),i.addEventListener(`contextmenu`,t=>{t.preventDefault(),t.stopPropagation(),this._showCtx(e,t.clientX,t.clientY)}),r.appendChild(i),a&&o){let i=this.mgr.getChildren(e.id);(n?i.filter(e=>this._subtreeMatches(e,n)):i).forEach(e=>r.appendChild(this._renderNode(e,t+1,n)))}return r}_select(e){e.type===`folder`&&(this.expanded.has(e.id)?this.expanded.delete(e.id):this.expanded.add(e.id)),this.selectedId=e.id,this.render(),this._emit(`poa-tmpl-select`,{node:e})}_commitEdit(e,t){t.trim()&&this.mgr.rename(e,t.trim()),this.editingId=null,this.render()}_showCtx(e,t,n){this._hideCtx();let r=Be(),i=e.isPublic?r:!0,a=document.createElement(`div`);a.className=`ctx-menu`,a.style.left=`${t}px`,a.style.top=`${n}px`;let o=document.createElement(`button`);if(o.className=`ctx-item${i?``:` disabled`}`,o.innerHTML=`${Q.pencil} 이름 변경`,o.addEventListener(`click`,()=>{this._hideCtx(),this.editingId=e.id,this.render()}),a.appendChild(o),e.type===`template`){let t=document.createElement(`div`);t.className=`ctx-sep`,a.appendChild(t);let n=document.createElement(`button`);n.className=`ctx-item`,n.innerHTML=`${Q.link16} 사용자 링크 복사`,n.addEventListener(`click`,()=>{this._hideCtx();let t=ji(e.id);navigator.clipboard.writeText(t).then(()=>this._emit(`poa-tmpl-copy-link`,{id:e.id,url:t})).catch(()=>this._emit(`poa-tmpl-copy-link`,{id:e.id,url:t}))}),a.appendChild(n)}let s=document.createElement(`div`);s.className=`ctx-sep`,a.appendChild(s);let c=document.createElement(`button`);c.className=`ctx-item danger${i?``:` disabled`}`,c.innerHTML=`${Q.trash} 삭제`,c.addEventListener(`click`,()=>{this._hideCtx(),this.mgr.delete(e.id),this.expanded.delete(e.id),this.selectedId===e.id&&(this.selectedId=null),this.render(),this._emit(`poa-tmpl-delete`,{id:e.id})}),a.appendChild(c),this.shadow.appendChild(a),this.ctxMenu=a,setTimeout(()=>document.addEventListener(`click`,()=>this._hideCtx(),{once:!0}),0)}_hideCtx(){this.ctxMenu?.remove(),this.ctxMenu=null}_emit(e,t){this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0,detail:t}))}},Xo=`
*, *::before, *::after { box-sizing: border-box; }
:host {
...
`,Qo=class extends HTMLElement{shadow;mgr;tree;selected=null;_getEditorHTML=null;_saveFormOpen=!1;connectedCallback(){this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${Xo}</style>${Zo}`,this.mgr=new ia,this.tree=this.shadow.querySelector(`poa-template-tree`),this.tree.setManager(this.mgr),this._bind()}setup(e){this._getEditorHTML=e}open(){this.selected=null,this._refreshPreview(),this._fillFolderSelect(),this.tree.render(),this._closeSaveForm(),this.setAttribute(`open`,``),setTimeout(()=>this.tree.render(),300)}close(){this.removeAttribute(`open`)}_bind(){if(this.shadow.querySelector(`.x-btn`).addEventListener(`click`,()=>this.close()),this.addEventListener(`click`,e=>{e.composedPath()[0]===this&&this.close()}),this.addEventListener(`keydown`,e=>{e.key===`Escape`&&(this._saveFormOpen?this._closeSaveForm():this.close())}),this.shadow.getElementById(`search-input`).addEventListener(`input`,e=>{this.tree.setFilter(e.target.value)}),this.shadow.getElementById(`btn-add-folder`).addEventListener(`click`,()=>{let e=this.tree.getSelected(),t=e?.type===`folder`?e.id:null,n=e?.isPublic??!1;this.tree.addFolder(t,Be()?n:!1)}),this.shadow.getElementById(`btn-save-tmpl`).addEventListener(`click`,()=>{this._saveFormOpen?this._closeSaveForm():this._openSaveForm()}),this.shadow.getElementById(`sf-cancel`).addEventListener(`click`,()=>this._closeSaveForm()),this.shadow.getElementById(`sf-ok`).addEventListener(`click`,()=>this._doSave()),this.shadow.getElementById(`sf-name`).addEventListener(`keydown`,e=>{e.key===`Enter`&&this._doSave()}),Be()||this.shadow.getElementById(`sf-public-label`).classList.add(`disabled`),this.shadow.getElementById(`btn-append`).addEventListener(`click`,()=>this._apply(`append`)),this.shadow.getElementById(`btn-replace`).addEventListener(`click`,()=>this._apply(`replace`)),this.shadow.getElementById(`btn-apply-quick`).addEventListener(`click`,()=>this._apply(`replace`)),Be()){let e=document.createElement(`button`);e.className=`left-action-btn danger`,e.title=`임시/테스트 데이터 일괄 삭제 (관리자 전용)`,e.innerHTML=`${Q.trash} 정리`,this.shadow.querySelector(`.left-btns`).appendChild(e),e.addEventListener(`click`,()=>void this._adminCleanup())}this.shadow.addEventListener(`poa-tmpl-copy-link`,()=>{this._showToast(`링크가 복사되었습니다.`)}),this.shadow.addEventListener(`poa-tmpl-select`,e=>{let{node:t}=e.detail;this.selected=t.type===`template`?t:null,this._refreshPreview()}),this.shadow.addEventListener(`poa-tmpl-dblclick`,e=>{let{node:t}=e.detail;this.selected=t,this._apply(`replace`)})}_openSaveForm(){this._saveFormOpen=!0,this._fillFolderSelect(),this.shadow.getElementById(`sf-name`).value=``,this.shadow.getElementById(`save-form`).classList.add(`visible`),this.shadow.getElementById(`btn-save-tmpl`).classList.add(`active`),setTimeout(()=>this.shadow.getElementById(`sf-name`).focus(),50)}_closeSaveForm(){this._saveFormOpen=!1,this.shadow.getElementById(`save-form`).classList.remove(`visible`),this.shadow.getElementById(`btn-save-tmpl`).classList.remove(`active`)}async _ensureContent(){if(!this.selected)return``;if(this.selected.content)return this.selected.content;let e=Qi(this.selected.id);if(e===null)return``;try{let t=await X.getTemplate(e);return this.selected={...this.selected,content:t.content??``},this.selected.content??``}catch{return``}}async _refreshPreview(){let e=this.shadow.getElementById(`preview-empty`),t=this.shadow.getElementById(`preview-content`),n=this.shadow.getElementById(`preview-frame`),r=this.shadow.getElementById(`btn-append`),i=this.shadow.getElementById(`btn-replace`);if(!this.selected||this.selected.type!==`template`){e.classList.remove(`hidden`),t.classList.add(`hidden`),r.disabled=!0,i.disabled=!0;return}this.shadow.getElementById(`info-name`).textContent=this.selected.name,this.shadow.getElementById(`info-date`).textContent=new Date(this.selected.updatedAt).toLocaleDateString(`ko-KR`,{year:`numeric`,month:`2-digit`,day:`2-digit`}),e.classList.add(`hidden`),t.classList.remove(`hidden`),r.disabled=!1,i.disabled=!1;let a=await this._ensureContent();n.srcdoc=`<!DOCTYPE html>
...
</head><body>${String(j.sanitize(a,{ADD_TAGS:[`textarea`],ADD_ATTR:[`data-field-id`,`data-placeholder`,`data-label`,`data-field-type`,`data-prefix`,`data-suffix`,`data-multiline`,`data-number-format`,`data-date-format`,`data-width`,`data-height`,`data-size-fixed`,`data-raw-value`,`contenteditable`,`rows`],FORCE_BODY:!0}))}</body></html>`}async _apply(e){if(!this.selected)return;let t=await this._ensureContent();if(!t)return;let n=String(j.sanitize(t,{ADD_TAGS:[`textarea`],ADD_ATTR:[`data-field-id`,`data-placeholder`,`data-label`,`data-field-type`,`data-prefix`,`data-suffix`,`data-multiline`,`data-number-format`,`data-date-format`,`data-font-size`,`data-text-align`,`data-font-family`,`data-width`,`data-height`,`data-size-fixed`,`data-raw-value`,`value`,`rows`],FORCE_BODY:!0}));this.dispatchEvent(new CustomEvent(`poa-tmpl-insert`,{bubbles:!0,composed:!0,detail:{html:n,mode:e}})),this.close()}_doSave(){let e=this.shadow.getElementById(`sf-name`).value.trim();if(!e){this.shadow.getElementById(`sf-name`).focus();return}let t=this.shadow.getElementById(`sf-folder`).value||null,n=this.shadow.getElementById(`sf-public`).checked&&Be(),r=this._getEditorHTML?.()??``;this.mgr.addTemplate(e,r,t,n),this.tree.render(),this._closeSaveForm(),this._showToast(`"${e}" 저장 완료`)}_fillFolderSelect(){let e=this.shadow.getElementById(`sf-folder`);e.innerHTML=`<option value="">폴더 없음</option>`;for(let t of this.mgr.getFolders()){let n=document.createElement(`option`);n.value=t.id,n.textContent=(t.isPublic?`[공용] `:`[내] `)+t.name,e.appendChild(n)}}async _adminCleanup(){let e=await X.adminCleanup().then(()=>!0).catch(()=>!1);try{let e=await X.getAllNodes();try{localStorage.removeItem(`poa-templates`)}catch{}if(e.length>0)try{localStorage.setItem(`poa-templates`,JSON.stringify(e))}catch{}}catch{}this.mgr.reload(),this.tree.setManager(this.mgr),this._showToast(e?`서버 데이터 정리 완료`:`서버 정리 실패 (로컬 재동기화됨)`)}_showToast(e){let t=document.createElement(`div`);t.className=`tmpl-toast`,t.textContent=e,this.shadow.querySelector(`.dlg`).appendChild(t),setTimeout(()=>t.remove(),2200)}},$o=`poa-signatures`,es=10;function ts(){return`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,7)}`}function $(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function ns(e){let{layout:t,fields:n,logo:r,headerColor:i=`#2563eb`}=e,a=n.displayName?`<strong style="font-size:15px;color:#111;">${$(n.displayName)}</strong>`:``,o=[n.title,n.department].filter(Boolean).map($).join(` | `),s=n.company?`<span style="color:#555;">${$(n.company)}</span>`:``,c=n.phone?`<span style="color:#888;font-size:12px;">T.</span>&nbsp;${$(n.phone)}`:``,l=n.email?`<span style="color:#888;font-size:12px;">E.</span>&nbsp;${$(n.email)}`:``,u=n.website?`<span style="color:#888;font-size:12px;">W.</span>&nbsp;${$(n.website)}`:``,d=[o?`<span style="color:#555;">${o}</span>`:``,s,c,l,u].filter(Boolean),f=r?`<img src="${$(r)}" alt="" style="max-width:80px;max-height:60px;display:block;">`:``,p=`font-size:14px;line-height:1.6;border-collapse:collapse;font-family:Arial,Helvetica,sans-serif;`,m=()=>[a,...d].filter(Boolean).join(`<br>`);switch(t){case 1:return`<table class="poa-signature" style="${p}"><tbody><tr><td style="padding:8px 0;vertical-align:top;">${m()}</td></tr></tbody></table>`;case 2:return r?`<table class="poa-signature" style="${p}"><tbody><tr><td style="padding:0 14px 0 0;vertical-align:middle;border-right:2px solid #e5e7eb;">${f}</td><td style="padding:0 0 0 14px;vertical-align:middle;">${m()}</td></tr></tbody></table>`:ns({...e,layout:1});case 3:return r?`<table class="poa-signature" style="${p}"><tbody><tr><td style="text-align:center;padding-bottom:6px;">${f}</td></tr><tr><td style="padding:4px 0;">${m()}</td></tr></tbody></table>`:ns({...e,layout:1});case 4:return`<table class="poa-signature" style="${p}"><tbody><tr><td style="padding:8px 0;vertical-align:top;">${a?a+`<br>`:``}<hr style="border:none;border-top:1px solid #aaa;margin:4px 0;">${d.join(`<br>`)}</td></tr></tbody></table>`;case 5:{let e=[a,n.department?`<span style="color:#555;">${$(n.department)}</span>`:``].filter(Boolean).join(`<br>`),t=[n.title?`<span style="color:#555;">${$(n.title)}</span>`:``,s].filter(Boolean).join(`<br>`),r=[c,l].filter(Boolean).join(`&nbsp;|&nbsp;`);return`<table class="poa-signature" style="${p}"><tbody><tr><td style="padding:4px 14px 4px 0;border-right:1px solid #ddd;vertical-align:top;">${e||`&nbsp;`}</td><td style="padding:4px 0 4px 14px;vertical-align:top;">${t||`&nbsp;`}</td></tr>`+(r?`<tr><td colspan="2" style="padding:6px 0 4px;border-top:1px solid #eee;font-size:13px;">${r}</td></tr>`:``)+`</tbody></table>`}case 6:{let e=[n.displayName?`<strong style="color:#fff;">${$(n.displayName)}</strong>`:``,n.title?`<span style="color:rgba(255,255,255,.85);">${$(n.title)}</span>`:``].filter(Boolean).join(`&nbsp;&nbsp;`),t=[n.department?`<span style="color:#555;">${$(n.department)}</span>`:``,s,c,l,u].filter(Boolean);return`<table class="poa-signature" style="${p}border:1px solid ${$(i)};"><tbody><tr><td style="background:${$(i)};padding:8px 16px;">${e||`&nbsp;`}</td></tr><tr><td style="padding:8px 16px;">${t.join(`<br>`)||`&nbsp;`}</td></tr></tbody></table>`}default:return``}}var rs=class{sigs=[];constructor(){this._load()}_load(){try{let e=localStorage.getItem($o);this.sigs=e?JSON.parse(e):[]}catch{this.sigs=[]}}_persist(){try{localStorage.setItem($o,JSON.stringify(this.sigs))}catch{}}getAll(){return[...this.sigs]}getById(e){return this.sigs.find(t=>t.id===e)??null}add(e){if(this.sigs.length>=es)throw Error(`최대 ${es}개까지 저장할 수 있습니다.`);let t={...e,id:ts(),createdAt:Date.now(),updatedAt:Date.now()};return this.sigs.push(t),this._persist(),t}update(e,t){let n=this.sigs.find(t=>t.id===e);return n?(Object.assign(n,t,{updatedAt:Date.now()}),this._persist(),!0):!1}delete(e){let t=this.sigs.findIndex(t=>t.id===e);return t<0?!1:(this.sigs.splice(t,1),this._persist(),!0)}isFull(){return this.sigs.length>=es}},is={1:`기본형`,2:`로고(좌)`,3:`로고(상)`,4:`구분선형`,5:`2단형`,6:`컬러헤더`},as=`
*, *::before, *::after { box-sizing: border-box; }
:host { display: none; position: fixed; inset: 0; z-index: 9999; align-items: center; justify-content: center; }
:host([open]) { display: flex; background: rgba(0,0,0,.45); }
...
`,ls=class extends HTMLElement{shadow;inserter=new ei;activeCatId=Zr[0].id;connectedCallback(){this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${cs}</style>
<div class="dlg">
...
</div>`,this._buildCatBar(),this._bind()}open(){this._renderCategory(this.activeCatId),this.setAttribute(`open`,``),setTimeout(()=>this.shadow.getElementById(`search`).focus(),50)}close(){this.removeAttribute(`open`)}_buildCatBar(){let e=this.shadow.getElementById(`cat-bar`);e.innerHTML=``;for(let t of Zr){let n=document.createElement(`button`);n.className=`cat-btn${t.id===this.activeCatId?` active`:``}`,n.title=t.label,n.textContent=t.icon,n.dataset.catId=t.id,n.addEventListener(`click`,()=>{this.activeCatId=t.id,this._syncCatBar(),this._renderCategory(t.id),this.shadow.getElementById(`search`).value=``}),e.appendChild(n)}}_syncCatBar(){this.shadow.querySelectorAll(`.cat-btn`).forEach(e=>{e.classList.toggle(`active`,e.dataset.catId===this.activeCatId)})}_renderCategory(e){let t=this.shadow.getElementById(`emoji-area`);t.innerHTML=``;let n=this.inserter.getRecent();if(n.length>0){this._appendSection(t,`최근 사용`,n);let e=document.createElement(`hr`);e.className=`divider`,t.appendChild(e)}let r=Zr.find(t=>t.id===e);r&&this._appendSection(t,r.label,r.emojis)}_renderSearch(e){let t=this.shadow.getElementById(`emoji-area`);t.innerHTML=``;let n=$r(e);if(n.length===0){let n=document.createElement(`div`);n.className=`no-result`,n.textContent=`"${e}"에 대한 결과가 없습니다`,t.appendChild(n)}else this._appendSection(t,`검색 결과 (${n.length})`,n)}_appendSection(e,t,n){let r=document.createElement(`div`);r.className=`section-label`,r.textContent=t,e.appendChild(r);let i=document.createElement(`div`);i.className=`emoji-grid`;for(let e of n){let t=document.createElement(`button`);t.className=`emoji-btn`,t.textContent=e,t.title=e,t.addEventListener(`click`,()=>this._pickEmoji(e)),i.appendChild(t)}e.appendChild(i)}_bind(){this.shadow.querySelector(`.x-btn`).addEventListener(`click`,()=>this.close()),this.addEventListener(`click`,e=>{e.composedPath()[0]===this&&this.close()});let e=this.shadow.getElementById(`search`);e.addEventListener(`input`,()=>{let t=e.value.trim();t?this._renderSearch(t):this._renderCategory(this.activeCatId)}),e.addEventListener(`keydown`,e=>{e.key===`Escape`&&(e.stopPropagation(),this.close())})}_pickEmoji(e){this.dispatchEvent(new CustomEvent(`poa-emoji-insert`,{bubbles:!0,composed:!0,detail:{emoji:e}})),this.shadow.getElementById(`search`).value.trim()||this._renderCategory(this.activeCatId)}},us=`
*, *::before, *::after { box-sizing: border-box; }
:host { display: none; position: fixed; inset: 0; z-index: 9999; align-items: center; justify-content: center; }
:host([open]) { display: flex; background: rgba(0,0,0,.45); }
...
.hidden { display: none !important; }
`,ds=class extends HTMLElement{shadow;mode=`add`;editId=null;entries=[];connectedCallback(){this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${us}</style>
<div class="dlg">
  <div class="hdr">
...
`,ps=class extends HTMLElement{shadow;targetInput=null;connectedCallback(){this.shadow||(this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${fs}</style>${this._tpl()}`,this._bindEvents())}open(e){this.shadow||this.connectedCallback(),this.targetInput=e,this._populate(e),this.setAttribute(`open`,``)}close(){this.removeAttribute(`open`)}_tpl(){return`<div class="dlg">
  <div class="hdr">
    <h3>입력 요소 속성</h3>
    <button class="x-btn" aria-label="닫기">✕</button>
  </div>
...
`;function hs(e){return new Date(e).toLocaleString(`ko-KR`,{month:`2-digit`,day:`2-digit`,hour:`2-digit`,minute:`2-digit`,second:`2-digit`})}var gs=class extends HTMLElement{shadow;autoSave=null;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${ms}</style>
<div class="backdrop" id="backdrop">
  <div class="dialog" role="dialog" aria-modal="true" aria-label="파일 관리">
    ...
    <div class="body">
      ...
      <div class="section">
        ...
        <span class="history-time">${hs(n.savedAt)}</span>
        <button class="restore-btn" data-id="${String(n.id)}">복원</button>`,t.querySelector(`.restore-btn`).addEventListener(`click`,()=>{this.handleRestore(n)}),e.appendChild(t)}}handleRestore(e){this.dispatchEvent(new CustomEvent(`poa-autosave-restore`,{bubbles:!0,composed:!0,detail:{html:e.html}})),this.close()}},_s=[{id:`file`,label:`파일`},{id:`edit`,label:`편집`},{id:`insert`,label:`삽입`},{id:`view`,label:`보기`},{id:`table`,label:`표`},{id:`format`,label:`서식`},{id:`misc`,label:`기타`},{id:`help`,label:`도움말`}],vs=`
:host { display: block; }
.menubar {
...
`,ys=new Set([`edit`,`insert`,`table`,`format`,`misc`]),bs=class extends HTMLElement{shadow;_activeTab=`edit`;_userMode=!1;busHandler=({tab:e})=>{this._activeTab=e,this.updateActive()};constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){let e=_s.map(e=>`<button class="tab${e.id===this._activeTab?` active`:``}" data-tab="${e.id}">${e.label}</button>`).join(``);this.shadow.innerHTML=`<style>${vs}</style><div class="menubar">${e}</div>`;let t=this.shadow.querySelector(`.menubar`),n=document.createElement(`div`);n.className=`user-area`,n.id=`user-area`;let r=document.createElement(`span`);r.style.cssText=`display:contents`,r.innerHTML=Q.userCircle,n.appendChild(r);let i=document.createElement(`span`);if(i.className=`user-name-text`,i.id=`user-name-text`,i.textContent=Re(),n.appendChild(i),Be()){let e=document.createElement(`span`);e.className=`admin-badge`,e.textContent=`관리자`,n.appendChild(e)}let a=document.createElement(`div`);a.className=`user-dropdown hidden`,a.id=`user-dropdown`;let o=document.createElement(`div`);o.className=`user-dropdown-label`,o.textContent=`사용자 이름`;let s=document.createElement(`input`);s.type=`text`,s.id=`user-name-input`,s.placeholder=`사용자 이름`;let c=document.createElement(`button`);c.className=`user-dropdown-btn`,c.id=`user-name-confirm`,c.textContent=`확인`,a.append(o,s,c),n.appendChild(a),t.appendChild(n),this.shadow.querySelectorAll(`.tab`).forEach(e=>{e.addEventListener(`mousedown`,t=>{t.preventDefault(),F.emit(I.MENUBAR_CHANGE,{tab:e.dataset.tab})})}),this._bindUserArea(),F.on(I.MENUBAR_CHANGE,this.busHandler)}disconnectedCallback(){F.off(I.MENUBAR_CHANGE,this.busHandler)}_bindUserArea(){let e=this.shadow.getElementById(`user-area`),t=this.shadow.getElementById(`user-dropdown`),n=this.shadow.getElementById(`user-name-input`),r=this.shadow.getElementById(`user-name-confirm`),i=this.shadow.getElementById(`user-name-text`);e.addEventListener(`mousedown`,e=>{if(e.preventDefault(),e.target.closest(`#user-dropdown`))return;let r=t.classList.contains(`hidden`);t.classList.toggle(`hidden`,!r),r&&(n.value=Re(),setTimeout(()=>{n.focus(),n.select()},50))});let a=()=>{let e=n.value.trim()||`사용자`;ze(e),i.textContent=e,t.classList.add(`hidden`)};r.addEventListener(`mousedown`,e=>{e.preventDefault(),a()}),n.addEventListener(`keydown`,e=>{e.key===`Enter`&&a()}),document.addEventListener(`click`,n=>{e.contains(n.target)||t.classList.add(`hidden`)})}applyUserMode(){this._userMode=!0,ys.has(this._activeTab)&&F.emit(I.MENUBAR_CHANGE,{tab:`file`}),this._applyUserModeStyles()}_applyUserModeStyles(){if(!this._userMode)return;this.shadow.querySelectorAll(`.tab`).forEach(e=>{let t=e.dataset.tab;ys.has(t)&&(e.dataset.userDisabled=`true`)});let e=this.shadow.querySelector(`.menubar`);if(!e.querySelector(`.user-mode-badge`)){let t=document.createElement(`span`);t.className=`user-mode-badge`,t.textContent=`사용자 모드`;let n=e.querySelector(`.user-area`);n?e.insertBefore(t,n):e.appendChild(t)}}updateActive(){this.shadow.querySelectorAll(`.tab`).forEach(e=>{e.classList.toggle(`active`,e.dataset.tab===this._activeTab)})}},xs={text:Q.fieldText,number:Q.fieldNumber,date:Q.fieldDate};function Ss(){let e=[`기본`,`계약`,`금액`,`보증`,`기타`],t=[],n=!0;for(let r of e){let e=Si.filter(e=>e.category===r);if(e.length!==0){n||t.push([``,`__sep__`]),t.push([r,`__cat__`]),n=!1;for(let n of e)t.push([n.label,`insert:field`,n.id,xs[n.type]])}}return t}var Cs={file:[[[`새 문서`,`file:new`],[`열기`,`file:open`],[`저장`,`file:save`],[`다른 이름으로 저장`,`file:saveas`]],[[`인쇄`,`file:print`],[`환경설정`,`settings`],[`이력`,`file:history`]]],edit:[[[`잘라내기`,`edit:cut`],[`복사`,`edit:copy`],[`붙여넣기`,`edit:paste`],[`서식 없이 붙여넣기`,`edit:paste-plain`]],[[`찾기·바꾸기`,`find-replace`],[`이미지 편집`,`edit:image-edit`],[`전체 선택`,`edit:select-all`]]],insert:[[[`이미지`,`image`]],[[`하이퍼링크`,`insert:link`],[`책갈피`,`insert:bookmark`]],[[`서명`,`insert:signature`],[`이모지`,`insert:emoji`]],[[`툴팁`,`insert:tooltip`],[`툴팁 관리`,`insert:tooltip-list`]],[[`날짜·시간`,`insert:datetime`],[`가로줄`,`insert:hr`],[`기호`,`insert:symbol`],[`페이지 구분선`,`insert:pagebreak`],[`템플릿`,`misc:template`]],[{dropdown:!0,id:`doc-field`,label:`양식 필드`,iconKey:`formField`,items:Ss()}]],view:[[[`디자인`,`view:design`],[`HTML`,`view:html`],[`미리보기`,`view:preview`],[`텍스트`,`view:text`],[`페이지`,`view:page`]],[[`전체화면`,`view:fullscreen`],[`눈금자`,`view:ruler`],[`그리드`,`view:grid`],[`숨김 테두리`,`view:hidden-border`]]],table:[[[`표 삽입`,`table`],[`표 속성`,`table:table-props`],[`셀 속성`,`table:cell-props`]],[[`셀 병합`,`table:merge`],[`셀 나누기`,`table:split-cell`]],[[`위에 행 삽입`,`table:row-above`],[`아래에 행 삽입`,`table:row-below`],[`왼쪽에 열 삽입`,`table:col-left`],[`오른쪽에 열 삽입`,`table:col-right`]],[[`행 삭제`,`table:row-delete`],[`열 삭제`,`table:col-delete`],[`표 삭제`,`table:delete`]],[[`표 왼쪽 정렬`,`table:align-left`],[`표 가운데 정렬`,`table:align-center`],[`표 오른쪽 정렬`,`table:align-right`]]],format:[[[`서식 복사`,`format:painter-copy`],[`서식 붙여넣기`,`format:painter-paste`],[`서식 제거`,`format:clear`]],[[`글머리 기호`,`format:ul`],[`글머리 번호`,`format:ol`]],[[`위 첨자`,`format:sup`],[`아래 첨자`,`format:sub`]]],misc:[[[`웹 접근성 체크`,`misc:a11y`],[`개인정보 체크`,`misc:privacy`]],[[`폼 컨트롤`,`misc:form`],[`계산식`,`misc:calc`]],[[`사용자 모드로 보기`,`misc:user-mode`]]],help:[[[`단축키`,`help:shortcuts`],[`사용자 가이드`,`help:guide`],[`제품 정보`,`help:about`]]]},ws=new Set([`view:design`,`view:html`,`view:preview`,`view:text`,`view:page`]),Ts=`
:host {
  display: block;
  --icon-color:         #374151;
...
`,Es=new Set([`file:new`,`file:open`,`settings`]),Ds=class extends HTMLElement{shadow;activeTab=`edit`;activeViewMode=`design`;outsideHandler=null;userMode=!1;busHandler=({tab:e})=>{this.activeTab=e,this.render()};viewHandler=({mode:e})=>{this.activeViewMode=e,this.activeTab===`view`&&this.render()};constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.render(),F.on(I.MENUBAR_CHANGE,this.busHandler),F.on(I.VIEW_CHANGE,this.viewHandler)}disconnectedCallback(){F.off(I.MENUBAR_CHANGE,this.busHandler),F.off(I.VIEW_CHANGE,this.viewHandler),this.closeAllDropdowns()}render(){this.closeAllDropdowns();let e=Cs[this.activeTab]??[],t=[];for(let n=0;n<e.length;n++){n>0&&t.push(`<div class="sep"></div>`),t.push(`<div class="group">`);for(let r of e[n])if(r===null)t.push(`<div class="sep" style="margin:0 2px;"></div>`);else if(`dropdown`in r&&r.dropdown){let e=r.items.map(([e,t,n,r])=>t===`__sep__`?`<hr class="drop-sep">`:t===`__cat__`?`<div class="drop-cat">${e}</div>`:`<div class="drop-item" data-action="${t}"${n?` data-value="${n}"`:``}>${r?`<span class="type-icon">${r}</span>`:``}${e}</div>`).join(``),n=r.iconKey?Q[r.iconKey]??``:``,i=n?`${n}<span>${r.label}</span>`:r.label;t.push(`<div class="dropdown-wrap" id="dd-${r.id}"><button class="btn dropdown-toggle" data-dropdown-id="${r.id}">${i}</button><div class="dropdown-menu" id="menu-${r.id}">${e}</div></div>`)}else{let[e,n,i,a]=r,o=i?` data-value="${i}"`:``,s=ws.has(n)&&n===`view:${this.activeViewMode}`?` active`:``,c=a??e,l=qo[n],u=l?Q[l]:``,d=u?`${u}<span>${e}</span>`:e;t.push(`<button class="btn${s}" data-action="${n}"${o} data-tip="${c}">${d}</button>`)}t.push(`</div>`)}this.shadow.innerHTML=`<style>${Ts}</style><div class="ctx-bar">${t.join(``)}</div>`,this.userMode&&this._applyUserModeButtons(),this.shadow.querySelector(`.ctx-bar`).addEventListener(`mousedown`,e=>{let t=e.target,n=t.closest(`.dropdown-toggle`);if(n){let t=n.dataset.dropdownId;if(!t)return;e.preventDefault();let r=this.shadow.getElementById(`menu-${t}`);if(!r)return;let i=r.classList.contains(`open`);this.closeAllDropdowns(),i||(r.classList.add(`open`),this.setupOutsideClick(t));return}let r=t.closest(`.drop-item`);if(r){let t=r.dataset.action,n=r.dataset.value;if(!t)return;e.preventDefault(),this.closeAllDropdowns(),this.dispatchEvent(new CustomEvent(`poa-action`,{bubbles:!0,composed:!0,detail:{type:t,value:n}}));return}let i=t.closest(`.btn`);if(!i||i.disabled)return;let a=i.dataset.action;if(!a)return;e.preventDefault();let o=i.dataset.value;this.dispatchEvent(new CustomEvent(`poa-action`,{bubbles:!0,composed:!0,detail:{type:a,value:o}}))})}closeAllDropdowns(){this.shadow.querySelectorAll(`.dropdown-menu.open`).forEach(e=>e.classList.remove(`open`)),this.outsideHandler&&=(document.removeEventListener(`mousedown`,this.outsideHandler),null)}setupOutsideClick(e){this.outsideHandler=t=>{let n=this.shadow.getElementById(`dd-${e}`);n&&(t.composedPath().includes(n)||this.closeAllDropdowns())},document.addEventListener(`mousedown`,this.outsideHandler)}applyUserMode(){this.userMode=!0,this._applyUserModeButtons()}_applyUserModeButtons(){this.shadow.querySelectorAll(`.btn[data-action]`).forEach(e=>{let t=e.dataset.action??``;Es.has(t)&&(e.disabled=!0,e.title=(e.title||e.textContent?.trim()||``)+` (사용자 모드에서 비활성화)`)})}},Os=[{label:`기본`,value:`inherit`},{label:`Noto Sans KR`,value:`Noto Sans KR, Roboto, sans-serif`},{label:`맑은 고딕`,value:`맑은 고딕, sans-serif`},{label:`나눔고딕`,value:`나눔고딕, sans-serif`},{label:`나눔명조`,value:`나눔명조, serif`},{label:`굴림`,value:`굴림, sans-serif`},{label:`돋움`,value:`돋움, sans-serif`},{label:`바탕`,value:`바탕, serif`},{label:`궁서`,value:`궁서, serif`},{label:`Arial`,value:`Arial, sans-serif`},{label:`Times New Roman`,value:`Times New Roman, serif`},{label:`Courier New`,value:`Courier New, monospace`},{label:`Georgia`,value:`Georgia, serif`},{label:`Verdana`,value:`Verdana, sans-serif`},{label:`Tahoma`,value:`Tahoma, sans-serif`}],ks=[`8`,`9`,`10`,`11`,`12`,`14`,`16`,`18`,`20`,`24`,`28`,`32`,`36`,`48`,`72`],As=[`1`,`1.2`,`1.4`,`1.5`,`1.6`,`1.8`,`2.0`,`2.5`],js=[`0px`,`0.5px`,`1px`,`1.5px`,`2px`,`3px`,`4px`],Ms=`
:host {
  display: block;
  --icon-color:         #374151;
  --icon-hover-bg:      #F3F4F6;
...
<div class="toolbar">
  ...
  <div class="group">
    <button class="btn" id="btn-bold"      data-tip="굵게 (Ctrl+B)">${Q.bold}</button>
    <button class="btn" id="btn-italic"    data-tip="기울임 (Ctrl+I)">${Q.italic}</button>
    <button class="btn" id="btn-underline" data-tip="밑줄 (Ctrl+U)">${Q.underline}</button>
    <button class="btn" id="btn-strike"    data-tip="취소선">${Q.strike}</button>
  </div>
  <div class="sep"></div>
  ...
  <div class="group">
    <div class="color-wrap" data-tip="글자색">
      <button class="btn color-btn" id="btn-fore" data-tip="글자색">
        <span class="c-icon">${Q.foreColor}</span>
    ...
    <div class="color-wrap">
      <button class="btn color-btn" id="btn-back" data-tip="배경 강조색">
        <span class="c-icon">${Q.backColor}</span>
  ...
  <div class="group">
    <button class="btn" id="btn-al-left"    data-tip="왼쪽 정렬">${Q.alignLeft}</button>
    <button class="btn" id="btn-al-center"  data-tip="가운데 정렬">${Q.alignCenter}</button>
    <button class="btn" id="btn-al-right"   data-tip="오른쪽 정렬">${Q.alignRight}</button>
    <button class="btn" id="btn-al-justify" data-tip="양쪽 정렬">${Q.alignJustify}</button>
  </div>
  <div class="sep"></div>

  <div class="group">
    <button class="btn" id="btn-indent"  data-tip="들여쓰기">${Q.indent}</button>
    <button class="btn" id="btn-outdent" data-tip="내어쓰기">${Q.outdent}</button>
  </div>
  <div class="sep"></div>
...
`,Bs=class extends HTMLElement{shadow;editor=new Ii;originalSrc=``;currentDataUrl=``;busy=!1;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${zs}</style>
<div class="backdrop" id="backdrop">
...
`;function Hs(e){return e<1024*1024?`${(e/1024).toFixed(1)}KB`:`${(e/1024/1024).toFixed(1)}MB`}var Us=class extends HTMLElement{shadow;uploader=new zi;uploadConfig=null;selectedFiles=[];busy=!1;onErrorFn=null;setOnError(e){this.onErrorFn=e}constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${Vs}</style>
<div class="backdrop" id="backdrop">
...
.grid-picker {
  display: grid;
  grid-template-columns: repeat(${Ws}, ${Ks}px);
  gap: ${qs}px;
  cursor: crosshair;
}
.gc {
...
`,Ys=class e extends HTMLElement{shadow;selectedPreset=`border-all`;gridCells=[];constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${Js}</style>
<div class="overlay" id="overlay">
  <div class="dialog" role="dialog" aria-modal="true">
    <div class="dlg-hd">
...
</div>`;let l=s;t.querySelector(`#pp-align-btns`).addEventListener(`click`,e=>{let n=e.target.closest(`.align-btn`);n&&(l=n.dataset.align,t.querySelectorAll(`.align-btn`).forEach(e=>{e.classList.toggle(`active`,e.dataset.align===l)}))}),t.querySelector(`#pp-cancel`).addEventListener(`click`,()=>this.close()),t.querySelector(`#pp-ok`).addEventListener(`click`,()=>{let e={width:t.querySelector(`#pp-w`).value.trim(),borderColor:t.querySelector(`#pp-bc`).value,bgColor:t.querySelector(`#pp-bg`).value,align:l};this.dispatchEvent(new CustomEvent(`poa-table-update`,{bubbles:!0,composed:!0,detail:{options:e,table:n}})),this.close()})}static rgbToHex(e){let t=e.match(/\d+/g);return!t||t.length<3?``:`#`+t.slice(0,3).map(e=>parseInt(e).toString(16).padStart(2,`0`)).join(``)}static colorToHex(t){return e.rgbToHex(t)||`#ffffff`}},Xs=[{label:`날짜 (2025-05-05)`,fn:()=>new Date().toISOString().slice(0,10)},{label:`시간 (14:30:05)`,fn:()=>new Intl.DateTimeFormat(`ko-KR`,{hour:`2-digit`,minute:`2-digit`,second:`2-digit`,hour12:!1}).format(new Date)},{label:`날짜·시간 (2025-05-05 14:30)`,fn:()=>{let e=new Date;return`${e.toISOString().slice(0,10)} ${new Intl.DateTimeFormat(`ko-KR`,{hour:`2-digit`,minute:`2-digit`,hour12:!1}).format(e)}`}},{label:`한국어 날짜 (2025년 5월 5일)`,fn:()=>new Intl.DateTimeFormat(`ko-KR`,{year:`numeric`,month:`long`,day:`numeric`}).format(new Date)},{label:`한국어 날짜·시간 (2025년 5월 5일 월요일 오후 2:30)`,fn:()=>new Intl.DateTimeFormat(`ko-KR`,{year:`numeric`,month:`long`,day:`numeric`,weekday:`long`,hour:`numeric`,minute:`2-digit`}).format(new Date)}],Zs=`
:host { display: none; }
:host([open]) { display: block; }
.backdrop {
  position: fixed; inset: 0; background: rgba(0,0,0,.45);
...
`,Qs=class extends HTMLElement{shadow;bookmarks=[];editingId=null;editingAnchor=null;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${Zs}</style>
<div class="backdrop" id="backdrop">
  <div class="dialog" role="dialog" aria-modal="true" aria-label="링크 삽입">
    ...
    `).join(``),this.refreshDatetimePreviews(),e.addEventListener(`click`,e=>{let t=e.target.closest(`[data-preset]`);if(!t)return;let n=Xs[parseInt(t.dataset.preset??`0`)]?.fn()??``;this.dispatch(`poa-datetime-insert`,{text:n}),this.close()}))}refreshDatetimePreviews(){Xs.forEach((e,t)=>{let n=this.shadow.getElementById(`dt-prev-${t}`);n&&(n.textContent=e.fn())})}dispatch(e,t){this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0,detail:t}))}},$s=`
:host { display: none; }
:host([open]) {
  display: flex; align-items: center; gap: 6px;
...
`,ec=class extends HTMLElement{shadow;img=null;aspectLocked=!1;naturalW=0;naturalH=0;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${$s}</style>
<label>너비</label>
...
`,rc=class extends HTMLElement{shadow;resolvePromise=null;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${tc}</style>${nc}`,this.bindEvents()}show(e,t=`확인`){let n=this.shadow.getElementById(`dlg-title`),r=this.shadow.getElementById(`dlg-message`);return n&&(n.textContent=t),r&&(r.textContent=e),this.setAttribute(`open`,``),new Promise(e=>{this.resolvePromise=e})}close(e){this.removeAttribute(`open`),this.resolvePromise?.(e),this.resolvePromise=null}bindEvents(){this.shadow.getElementById(`btn-ok`)?.addEventListener(`click`,()=>this.close(!0)),this.shadow.getElementById(`btn-cancel`)?.addEventListener(`click`,()=>this.close(!1)),this.shadow.getElementById(`overlay`)?.addEventListener(`click`,e=>{e.target.id===`overlay`&&this.close(!1)}),this.addEventListener(`keydown`,e=>{e.key===`Escape`&&(e.preventDefault(),this.close(!1))})}},ic={error:`●`,warning:`▲`,info:`ℹ`},ac={error:`#DC2626`,warning:`#D97706`,info:`#2563EB`},oc=`
:host { display: none; }
:host([open]) { display: block; }
...
`,sc=class extends HTMLElement{shadow;issues=[];contentEl=null;rerunFn=null;currentFilter=`all`;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${oc}</style>
<div class="overlay" id="overlay">
  <div class="dialog">
    <div class="header">
      <h2>웹 접근성 검사 결과</h2>
...
`,fc=class extends HTMLElement{shadow;items=[];filteredType=`all`;onModified=null;onConfirmFn=null;constructor(){super(),this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${dc}</style><slot></slot>`}setup(e,t){this.onModified=e,this.onConfirmFn=t}startLoading(){this.setAttribute(`open`,``),this.shadow.innerHTML=`<style>${dc}</style>
<div class="overlay">
  <div class="dialog">
    <div class="header">
      <h2>개인정보 검사</h2>
...
<div class="card" data-level="${e.riskLevel}" data-id="${e.id}">
  <div class="card-header" data-toggle="${e.id}">
    <span class="card-icon">${lc[e.riskLevel]}</span>
    <span class="card-label">${e.label}</span>
    <span class="card-risk">${uc[e.riskLevel]}</span>
    <span class="card-toggle">∨</span>
  </div>
  <div class="card-body" id="body-${e.id}">
    <div class="raw-text">"${pc(e.raw)}"</div>
...
`,hc=class extends HTMLElement{shadow;currentTable=null;currentRow=1;currentCol=1;pickBar=null;constructor(){super(),this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${mc}</style>`}open(e){this.currentTable=e.table,this.currentRow=e.cellRow,this.currentCol=e.cellCol,this.setAttribute(`open`,``),this.render(e.existingFormula,e.initialRange)}close(){this.removeAttribute(`open`),this.exitPickMode(),this.currentTable=null}applyRange(e,t,n,r){this.exitPickMode();let i=e=>this.shadow.getElementById(e),a=(e,t)=>{let n=i(e);n&&(n.value=String(t))};a(`sr`,e),a(`sc`,t),a(`er`,n),a(`ec`,r)}render(e,t){let n=e?.fn??`SUM`,r=e?.format??`integer`,i=e?.decimalPlaces??2,[a,o,s,c]=e?.range??t??[1,1,1,1],l=e?.targetRow??this.currentRow,u=e?.targetCol??this.currentCol,d=!e||e.targetRow===this.currentRow&&e.targetCol===this.currentCol,f=e?.style?.backgroundColor??`#ffffff`,p=e?.style?.color??`#000000`,m=(e,t)=>`<label><input type="radio" name="fn" value="${e}"${n===e?` checked`:``}> ${e} (${t})</label>`,h=(e,t)=>`<label><input type="radio" name="format" value="${e}"${r===e?` checked`:``}> ${t}</label>`;this.shadow.innerHTML=`<style>${mc}</style>
<div class="overlay" id="overlay">
  <div class="dialog" id="dialog">
    <div class="header">
      <h2>계산식 설정</h2>
    ...
    <div class="footer">
      ...
      ">취소</button>`,document.body.appendChild(e),this.pickBar=e,e.querySelector(`#cancel-pick`)?.addEventListener(`click`,()=>this.exitPickMode()),this.dispatchEvent(new CustomEvent(`poa-formula-start-pick`,{bubbles:!0}))}exitPickMode(){this.shadow.getElementById(`overlay`)?.classList.remove(`pick-mode`),this.pickBar?.remove(),this.pickBar=null}};customElements.get(`poa-menubar`)||customElements.define(`poa-menubar`,bs),customElements.get(`poa-context-toolbar`)||customElements.define(`poa-context-toolbar`,Ds),customElements.get(`poa-toolbar`)||customElements.define(`poa-toolbar`,Ps),customElements.get(`poa-status-bar`)||customElements.define(`poa-status-bar`,Fs),customElements.get(`poa-settings-dialog`)||customElements.define(`poa-settings-dialog`,an),customElements.get(`poa-file-manager-dialog`)||customElements.define(`poa-file-manager-dialog`,gs),customElements.get(`poa-find-replace-dialog`)||customElements.define(`poa-find-replace-dialog`,Rs),customElements.get(`poa-image-edit-dialog`)||customElements.define(`poa-image-edit-dialog`,Bs),customElements.get(`poa-image-dialog`)||customElements.define(`poa-image-dialog`,Us),customElements.get(`poa-table-dialog`)||customElements.define(`poa-table-dialog`,Ys),customElements.get(`poa-cell-split-dialog`)||customElements.define(`poa-cell-split-dialog`,Vi),customElements.get(`poa-link-dialog`)||customElements.define(`poa-link-dialog`,Qs),customElements.get(`poa-image-toolbar`)||customElements.define(`poa-image-toolbar`,ec),customElements.get(`poa-confirm-dialog`)||customElements.define(`poa-confirm-dialog`,rc),customElements.get(`poa-accessibility-dialog`)||customElements.define(`poa-accessibility-dialog`,sc),customElements.get(`poa-privacy-dialog`)||customElements.define(`poa-privacy-dialog`,fc),customElements.get(`poa-formula-dialog`)||customElements.define(`poa-formula-dialog`,hc),customElements.get(`poa-video-dialog`)||customElements.define(`poa-video-dialog`,Ui),customElements.get(`poa-form-control-dialog`)||customElements.define(`poa-form-control-dialog`,Yi),customElements.get(`poa-template-tree`)||customElements.define(`poa-template-tree`,Yo),customElements.get(`poa-template-dialog`)||customElements.define(`poa-template-dialog`,Qo),customElements.get(`poa-signature-dialog`)||customElements.define(`poa-signature-dialog`,ss),customElements.get(`poa-emoji-dialog`)||customElements.define(`poa-emoji-dialog`,ls),customElements.get(`poa-tooltip-dialog`)||customElements.define(`poa-tooltip-dialog`,ds),customElements.get(`poa-input-property-dialog`)||customElements.define(`poa-input-property-dialog`,ps),customElements.get(`poa-editor`)||customElements.define(`poa-editor`,Fi);var gc=Wo(ka,36),_c=Wo(Uo,14),vc=Wo(Ho,14);function yc(e){return j.sanitize(e,{USE_PROFILES:{svg:!0,svgFilters:!0}})}function bc(e){return e.type===`template`&&!e.isTemp&&!e.name.startsWith(`임시_`)&&!e.name.startsWith(`preview_`)}var xc=class{container;mgr;publicGrid;privateGrid;constructor(e){this.container=e,this.mgr=new ia}renderTemplateSelector(){this.container.innerHTML=``;let e=document.createElement(`div`);e.className=`user-mode-page`;let t=document.createElement(`h2`);t.className=`user-mode-title`,t.textContent=`양식 선택`,e.appendChild(t);let[n,r]=this._buildSection(`공용 양식`,_c);this.publicGrid=r,e.appendChild(n);let[i,a]=this._buildSection(`내 양식`,vc);this.privateGrid=a,e.appendChild(i),this.container.appendChild(e),this._renderSections(this.mgr.getAll().filter(bc)),this._refreshFromServer()}_buildSection(e,t){let n=document.createElement(`section`);n.className=`user-mode-section`;let r=document.createElement(`h3`);r.className=`user-mode-section-header`;let i=document.createElement(`span`);i.className=`section-header-icon`,i.innerHTML=yc(t);let a=document.createElement(`span`);a.textContent=e,r.appendChild(i),r.appendChild(a),n.appendChild(r);let o=document.createElement(`div`);return o.className=`user-mode-card-grid`,n.appendChild(o),[n,o]}async _refreshFromServer(){try{let e=await X.getTemplates();this._renderSections(e.filter(bc))}catch{}}_renderSections(e){let t=new Set,n=e.filter(e=>t.has(e.id)?!1:(t.add(e.id),!0)),r=n.filter(e=>e.isPublic),i=n.filter(e=>!e.isPublic);this._renderCards(this.publicGrid,r,`public`,`등록된 공용 양식이 없습니다.`),this._renderCards(this.privateGrid,i,`private`,`저장된 개인 양식이 없습니다.`)}_renderCards(e,t,n,r){if(e.innerHTML=``,t.length===0){let t=document.createElement(`p`);t.className=`user-mode-empty`,t.textContent=r,e.appendChild(t)}else for(let r of t)e.appendChild(this._buildCard(r,n))}_buildCard(e,t){let n=document.createElement(`div`);n.className=`user-mode-card user-mode-card--${t}`;let r=document.createElement(`div`);r.className=`user-mode-card-icon`,r.innerHTML=yc(gc);let i=document.createElement(`div`);return i.className=`user-mode-card-name`,i.textContent=e.name,n.appendChild(r),n.appendChild(i),n.addEventListener(`click`,()=>{window.location.href=ji(e.id)}),n}static async loadTemplateById(e){if(e===`__preview__`){let e=sessionStorage.getItem(`poa-preview-html`);return e?{id:`__preview__`,type:`template`,name:`미리보기`,parentId:null,content:e,isPublic:!1,createdAt:Date.now(),updatedAt:Date.now(),order:0}:null}let t=Qi(e);if(t!==null)try{return await X.getTemplate(t)}catch{}return new ia().getById(e)??null}};if(Oi()===`user`){let e=ki();if(e){let t=await xc.loadTemplateById(e),n=document.getElementById(`editor`);t?.content&&n.setHTML(t.content),n.enterUserMode(t?.name??`문서`)}else document.getElementById(`editor-root`).classList.add(`hidden`),document.body.classList.add(`user-mode`),new xc(document.getElementById(`user-mode-root`)).renderTemplateSelector()}var Sc=document.getElementById(`editor`),Cc=document.getElementById(`output`),wc=`<h2>poa-editor v1.0.0</h2>
...
<p>표 삽입 → 삽입 메뉴 → 표를 사용해보세요.</p>`;document.getElementById(`btn-get-html`).addEventListener(`click`,()=>{Cc.style.display=`block`,Cc.textContent=Sc.getHTML()}),document.getElementById(`btn-set-html`).addEventListener(`click`,()=>{Sc.setHTML(wc),Cc.style.display=`none`}),document.getElementById(`btn-clear`).addEventListener(`click`,()=>{Sc.setHTML(``),Cc.style.display=`none`}),document.getElementById(`btn-find`).addEventListener(`click`,()=>{Sc.querySelector(`.poa-editor-content`)?.focus(),Sc.dispatchEvent(new KeyboardEvent(`keydown`,{key:`f`,ctrlKey:!0,bubbles:!0}))}),document.getElementById(`btn-replace`).addEventListener(`click`,()=>{Sc.querySelector(`.poa-editor-content`)?.focus(),Sc.dispatchEvent(new KeyboardEvent(`keydown`,{key:`h`,ctrlKey:!0,bubbles:!0}))}),document.getElementById(`btn-undo`).addEventListener(`click`,()=>{Sc.querySelector(`.poa-editor-content`)?.focus(),document.execCommand(`undo`)}),document.getElementById(`btn-redo`).addEventListener(`click`,()=>{Sc.querySelector(`.poa-editor-content`)?.focus(),document.execCommand(`redo`)}),Oi()!==`user`&&setTimeout(()=>Sc.setHTML(wc),100);