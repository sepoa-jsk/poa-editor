...
`;function Po(e,t){return e.replace(/width="24"/,`width="${t}"`).replace(/height="24"/,`height="${t}"`)}function Z(e){return Po(e,16)}function Fo(e){return Po(e,14)}function Io(e){return Po(e,12)}var Q={bold:Z(ra),italic:Z(ja),underline:Z(Ao),strike:Z(_o),undo:Z(jo),redo:Z(no),alignLeft:Z(Do),alignCenter:Z(wo),alignRight:Z(To),alignJustify:Z(Eo),indent:Z(za),outdent:Z(Ra),foreColor:Z(ta),backColor:Z(Ea),lineHeight:Z(na),letterSpacing:Z(qa),fileNew:Z(ya),fileOpen:Z(Ca),save:Z(oo),fileSaveAs:Z(va),print:Z(eo),settings:Z(uo),clock:Z(pa),cut:Z(so),copy:Z(ga),paste:Z(fa),pastePlain:Z(da),selectAll:Z(go),search:Z(co),imageEdit:Z(Da),image:Z(Oa),images:Z(ka),videoTag:Z(Sa),embedVideo:Z(la),link:Z(La),linkOff:Z(Ia),bookmark:Z(aa),signature:Z(Za),emoji:Z(mo),tooltip:Z(Ua),tooltipList:Z(Wa),calendar:Z(oa),hr:Z(Ga),symbol:Z(Ja),youtube:Z(Ka),pageBreak:Z(lo),template:Z(Fa),formField:Z(to),viewDesign:Z(Na),viewHtml:Z(ma),viewPreview:Z(_a),viewText:Z(ko),viewPage:Z(ba),fullscreen:Z(Ha),ruler:Z(ao),grid:Z(Ta),hiddenBorder:Z(go),table:Z(Co),tableProps:Z(So),cellProps:Z(Pa),mergeCells:Z(bo),splitCell:Z(xo),rowAbove:Z(ea),rowBelow:Z(Zi),colLeft:Z(Qi),colRight:Z($i),rowDelete:Z(io),colDelete:Z(ha),tableDelete:Z(Oo),painterCopy:Z(Ya),painterPaste:Z(Xa),formatClear:Z(ro),ul:Z(Va),ol:Z(Ba),sup:Z(yo),sub:Z(vo),a11y:Z(Xi),privacy:Z(fo),form:Z(ho),calc:Z(po),userMode:Z(Mo),shortcuts:Z(Ma),guide:Z(ia),about:Z(Aa),folder:Z(wa),folderOpen:Z(Ca),file:Z(xa),fileText16:Z(ba),users16:Z(No),user16:Z(Mo),userCircle:Z(ua),plus:Z($a),pencil:Z(Qa),trash:Z(Oo),link16:Z(La),chevronRight:Z(ca),chevronDown:Z(sa),folder14:Fo(wa),folderOpen14:Fo(Ca),file14:Fo(xa),fileText14:Fo(ba),users14:Fo(No),user14:Fo(Mo),chevronRight12:Io(ca),chevronDown12:Io(sa),layoutTemplate48:Po(Fa,48)},Lo={"file:new":`fileNew`,"file:open":`fileOpen`,"file:save":`save`,"file:saveas":`fileSaveAs`,"file:print":`print`,settings:`settings`,"edit:cut":`cut`,"edit:copy":`copy`,"edit:paste":`paste`,"edit:paste-plain":`pastePlain`,"edit:select-all":`selectAll`,"find-replace":`search`,"edit:image-edit":`imageEdit`,image:`image`,"insert:multi-image":`images`,"insert:video":`videoTag`,"insert:embed":`embedVideo`,"insert:link":`link`,"insert:link-remove":`linkOff`,"insert:bookmark":`bookmark`,"insert:signature":`signature`,"insert:emoji":`emoji`,"insert:tooltip":`tooltip`,"insert:tooltip-list":`tooltipList`,"insert:datetime":`calendar`,"insert:hr":`hr`,"insert:symbol":`symbol`,"insert:pagebreak":`pageBreak`,"misc:template":`template`,"view:design":`viewDesign`,"view:html":`viewHtml`,"view:preview":`viewPreview`,"view:text":`viewText`,"view:page":`viewPage`,"view:fullscreen":`fullscreen`,"view:ruler":`ruler`,"view:grid":`grid`,"view:hidden-border":`hiddenBorder`,table:`table`,"table:table-props":`tableProps`,"table:cell-props":`cellProps`,"table:merge":`mergeCells`,"table:split-cell":`splitCell`,"table:row-above":`rowAbove`,"table:row-below":`rowBelow`,"table:col-left":`colLeft`,"table:col-right":`colRight`,"table:row-delete":`rowDelete`,"table:col-delete":`colDelete`,"table:delete":`tableDelete`,"table:align-left":`alignLeft`,"table:align-center":`alignCenter`,"table:align-right":`alignRight`,"format:painter-copy":`painterCopy`,"format:painter-paste":`painterPaste`,"format:clear":`formatClear`,"format:ul":`ul`,"format:ol":`ol`,"format:sup":`sup`,"format:sub":`sub`,"misc:a11y":`a11y`,"misc:privacy":`privacy`,"misc:form":`form`,"misc:calc":`calc`,"misc:user-mode":`userMode`,"help:shortcuts":`shortcuts`,"help:guide":`guide`,"help:about":`about`},Ro=`
*, *::before, *::after { box-sizing: border-box; }
...
`,Ho=class extends HTMLElement{shadow;mgr;tree;selected=null;_getEditorHTML=null;connectedCallback(){this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${Bo}</style>${Vo}`,this.mgr=new ji,this.tree=this.shadow.querySelector(`poa-template-tree`),this.tree.setManager(this.mgr),this._bind()}setup(e){this._getEditorHTML=e}open(){this.selected=null,this._refreshPreview(),this._fillFolderSelect(),this.tree.render(),this.setAttribute(`open`,``)}close(){this.removeAttribute(`open`)}_bind(){this.shadow.querySelector(`.x-btn`).addEventListener(`click`,()=>this.close()),this.addEventListener(`click`,e=>{e.composedPath()[0]===this&&this.close()}),this.shadow.getElementById(`btn-add-folder`).addEventListener(`click`,()=>{let e=this.tree.getSelected(),t=e?.type===`folder`?e.id:null;this.tree.addFolder(t)}),this.shadow.getElementById(`btn-save-tmpl`).addEventListener(`click`,()=>{this._fillFolderSelect(),this.shadow.getElementById(`save-name`).value=``,this.shadow.getElementById(`save-overlay`).classList.remove(`hidden`),setTimeout(()=>this.shadow.getElementById(`save-name`).focus(),50)}),this.shadow.getElementById(`save-cancel`).addEventListener(`click`,()=>{this.shadow.getElementById(`save-overlay`).classList.add(`hidden`)}),this.shadow.getElementById(`save-ok`).addEventListener(`click`,()=>this._doSave()),this.shadow.getElementById(`save-name`).addEventListener(`keydown`,e=>{e.key===`Enter`&&this._doSave()}),this.shadow.getElementById(`btn-append`).addEventListener(`click`,()=>this._apply(`append`)),this.shadow.getElementById(`btn-replace`).addEventListener(`click`,()=>this._apply(`replace`)),this.shadow.addEventListener(`poa-tmpl-copy-link`,()=>{this._showToast(`링크가 복사되었습니다.`)}),this.shadow.addEventListener(`poa-tmpl-select`,e=>{let{node:t}=e.detail;this.selected=t.type===`template`?t:null,this._refreshPreview()}),this.shadow.addEventListener(`poa-tmpl-dblclick`,e=>{let{node:t}=e.detail;this.selected=t,this._apply(`replace`)})}_refreshPreview(){let e=this.shadow.getElementById(`preview-frame`),t=this.shadow.getElementById(`preview-empty`),n=this.shadow.getElementById(`btn-append`),r=this.shadow.getElementById(`btn-replace`);if(!this.selected||this.selected.type!==`template`){e.classList.add(`hidden`),t.classList.remove(`hidden`),n.disabled=!0,r.disabled=!0;return}e.srcdoc=`<!doctype html><html><head><style>
       ...
       </style></head><body>${String(j.sanitize(this.selected.content??``,{USE_PROFILES:{html:!0}}))}</body></html>`,e.classList.remove(`hidden`),t.classList.add(`hidden`),n.disabled=!1,r.disabled=!1}_apply(e){if(!this.selected?.content)return;let t=String(j.sanitize(this.selected.content,{USE_PROFILES:{html:!0}}));this.dispatchEvent(new CustomEvent(`poa-tmpl-insert`,{bubbles:!0,composed:!0,detail:{html:t,mode:e}})),e===`append`&&this.close()}_doSave(){let e=this.shadow.getElementById(`save-name`).value.trim();if(!e){this.shadow.getElementById(`save-name`).focus();return}let t=this.shadow.getElementById(`save-folder`).value||null,n=this.shadow.getElementById(`save-public`).checked,r=this._getEditorHTML?.()??``;this.mgr.addTemplate(e,r,t,n),this.tree.render(),this.shadow.getElementById(`save-overlay`).classList.add(`hidden`)}_showToast(e){let t=document.createElement(`div`);t.className=`tmpl-toast`,t.textContent=e,this.shadow.querySelector(`.dlg`).appendChild(t),setTimeout(()=>t.remove(),2200)}_fillFolderSelect(){let e=this.shadow.getElementById(`save-folder`);e.innerHTML=``;let t=this.mgr.getFolders().find(e=>!e.isPublic);for(let n of this.mgr.getFolders()){let r=document.createElement(`option`);r.value=n.id,r.textContent=n.name,n===t&&(r.selected=!0),e.appendChild(r)}}},Uo=`poa-signatures`,Wo=10;function Go(){return`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,7)}`}function $(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Ko(e){let{layout:t,fields:n,logo:r,headerColor:i=`#2563eb`}=e,a=n.displayName?`<strong style="font-size:15px;color:#111;">${$(n.displayName)}</strong>`:``,o=[n.title,n.department].filter(Boolean).map($).join(` | `),s=n.company?`<span style="color:#555;">${$(n.company)}</span>`:``,c=n.phone?`<span style="color:#888;font-size:12px;">T.</span>&nbsp;${$(n.phone)}`:``,l=n.email?`<span style="color:#888;font-size:12px;">E.</span>&nbsp;${$(n.email)}`:``,u=n.website?`<span style="color:#888;font-size:12px;">W.</span>&nbsp;${$(n.website)}`:``,d=[o?`<span style="color:#555;">${o}</span>`:``,s,c,l,u].filter(Boolean),f=r?`<img src="${$(r)}" alt="" style="max-width:80px;max-height:60px;display:block;">`:``,p=`font-size:14px;line-height:1.6;border-collapse:collapse;font-family:Arial,Helvetica,sans-serif;`,m=()=>[a,...d].filter(Boolean).join(`<br>`);switch(t){case 1:return`<table class="poa-signature" style="${p}"><tbody><tr><td style="padding:8px 0;vertical-align:top;">${m()}</td></tr></tbody></table>`;case 2:return r?`<table class="poa-signature" style="${p}"><tbody><tr><td style="padding:0 14px 0 0;vertical-align:middle;border-right:2px solid #e5e7eb;">${f}</td><td style="padding:0 0 0 14px;vertical-align:middle;">${m()}</td></tr></tbody></table>`:Ko({...e,layout:1});case 3:return r?`<table class="poa-signature" style="${p}"><tbody><tr><td style="text-align:center;padding-bottom:6px;">${f}</td></tr><tr><td style="padding:4px 0;">${m()}</td></tr></tbody></table>`:Ko({...e,layout:1});case 4:return`<table class="poa-signature" style="${p}"><tbody><tr><td style="padding:8px 0;vertical-align:top;">${a?a+`<br>`:``}<hr style="border:none;border-top:1px solid #aaa;margin:4px 0;">${d.join(`<br>`)}</td></tr></tbody></table>`;case 5:{let e=[a,n.department?`<span style="color:#555;">${$(n.department)}</span>`:``].filter(Boolean).join(`<br>`),t=[n.title?`<span style="color:#555;">${$(n.title)}</span>`:``,s].filter(Boolean).join(`<br>`),r=[c,l].filter(Boolean).join(`&nbsp;|&nbsp;`);return`<table class="poa-signature" style="${p}"><tbody><tr><td style="padding:4px 14px 4px 0;border-right:1px solid #ddd;vertical-align:top;">${e||`&nbsp;`}</td><td style="padding:4px 0 4px 14px;vertical-align:top;">${t||`&nbsp;`}</td></tr>`+(r?`<tr><td colspan="2" style="padding:6px 0 4px;border-top:1px solid #eee;font-size:13px;">${r}</td></tr>`:``)+`</tbody></table>`}case 6:{let e=[n.displayName?`<strong style="color:#fff;">${$(n.displayName)}</strong>`:``,n.title?`<span style="color:rgba(255,255,255,.85);">${$(n.title)}</span>`:``].filter(Boolean).join(`&nbsp;&nbsp;`),t=[n.department?`<span style="color:#555;">${$(n.department)}</span>`:``,s,c,l,u].filter(Boolean);return`<table class="poa-signature" style="${p}border:1px solid ${$(i)};"><tbody><tr><td style="background:${$(i)};padding:8px 16px;">${e||`&nbsp;`}</td></tr><tr><td style="padding:8px 16px;">${t.join(`<br>`)||`&nbsp;`}</td></tr></tbody></table>`}default:return``}}var qo=class{sigs=[];constructor(){this._load()}_load(){try{let e=localStorage.getItem(Uo);this.sigs=e?JSON.parse(e):[]}catch{this.sigs=[]}}_persist(){try{localStorage.setItem(Uo,JSON.stringify(this.sigs))}catch{}}getAll(){return[...this.sigs]}getById(e){return this.sigs.find(t=>t.id===e)??null}add(e){if(this.sigs.length>=Wo)throw Error(`최대 ${Wo}개까지 저장할 수 있습니다.`);let t={...e,id:Go(),createdAt:Date.now(),updatedAt:Date.now()};return this.sigs.push(t),this._persist(),t}update(e,t){let n=this.sigs.find(t=>t.id===e);return n?(Object.assign(n,t,{updatedAt:Date.now()}),this._persist(),!0):!1}delete(e){let t=this.sigs.findIndex(t=>t.id===e);return t<0?!1:(this.sigs.splice(t,1),this._persist(),!0)}isFull(){return this.sigs.length>=Wo}},Jo={1:`기본형`,2:`로고(좌)`,3:`로고(상)`,4:`구분선형`,5:`2단형`,6:`컬러헤더`},Yo=`
*, *::before, *::after { box-sizing: border-box; }
:host { display: none; position: fixed; inset: 0; z-index: 9999; align-items: center; justify-content: center; }
:host([open]) { display: flex; background: rgba(0,0,0,.45); }
...
`,$o=class extends HTMLElement{shadow;inserter=new Wr;activeCatId=Vr[0].id;connectedCallback(){this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${Qo}</style>
<div class="dlg">
...
.hidden { display: none !important; }
`,ts=class extends HTMLElement{shadow;mode=`add`;editId=null;entries=[];connectedCallback(){this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${es}</style>
<div class="dlg">
  <div class="hdr">
...
`,rs=class extends HTMLElement{shadow;targetInput=null;connectedCallback(){this.shadow||(this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${ns}</style>${this._tpl()}`,this._bindEvents())}open(e){this.shadow||this.connectedCallback(),this.targetInput=e,this._populate(e),this.setAttribute(`open`,``)}close(){this.removeAttribute(`open`)}_tpl(){return`<div class="dlg">
  <div class="hdr">
    <h3>입력 요소 속성</h3>
    <button class="x-btn" aria-label="닫기">✕</button>
  </div>
...
`;function ws(e){return new Date(e).toLocaleString(`ko-KR`,{month:`2-digit`,day:`2-digit`,hour:`2-digit`,minute:`2-digit`,second:`2-digit`})}var Ts=class extends HTMLElement{shadow;autoSave=null;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${Cs}</style>
  ...
  <div class="dialog" role="dialog" aria-modal="true" aria-label="설정">
    ...
    <div class="body">
      ...
      <div class="section">
        ...
        <span class="history-time">${ws(n.savedAt)}</span>
        <button class="restore-btn" data-id="${String(n.id)}">복원</button>`,t.querySelector(`.restore-btn`).addEventListener(`click`,()=>{this.handleRestore(n)}),e.appendChild(t)}}handleRestore(e){this.dispatchEvent(new CustomEvent(`poa-autosave-restore`,{bubbles:!0,composed:!0,detail:{html:e.html}})),this.close()}},Es=`
/* ── 호스트 슬라이드 애니메이션 ── */
:host {
  display: block;
  overflow: hidden;
...
`,As=class extends HTMLElement{shadow;editor=new Ii;originalSrc=``;currentDataUrl=``;busy=!1;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${ks}</style>
<div class="backdrop" id="backdrop">
...
.grid-picker {
  display: grid;
  grid-template-columns: repeat(${Ps}, ${Is}px);
  gap: ${Ls}px;
  cursor: crosshair;
}
.gc {
...
`,zs=class e extends HTMLElement{shadow;selectedPreset=`border-all`;gridCells=[];constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${Rs}</style>
<div class="overlay" id="overlay">
  <div class="dialog" role="dialog" aria-modal="true">
    <div class="dlg-hd">
...
</div>`;let l=s;t.querySelector(`#pp-align-btns`).addEventListener(`click`,e=>{let n=e.target.closest(`.align-btn`);n&&(l=n.dataset.align,t.querySelectorAll(`.align-btn`).forEach(e=>{e.classList.toggle(`active`,e.dataset.align===l)}))}),t.querySelector(`#pp-cancel`).addEventListener(`click`,()=>this.close()),t.querySelector(`#pp-ok`).addEventListener(`click`,()=>{let e={width:t.querySelector(`#pp-w`).value.trim(),borderColor:t.querySelector(`#pp-bc`).value,bgColor:t.querySelector(`#pp-bg`).value,align:l};this.dispatchEvent(new CustomEvent(`poa-table-update`,{bubbles:!0,composed:!0,detail:{options:e,table:n}})),this.close()})}static rgbToHex(e){let t=e.match(/\d+/g);return!t||t.length<3?``:`#`+t.slice(0,3).map(e=>parseInt(e).toString(16).padStart(2,`0`)).join(``)}static colorToHex(t){return e.rgbToHex(t)||`#ffffff`}},Bs=[{label:`날짜 (2025-05-05)`,fn:()=>new Date().toISOString().slice(0,10)},{label:`시간 (14:30:05)`,fn:()=>new Intl.DateTimeFormat(`ko-KR`,{hour:`2-digit`,minute:`2-digit`,second:`2-digit`,hour12:!1}).format(new Date)},{label:`날짜·시간 (2025-05-05 14:30)`,fn:()=>{let e=new Date;return`${e.toISOString().slice(0,10)} ${new Intl.DateTimeFormat(`ko-KR`,{hour:`2-digit`,minute:`2-digit`,hour12:!1}).format(e)}`}},{label:`한국어 날짜 (2025년 5월 5일)`,fn:()=>new Intl.DateTimeFormat(`ko-KR`,{year:`numeric`,month:`long`,day:`numeric`}).format(new Date)},{label:`한국어 날짜·시간 (2025년 5월 5일 월요일 오후 2:30)`,fn:()=>new Intl.DateTimeFormat(`ko-KR`,{year:`numeric`,month:`long`,day:`numeric`,weekday:`long`,hour:`numeric`,minute:`2-digit`}).format(new Date)}],Vs=`
:host { display: none; }
:host([open]) { display: block; }
.backdrop {
  position: fixed; inset: 0; background: rgba(0,0,0,.45);
...
`,Hs=class extends HTMLElement{shadow;bookmarks=[];editingId=null;editingAnchor=null;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${Vs}</style>
<div class="backdrop" id="backdrop">
  <div class="dialog" role="dialog" aria-modal="true" aria-label="링크 삽입">
    ...
    `).join(``),this.refreshDatetimePreviews(),e.addEventListener(`click`,e=>{let t=e.target.closest(`[data-preset]`);if(!t)return;let n=Bs[parseInt(t.dataset.preset??`0`)]?.fn()??``;this.dispatch(`poa-datetime-insert`,{text:n}),this.close()}))}refreshDatetimePreviews(){Bs.forEach((e,t)=>{let n=this.shadow.getElementById(`dt-prev-${t}`);n&&(n.textContent=e.fn())})}dispatch(e,t){this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0,detail:t}))}},Us=`
:host { display: none; }
:host([open]) {
  display: flex; align-items: center; gap: 6px;
...
`,Ws=class extends HTMLElement{shadow;img=null;aspectLocked=!1;naturalW=0;naturalH=0;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${Us}</style>
<label>너비</label>
...
`,qs=class extends HTMLElement{shadow;resolvePromise=null;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${Gs}</style>${Ks}`,this.bindEvents()}show(e,t=`확인`){let n=this.shadow.getElementById(`dlg-title`),r=this.shadow.getElementById(`dlg-message`);return n&&(n.textContent=t),r&&(r.textContent=e),this.setAttribute(`open`,``),new Promise(e=>{this.resolvePromise=e})}close(e){this.removeAttribute(`open`),this.resolvePromise?.(e),this.resolvePromise=null}bindEvents(){this.shadow.getElementById(`btn-ok`)?.addEventListener(`click`,()=>this.close(!0)),this.shadow.getElementById(`btn-cancel`)?.addEventListener(`click`,()=>this.close(!1)),this.shadow.getElementById(`overlay`)?.addEventListener(`click`,e=>{e.target.id===`overlay`&&this.close(!1)}),this.addEventListener(`keydown`,e=>{e.key===`Escape`&&(e.preventDefault(),this.close(!1))})}},Js={error:`●`,warning:`▲`,info:`ℹ`},Ys={error:`#DC2626`,warning:`#D97706`,info:`#2563EB`},Xs=`
:host { display: none; }
:host([open]) { display: block; }
...
`,Zs=class extends HTMLElement{shadow;issues=[];contentEl=null;rerunFn=null;currentFilter=`all`;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${Xs}</style>
<div class="overlay" id="overlay">
  <div class="dialog">
    <div class="header">
      <h2>웹 접근성 검사 결과</h2>
...
`,nc=class extends HTMLElement{shadow;items=[];filteredType=`all`;onModified=null;onConfirmFn=null;constructor(){super(),this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${tc}</style><slot></slot>`}setup(e,t){this.onModified=e,this.onConfirmFn=t}startLoading(){this.setAttribute(`open`,``),this.shadow.innerHTML=`<style>${tc}</style>
<div class="overlay">
  <div class="dialog">
    <div class="header">
      <h2>개인정보 검사</h2>
...
<div class="card" data-level="${e.riskLevel}" data-id="${e.id}">
  <div class="card-header" data-toggle="${e.id}">
    <span class="card-icon">${$s[e.riskLevel]}</span>
    <span class="card-label">${e.label}</span>
    <span class="card-risk">${ec[e.riskLevel]}</span>
    <span class="card-toggle">∨</span>
  </div>
  <div class="card-body" id="body-${e.id}">
    <div class="raw-text">"${rc(e.raw)}"</div>
...
`,ac=class extends HTMLElement{shadow;currentTable=null;currentRow=1;currentCol=1;pickBar=null;constructor(){super(),this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${ic}</style>`}open(e){this.currentTable=e.table,this.currentRow=e.cellRow,this.currentCol=e.cellCol,this.setAttribute(`open`,``),this.render(e.existingFormula,e.initialRange)}close(){this.removeAttribute(`open`),this.exitPickMode(),this.currentTable=null}applyRange(e,t,n,r){this.exitPickMode();let i=e=>this.shadow.getElementById(e),a=(e,t)=>{let n=i(e);n&&(n.value=String(t))};a(`sr`,e),a(`sc`,t),a(`er`,n),a(`ec`,r)}render(e,t){let n=e?.fn??`SUM`,r=e?.format??`integer`,i=e?.decimalPlaces??2,[a,o,s,c]=e?.range??t??[1,1,1,1],l=e?.targetRow??this.currentRow,u=e?.targetCol??this.currentCol,d=!e||e.targetRow===this.currentRow&&e.targetCol===this.currentCol,f=e?.style?.backgroundColor??`#ffffff`,p=e?.style?.color??`#000000`,m=(e,t)=>`<label><input type="radio" name="fn" value="${e}"${n===e?` checked`:``}> ${e} (${t})</label>`,h=(e,t)=>`<label><input type="radio" name="format" value="${e}"${r===e?` checked`:``}> ${t}</label>`;this.shadow.innerHTML=`<style>${ic}</style>
<div class="overlay" id="overlay">
  <div class="dialog" id="dialog">
    <div class="header">
      <h2>계산식 설정</h2>
    ...
    <div class="footer">
      ...
      ">취소</button>`,document.body.appendChild(e),this.pickBar=e,e.querySelector(`#cancel-pick`)?.addEventListener(`click`,()=>this.exitPickMode()),this.dispatchEvent(new CustomEvent(`poa-formula-start-pick`,{bubbles:!0}))}exitPickMode(){this.shadow.getElementById(`overlay`)?.classList.remove(`pick-mode`),this.pickBar?.remove(),this.pickBar=null}};customElements.get(`poa-menubar`)||customElements.define(`poa-menubar`,ss),customElements.get(`poa-context-toolbar`)||customElements.define(`poa-context-toolbar`,ms),customElements.get(`poa-toolbar`)||customElements.define(`poa-toolbar`,xs),customElements.get(`poa-status-bar`)||customElements.define(`poa-status-bar`,Ss),customElements.get(`poa-settings-dialog`)||customElements.define(`poa-settings-dialog`,Ts),customElements.get(`poa-find-replace-dialog`)||customElements.define(`poa-find-replace-dialog`,Os),customElements.get(`poa-image-edit-dialog`)||customElements.define(`poa-image-edit-dialog`,As),customElements.get(`poa-image-dialog`)||customElements.define(`poa-image-dialog`,Ns),customElements.get(`poa-table-dialog`)||customElements.define(`poa-table-dialog`,zs),customElements.get(`poa-cell-split-dialog`)||customElements.define(`poa-cell-split-dialog`,Vi),customElements.get(`poa-link-dialog`)||customElements.define(`poa-link-dialog`,Hs),customElements.get(`poa-image-toolbar`)||customElements.define(`poa-image-toolbar`,Ws),customElements.get(`poa-confirm-dialog`)||customElements.define(`poa-confirm-dialog`,qs),customElements.get(`poa-accessibility-dialog`)||customElements.define(`poa-accessibility-dialog`,Zs),customElements.get(`poa-privacy-dialog`)||customElements.define(`poa-privacy-dialog`,nc),customElements.get(`poa-formula-dialog`)||customElements.define(`poa-formula-dialog`,ac),customElements.get(`poa-video-dialog`)||customElements.define(`poa-video-dialog`,Ui),customElements.get(`poa-form-control-dialog`)||customElements.define(`poa-form-control-dialog`,Yi),customElements.get(`poa-template-tree`)||customElements.define(`poa-template-tree`,zo),customElements.get(`poa-template-dialog`)||customElements.define(`poa-template-dialog`,Ho),customElements.get(`poa-signature-dialog`)||customElements.define(`poa-signature-dialog`,Zo),customElements.get(`poa-emoji-dialog`)||customElements.define(`poa-emoji-dialog`,$o),customElements.get(`poa-tooltip-dialog`)||customElements.define(`poa-tooltip-dialog`,ts),customElements.get(`poa-input-property-dialog`)||customElements.define(`poa-input-property-dialog`,rs),customElements.get(`poa-editor`)||customElements.define(`poa-editor`,Fi);var oc=class{mgr;constructor(e){this.container=e,this.mgr=new ji}renderTemplateSelector(){this.container.innerHTML=``;let e=document.createElement(`h2`);e.className=`user-mode-selector-title`,e.textContent=`양식 선택`,this.container.appendChild(e);let t=document.createElement(`div`);t.className=`user-mode-card-grid`;let n=this.mgr.getAll().filter(e=>e.type===`template`&&!e.isTemp);if(n.length===0){let e=document.createElement(`p`);e.style.cssText=`color:#9ca3af;font-size:14px;`,e.textContent=`저장된 템플릿이 없습니다.`,t.appendChild(e)}else for(let e of n)t.appendChild(this._buildCard(e));this.container.appendChild(t)}_buildCard(e){let t=document.createElement(`div`);t.className=`user-mode-card`;let n=document.createElement(`div`);n.className=`user-mode-card-icon`,n.textContent=`📄`;let r=document.createElement(`div`);return r.className=`user-mode-card-name`,r.textContent=e.name,t.appendChild(n),t.appendChild(r),t.addEventListener(`click`,()=>{window.location.href=xi(e.id)}),t}};if(vi()===`user`){let e=yi();if(e){let t=new ji().getById(e),n=document.getElementById(`editor`);t?.content&&n.setHTML(t.content),n.enterUserMode(t?.name??`문서`)}else document.getElementById(`editor-root`).classList.add(`hidden`),document.body.classList.add(`user-mode`),new oc(document.getElementById(`user-mode-root`)).renderTemplateSelector()}var sc=document.getElementById(`editor`),cc=document.getElementById(`output`),lc=`<h2>poa-editor v1.0.0</h2>
