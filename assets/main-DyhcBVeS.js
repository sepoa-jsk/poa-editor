...
`,$o=class extends HTMLElement{shadow;inserter=new Ur;activeCatId=Br[0].id;connectedCallback(){this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${Qo}</style>
<div class="dlg">
