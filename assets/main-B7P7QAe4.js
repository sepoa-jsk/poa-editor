...
`;class Fl extends HTMLElement{constructor(){super();c(this,"shadow");c(this,"editor",new br);c(this,"originalSrc","");c(this,"currentDataUrl","");c(this,"busy",!1);this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){this.shadow.innerHTML=`<style>${Rl}</style>
<div class="backdrop" id="backdrop">
