...
<p>표 삽입 → 삽입 메뉴 → 표를 사용해보세요.</p>`;document.getElementById(`btn-get-html`).addEventListener(`click`,()=>{mc.style.display=`block`,mc.textContent=pc.getHTML()}),document.getElementById(`btn-set-html`).addEventListener(`click`,()=>{pc.setHTML(hc),mc.style.display=`none`}),document.getElementById(`btn-clear`).addEventListener(`click`,()=>{pc.setHTML(``),mc.style.display=`none`}),document.getElementById(`btn-find`).addEventListener(`click`,()=>{pc.querySelector(`.poa-editor-content`)?.focus(),pc.dispatchEvent(new KeyboardEvent(`keydown`,{key:`f`,ctrlKey:!0,bubbles:!0}))}),document.getElementById(`btn-replace`).addEventListener(`click`,()=>{pc.querySelector(`.poa-editor-content`)?.focus(),pc.dispatchEvent(new KeyboardEvent(`keydown`,{key:`h`,ctrlKey:!0,bubbles:!0}))}),document.getElementById(`btn-undo`).addEventListener(`click`,()=>{pc.querySelector(`.poa-editor-content`)?.focus(),document.execCommand(`undo`)}),document.getElementById(`btn-redo`).addEventListener(`click`,()=>{pc.querySelector(`.poa-editor-content`)?.focus(),document.execCommand(`redo`)}),vi()!==`user`&&setTimeout(()=>pc.setHTML(hc),100);