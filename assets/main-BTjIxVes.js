...
<div style="display:flex;justify-content:flex-end;gap:8px;margin-top:16px;">
  ...
  <button id="cp-ok" style="height:28px;padding:0 14px;border:1px solid #1565c0;border-radius:3px;background:#1565c0;color:#fff;cursor:pointer;">적용</button>
    ...
    <line x1="3"  y1="25" x2="37" y2="25" stroke="#bbb" stroke-width="1"/>`),"border-thick":dn(`
    ...
    <line x1="2"  y1="25" x2="38" y2="25" stroke="#aaa" stroke-width="1"/>`),"header-light":dn(`
    ...
    <line x1="25" y1="3" x2="25" y2="37" stroke="#ccc" stroke-width="1"/>`),"header-dark":dn(`
    ...
    <line x1="25" y1="3" x2="25" y2="37" stroke="#888" stroke-width="1"/>`),"stripe-light":dn(`
    ...
    <line x1="25" y1="3" x2="25" y2="37" stroke="#ddd" stroke-width="1"/>`),"stripe-dark":dn(`
    ...
    <line x1="14" y1="3" x2="14" y2="37" stroke="#bbb" stroke-width="1"/>
    <line x1="25" y1="3" x2="25" y2="37" stroke="#bbb" stroke-width="1"/>`),borderless:dn(`
    ...
    <line x1="3"  y1="25" x2="37" y2="25" stroke="#e0e0e0" stroke-width="1" stroke-dasharray="2,2"/>`),dashed:dn(`
    ...
    <line x1="3"  y1="25" x2="37" y2="25" stroke="#999" stroke-width="1" stroke-dasharray="3,2"/>`)},pn=[{id:`border-all`,label:`전체 테두리`,icon:fn[`border-all`],baseOptions:{width:`100%`,border:1,borderColor:`#cccccc`,headerPosition:`none`},apply:e=>{for(let t of cn(e))t.style.cssText=`border:1px solid #ccc;${W}`}},{id:`border-thick`,label:`굵은 외부`,icon:fn[`border-thick`],baseOptions:{width:`100%`,border:1,borderColor:`#aaaaaa`,headerPosition:`none`},apply:e=>{for(let t of cn(e))t.style.cssText=`border:1px solid #aaa;${W}`;e.style.boxShadow=`0 0 0 2px #333333`}},{id:`header-light`,label:`헤더 강조`,icon:fn[`header-light`],baseOptions:{width:`100%`,border:1,borderColor:`#cccccc`,headerPosition:`top`},apply:e=>{for(let t of cn(e))t.style.cssText=`border:1px solid #ccc;${W}`;for(let t of ln(e))t.style.cssText=`border:1px solid #ccc;${W}background:#f0f0f0;font-weight:bold;`}},{id:`header-dark`,label:`헤더 진한`,icon:fn[`header-dark`],baseOptions:{width:`100%`,border:1,borderColor:`#aaaaaa`,headerPosition:`top`},apply:e=>{for(let t of cn(e))t.style.cssText=`border:1px solid #aaa;${W}`;for(let t of ln(e))t.style.cssText=`border:1px solid #555;${W}background:#333333;color:#ffffff;font-weight:bold;`}},{id:`stripe-light`,label:`줄무늬`,icon:fn[`stripe-light`],baseOptions:{width:`100%`,border:1,borderColor:`#dddddd`,headerPosition:`none`},apply:e=>{for(let t of cn(e))t.style.cssText=`border:1px solid #ddd;${W}`;un(e).forEach((e,t)=>{let n=t%2==0?`#f9f9f9`:``;for(let t of Array.from(e.querySelectorAll(`td,th`)))t.style.backgroundColor=n})}},{id:`stripe-dark`,label:`진한 줄무늬`,icon:fn[`stripe-dark`],baseOptions:{width:`100%`,border:1,borderColor:`#bbbbbb`,headerPosition:`none`},apply:e=>{for(let t of cn(e))t.style.cssText=`border:1px solid #bbb;${W}`;un(e).forEach((e,t)=>{let n=t%2==0?`#e0e0e0`:``;for(let t of Array.from(e.querySelectorAll(`td,th`)))t.style.backgroundColor=n})}},{id:`borderless`,label:`테두리 없음`,icon:fn.borderless,baseOptions:{width:`100%`,border:0,headerPosition:`none`},apply:e=>{for(let t of cn(e))t.style.cssText=`border:none;${W}`;e.removeAttribute(`border`)}},{id:`dashed`,label:`점선 테두리`,icon:fn.dashed,baseOptions:{width:`100%`,border:1,borderColor:`#999999`,headerPosition:`none`},apply:e=>{for(let t of cn(e))t.style.cssText=`border:1px dashed #999;${W}`}}];function mn(e,t){pn.find(t=>t.id===e)?.apply(t)}var hn=new Set([`http:`,`https:`,`mailto:`,`tel:`]);function gn(e){if(e.startsWith(`#`))return e.length>1;try{let t=new URL(e);return hn.has(t.protocol)}catch{return!1}}var _n=class{root;savedRange=null;constructor(e){this.root=e}saveSelection(){let e=this.root.ownerDocument.getSelection();e&&e.rangeCount>0&&(this.savedRange=e.getRangeAt(0).cloneRange())}insertLink(e){if(!gn(e.href))throw Error(`유효하지 않은 URL입니다.`);let t=this.root.ownerDocument.createElement(`a`);t.href=e.href,e.title&&(t.title=e.title),e.target===`_blank`&&(t.target=`_blank`,t.rel=`noopener noreferrer`),t.textContent=this.savedRange?.toString().trim()||e.text.trim()||e.href,e.target===`_self`&&(t.target=`_self`),this.insertNode(t)}updateLink(e,t){if(t.href!==void 0){if(!gn(t.href))throw Error(`유효하지 않은 URL입니다.`);e.href=t.href}t.text!==void 0&&(e.textContent=t.text),t.title!==void 0&&(e.title=t.title),t.target!==void 0&&(t.target===`_blank`?(e.target=`_blank`,e.rel=`noopener noreferrer`):(e.target=`_self`,e.removeAttribute(`rel`)))}removeLink(e){let t=e.parentNode;if(t){for(;e.firstChild;)t.insertBefore(e.firstChild,e);t.removeChild(e)}}getFocusedAnchor(){let e=this.root.ownerDocument.getSelection();if(!e||e.rangeCount===0)return null;let t=e.getRangeAt(0).startContainer;for(;t&&t!==this.root;){if(t.nodeType===Node.ELEMENT_NODE&&t.tagName===`A`)return t;t=t.parentNode}return null}insertNode(e){let t=this.root.ownerDocument,n=t.getSelection(),r;this.savedRange?(r=this.savedRange.cloneRange(),this.savedRange=null):n&&n.rangeCount>0?r=n.getRangeAt(0):(r=t.createRange(),r.selectNodeContents(this.root),r.collapse(!1)),r.deleteContents(),r.insertNode(e),r.setStartAfter(e),r.collapse(!0),n?.removeAllRanges(),n?.addRange(r)}};function vn(){let e=new Uint8Array(6);return crypto.getRandomValues(e),Array.from(e,e=>e.toString(16).padStart(2,`0`)).join(``)}var yn=class{root;savedRange=null;constructor(e){this.root=e}saveSelection(){let e=this.root.ownerDocument.getSelection();e&&e.rangeCount>0&&(this.savedRange=e.getRangeAt(0).cloneRange())}insert(e){let t=`bm-${vn()}`,n=this.root.ownerDocument.createElement(`a`);return n.id=t,n.setAttribute(`name`,t),n.className=`poa-bookmark`,n.setAttribute(`data-label`,e),n.title=e||t,n.textContent=`[${e||t}]`,n.contentEditable=`false`,this.insertAtRange(n),t}getAll(){return Array.from(this.root.querySelectorAll(`a.poa-bookmark[id^="bm-"]`)).map(e=>({id:e.id,label:e.getAttribute(`data-label`)??e.id,element:e}))}update(e,t){let n=this.root.querySelector(`a[id="${e}"]`);if(!n)throw Error(`책갈피 '${e}'를 찾을 수 없습니다.`);n.setAttribute(`data-label`,t),n.title=t,n.textContent=`[${t||e}]`}remove(e){this.root.querySelector(`a[id="${e}"]`)?.remove()}insertAtRange(e){let t=this.root.ownerDocument,n=t.getSelection(),r;this.savedRange?(r=this.savedRange.cloneRange(),this.savedRange=null):n&&n.rangeCount>0?r=n.getRangeAt(0):(r=t.createRange(),r.selectNodeContents(this.root),r.collapse(!1)),r.collapse(!0),r.insertNode(e),r.setStartAfter(e),r.collapse(!0),n?.removeAllRanges(),n?.addRange(r)}},bn=[{dir:`nw`,cursor:`nw-resize`,top:`0`,left:`0`},{dir:`n`,cursor:`n-resize`,top:`0`,left:`50%`},{dir:`ne`,cursor:`ne-resize`,top:`0`,left:`100%`},{dir:`e`,cursor:`e-resize`,top:`50%`,left:`100%`},{dir:`se`,cursor:`se-resize`,top:`100%`,left:`100%`},{dir:`s`,cursor:`s-resize`,top:`100%`,left:`50%`},{dir:`sw`,cursor:`sw-resize`,top:`100%`,left:`0`},{dir:`w`,cursor:`w-resize`,top:`50%`,left:`0`}],xn=20,Sn=class{root;cb;overlay=null;activeImg=null;dragging=!1;dragDir=`se`;dragStartX=0;dragStartY=0;dragStartW=0;dragStartH=0;constructor(e,t={}){this.root=e,this.cb=t}attach(){this.root.style.position||(this.root.style.position=`relative`),this.root.addEventListener(`click`,this.onRootClick,!0),this.root.addEventListener(`contextmenu`,this.onContextMenu),this.root.addEventListener(`input`,this.onContentInput),document.addEventListener(`mousemove`,this.onMouseMove),document.addEventListener(`mouseup`,this.onMouseUp)}detach(){this.deactivate(),this.root.removeEventListener(`click`,this.onRootClick,!0),this.root.removeEventListener(`contextmenu`,this.onContextMenu),this.root.removeEventListener(`input`,this.onContentInput),document.removeEventListener(`mousemove`,this.onMouseMove),document.removeEventListener(`mouseup`,this.onMouseUp)}getActiveImage(){return this.activeImg}syncOverlay(){this.updatePos()}deactivate(){this.overlay?.remove(),this.overlay=null,this.activeImg&&(this.activeImg=null,this.cb.onDeactivate?.())}activate(e){this.activeImg!==e&&(this.overlay?.remove(),this.activeImg=e,this.createOverlay(),this.cb.onActivate?.(e))}createOverlay(){if(!this.activeImg)return;let e=document.createElement(`div`);e.className=`poa-img-resize-overlay`,e.dataset.poaTemp=`true`,e.style.cssText=`position:absolute;border:2px solid #0078d7;pointer-events:none;z-index:10;box-sizing:border-box;`;for(let t of bn){let n=document.createElement(`div`);n.dataset.dir=t.dir,n.style.cssText=`position:absolute;width:8px;height:8px;background:#0078d7;border:1px solid #fff;border-radius:1px;box-sizing:border-box;cursor:${t.cursor};top:${t.top};left:${t.left};transform:translate(-50%,-50%);pointer-events:all;z-index:11;`,n.addEventListener(`mousedown`,this.onHandleMouseDown),e.appendChild(n)}this.root.appendChild(e),this.overlay=e,this.updatePos()}updatePos(){if(!this.overlay||!this.activeImg)return;let e=this.activeImg.getBoundingClientRect(),t=this.root.getBoundingClientRect(),n=e.top-t.top+this.root.scrollTop,r=e.left-t.left+this.root.scrollLeft;Object.assign(this.overlay.style,{top:`${n}px`,left:`${r}px`,width:`${e.width}px`,height:`${e.height}px`})}onRootClick=e=>{let t=e.target;this.overlay?.contains(t)||(t.tagName===`IMG`?this.activate(t):this.deactivate())};onContextMenu=e=>{let t=e.target;if(t.tagName!==`IMG`)return;e.preventDefault();let n=t;this.activate(n),this.cb.onContextMenu?.(n,e.clientX,e.clientY)};onContentInput=()=>{this.activeImg&&!this.root.contains(this.activeImg)&&this.deactivate()};onHandleMouseDown=e=>{if(!this.activeImg)return;let t=e.currentTarget.dataset.dir;e.preventDefault(),e.stopPropagation();let n=this.activeImg.getBoundingClientRect();this.dragging=!0,this.dragDir=t,this.dragStartX=e.clientX,this.dragStartY=e.clientY,this.dragStartW=n.width,this.dragStartH=n.height,document.body.style.cursor=e.currentTarget.style.cursor,document.body.style.userSelect=`none`};onMouseMove=e=>{if(!this.dragging||!this.activeImg)return;let t=e.clientX-this.dragStartX,n=e.clientY-this.dragStartY,r=this.dragDir,i=this.root.clientWidth,a=this.dragStartW,o=this.dragStartH;(r===`e`||r===`ne`||r===`se`)&&(a=this.dragStartW+t),(r===`w`||r===`nw`||r===`sw`)&&(a=this.dragStartW-t),(r===`s`||r===`se`||r===`sw`)&&(o=this.dragStartH+n),(r===`n`||r===`ne`||r===`nw`)&&(o=this.dragStartH-n);let s=r===`nw`||r===`ne`||r===`sw`||r===`se`;if(e.shiftKey&&s&&this.dragStartH>0){let e=this.dragStartW/this.dragStartH;Math.abs(t)>=Math.abs(n)?o=a/e:a=o*e}a=Math.max(xn,Math.min(i,a)),o=Math.max(xn,o),this.activeImg.style.width=`${Math.round(a)}px`,this.activeImg.style.height=`${Math.round(o)}px`,this.updatePos(),this.cb.onResize?.(this.activeImg)};onMouseUp=()=>{this.dragging&&(this.dragging=!1,document.body.style.cursor=``,document.body.style.userSelect=``,this.activeImg&&(this.updatePos(),this.cb.onResizeEnd?.()))}},Cn=794,wn=1123,Tn={top:60,right:80,bottom:60,left:80},En=`poa-print-styles`,Dn=class{container=null;mount(e,t,n=[],r=Tn){this.container=e,e.innerHTML=``;let i=document.createElement(`div`);i.className=`poa-page-main`,i.style.cssText=`flex:1;overflow-y:auto;padding:20px;display:flex;flex-direction:column;align-items:center;background:#e8e8e8;`,this.injectPrintStyles(r);let a=this.splitByPageBreaks(t);for(let e of a)i.appendChild(this.buildPage(e,r));e.appendChild(i),n.length>0&&e.appendChild(this.buildSidebar(n))}unmount(){this.container&&=(this.container.innerHTML=``,null),document.getElementById(En)?.remove()}getPageCount(e){return this.splitByPageBreaks(e).length}buildPage(e,t){let n=document.createElement(`div`);return n.className=`poa-a4-page`,n.style.cssText=[`width:${Cn}px`,`min-height:${wn}px`,`background:#fff`,`box-shadow:0 2px 8px rgba(0,0,0,.2)`,`padding:${t.top}px ${t.right}px ${t.bottom}px ${t.left}px`,`box-sizing:border-box`,`margin-bottom:20px`,`position:relative`,`font-size:14px`,`line-height:1.6`].join(`;`),n.innerHTML=e,n}buildSidebar(e){let t=document.createElement(`div`);t.className=`poa-page-sidebar`,t.style.cssText=[`width:180px`,`flex-shrink:0`,`overflow-y:auto`,`background:#fafafa`,`border-left:1px solid #ddd`,`padding:12px`].join(`;`);let n=document.createElement(`div`);n.style.cssText=`font-size:12px;font-weight:600;color:#555;margin-bottom:8px;padding-bottom:6px;border-bottom:1px solid #eee;`,n.textContent=`책갈피`,t.appendChild(n);for(let n of e){let e=document.createElement(`a`);e.href=`#${n.id}`,e.textContent=n.label,e.style.cssText=`display:block;font-size:12px;color:#1976d2;text-decoration:none;padding:5px 0;border-bottom:1px solid #f0f0f0;`,e.addEventListener(`mouseenter`,()=>{e.style.textDecoration=`underline`}),e.addEventListener(`mouseleave`,()=>{e.style.textDecoration=`none`}),t.appendChild(e)}return t}splitByPageBreaks(e){let t=e.split(/<hr[^>]*class="[^"]*poa-page-break[^"]*"[^>]*\/?>|<div[^>]*class="[^"]*poa-page-break[^"]*"[^>]*>[\s\S]*?<\/div>/gi);return t.length>0?t:[e]}injectPrintStyles(e){if(document.getElementById(En))return;let t=document.createElement(`style`);t.id=En,t.textContent=`
@media print {
...
<div id="pf-header" style="padding:10px 12px 10px;display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid #F1F5F9;gap:8px;cursor:move;">
  <div style="display:flex;align-items:center;gap:8px;min-width:0;">
    <span style="display:inline-flex;align-items:center;justify-content:center;width:26px;height:26px;background:linear-gradient(135deg,#3B82F6,#2563EB);border-radius:7px;color:#fff;font-size:11px;font-weight:700;flex-shrink:0;">${Zr[u]??`T`}</span>
...
</div>`,n.body.appendChild(O),this.popupEl=O;let k=e=>O.querySelector(`#${e}`),ue=()=>(y.tagName,y.value),de=e=>{y.tagName,y.value=e};O.querySelector(`#pf-value`).addEventListener(`input`,e=>{let n=e.target.value;if(h){t.setAttribute(q.rawValue,n);let e=t.getAttribute(q.numberFormat)??`none`;de(e===`none`?n:si(n,e))}else if(g){t.setAttribute(q.rawValue,n);let e=t.getAttribute(q.dateFormat)??`YYYY-MM-DD`;de(n?oi(n,e):``)}else de(n)}),k(`pf-prefix`).addEventListener(`input`,e=>{t.setAttribute(q.prefix,e.target.value)}),k(`pf-suffix`).addEventListener(`input`,e=>{t.setAttribute(q.suffix,e.target.value)}),k(`pf-fontsize`).addEventListener(`change`,e=>{let n=e.target.value;t.setAttribute(q.fontSize,n),n===`0`?y.style.fontSize=``:y.style.fontSize=`${n}px`}),k(`pf-font`).addEventListener(`change`,e=>{let n=e.target.value;t.setAttribute(q.fontFamily,n),y.style.fontFamily=n||`inherit`}),k(`pf-size-fixed`).addEventListener(`change`,e=>{let n=e.target.value;t.setAttribute(q.sizeFixed,n),y.style.resize=n===`1`?`none`:y.tagName===`TEXTAREA`?`both`:`horizontal`}),k(`pf-multiline`).addEventListener(`change`,e=>{let r=e.target.value===`1`;if(r===(y.tagName===`TEXTAREA`))return;let i=ue(),a=y.getAttribute(`placeholder`)??``,o=t.getAttribute(q.fieldId)??``;t.setAttribute(q.multiline,r?`1`:`0`);let s=r?this.createTextarea(n,a,o):this.createInput(n,a,o);r&&(s.rows=3);let c=t.getAttribute(q.fontSize)??`0`;s.style.fontSize=c===`0`?`inherit`:`${c}px`;let l=t.getAttribute(q.fontFamily)??``;s.style.fontFamily=l||`inherit`,s.style.textAlign=t.getAttribute(q.textAlign)??`left`;let u=t.getAttribute(q.sizeFixed)??`0`;s.style.resize=u===`1`?`none`:r?`both`:`horizontal`;let d=t.getAttribute(q.dataWidth),f=t.getAttribute(q.dataHeight);d&&(s.style.width=`${d}px`),f&&r&&(s.style.height=`${f}px`),r?s.value=i:s.value=i.replace(/\n/g,` `),y.replaceWith(s),y=s,this.attachResizeObserver(s,t)}),h&&k(`pf-numformat`).addEventListener(`change`,e=>{let n=e.target.value;t.setAttribute(q.numberFormat,n);let r=t.getAttribute(q.rawValue)??``;de(n===`none`?r:si(r,n))}),g&&k(`pf-dateformat`).addEventListener(`change`,e=>{let n=e.target.value;t.setAttribute(q.dateFormat,n);let r=t.getAttribute(q.rawValue)??``;r&&de(oi(r,n));let i=O.querySelector(`#pf-value`);i&&(i.placeholder=ai[n]??`예) 20261231`)}),O.querySelector(`#pf-width`)?.addEventListener(`change`,e=>{let n=parseInt(e.target.value,10)||60;n=Math.max(60,Math.min(800,n)),e.target.value=String(n),y.style.width=`${n}px`,t.setAttribute(q.dataWidth,String(n))}),oe&&O.querySelector(`#pf-height`)?.addEventListener(`change`,e=>{let n=parseInt(e.target.value,10)||28;n=Math.max(28,Math.min(600,n)),e.target.value=String(n),y.style.height=`${n}px`,t.setAttribute(q.dataHeight,String(n))}),O.querySelectorAll(`.pf-align-btn`).forEach(e=>{e.addEventListener(`click`,()=>{O.querySelectorAll(`.pf-align-btn`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`);let n=e.dataset.align??`left`;t.setAttribute(q.textAlign,n),y.style.textAlign=n})}),O.querySelectorAll(`.pf-sec-hdr`).forEach(e=>{e.addEventListener(`click`,()=>{let t=O.querySelector(`#pf-body-${e.dataset.sec}`),n=e.querySelector(`.pf-sec-arrow`);if(!t||!n)return;let r=t.style.display!==`none`;t.style.display=r?`none`:`block`,n.textContent=r?`▸`:`▾`})}),O.querySelectorAll(`.pf-move-btn`).forEach(e=>{e.addEventListener(`mousedown`,r=>{r.preventDefault(),r.stopPropagation();let i=e.dataset.dir;if(!i||!t.parentNode)return;let a=t.parentElement,o=a?.tagName===`TD`||a?.tagName===`TH`;switch(i){case`left`:{let e=t.previousSibling;e&&(!o||a?.contains(e))&&(t.parentNode.insertBefore(t,e),this.contentEl?.dispatchEvent(new Event(`input`,{bubbles:!0})));break}case`right`:{let e=t.nextSibling;e&&(!o||a?.contains(e))&&(t.parentNode.insertBefore(e,t),this.contentEl?.dispatchEvent(new Event(`input`,{bubbles:!0})));break}case`up`:{let e=n.createRange();e.setStartBefore(t),e.collapse(!0);let r=n.getSelection();r?.removeAllRanges(),r?.addRange(e),this.contentEl?.focus();break}case`down`:{let e=n.createRange();e.setStartAfter(t),e.collapse(!0);let r=n.getSelection();r?.removeAllRanges(),r?.addRange(e),this.contentEl?.focus();break}}})});let fe=k(`pf-close`);fe.addEventListener(`mouseenter`,()=>{fe.style.background=`#F1F5F9`,fe.style.color=`#374151`}),fe.addEventListener(`mouseleave`,()=>{fe.style.background=`#F8FAFC`,fe.style.color=`#94A3B8`}),fe.addEventListener(`click`,()=>this.closePopup());let pe=e=>{this.popupEl?.contains(e.target)||(this.closePopup(),n.removeEventListener(`mousedown`,pe))};setTimeout(()=>n.addEventListener(`mousedown`,pe),0),O.querySelector(`#pf-header`).addEventListener(`mousedown`,e=>{if(e.target.closest(`button`))return;e.preventDefault();let t=e.clientX,r=e.clientY,i=parseInt(O.style.left,10),a=parseInt(O.style.top,10),o=e=>{let n=e.clientX-t,o=e.clientY-r,s=Math.max(4,Math.min(i+n,(T?.innerWidth??1920)-320-4)),c=Math.max(4,Math.min(a+o,(T?.innerHeight??1080)-60));O.style.left=`${Math.round(s)}px`,O.style.top=`${Math.round(c)}px`},s=()=>{n.removeEventListener(`mousemove`,o),n.removeEventListener(`mouseup`,s),this.dragCleanup=null};n.addEventListener(`mousemove`,o),n.addEventListener(`mouseup`,s),this.dragCleanup=()=>{n.removeEventListener(`mousemove`,o),n.removeEventListener(`mouseup`,s)}})}closePopup(){this.dragCleanup?.(),this.dragCleanup=null,this.popupEl&&=(this.popupEl.remove(),null)}static exportFields(e){let t=new DOMParser().parseFromString(e,`text/html`);return t.querySelectorAll(`.poa-field`).forEach(e=>{let n=e.getAttribute(`data-label`)??``,r=(e.getAttribute(`data-placeholder`)??``)||n,i=e.getAttribute(`data-prefix`)??``,a=e.getAttribute(`data-suffix`)??``,o=e.getAttribute(`data-width`),s=e.getAttribute(`data-height`),c=e.querySelector(`.poa-field-input`),l=``;l=c?.tagName===`TEXTAREA`?c.textContent?.trim()??``:c?.getAttribute(`value`)?.trim()??``;let u=e.getAttribute(`data-field-type`)??``,d=e.getAttribute(`data-raw-value`)??``,f;f=l===``?r:u===`date`&&d?oi(d,e.getAttribute(`data-date-format`)??`YYYY-MM-DD`):l;let p=`${i}${f}${a}`;if(o||s){let n=t.createElement(`span`);n.style.display=`inline-block`,o&&(n.style.width=`${o}px`),s&&(n.style.minHeight=`${s}px`),n.textContent=p,e.replaceWith(n)}else e.replaceWith(t.createTextNode(p))}),t.body.innerHTML}},fi=[{id:`text`,label:`텍스트`,placeholder:`$.{text}`,type:`text`,category:`기본`},{id:`number`,label:`숫자`,placeholder:`$.{number}`,type:`number`,category:`기본`,defaultNumberFormat:`none`},{id:`date`,label:`날짜`,placeholder:`$.{date}`,type:`date`,category:`기본`},{id:`doc_number`,label:`계약번호`,placeholder:`$.{doc_number}`,type:`text`,category:`계약`},{id:`contract_name`,label:`계약명`,placeholder:`$.{contract_name}`,type:`text`,category:`계약`},{id:`contract_date`,label:`계약일`,placeholder:`$.{contract_date}`,type:`date`,category:`계약`},{id:`start_date`,label:`계약시작일`,placeholder:`$.{start_date}`,type:`date`,category:`계약`},{id:`end_date`,label:`계약종료일`,placeholder:`$.{end_date}`,type:`date`,category:`계약`},{id:`currency`,label:`통화`,placeholder:`$.{currency}`,type:`text`,category:`계약`},{id:`pay_condition`,label:`지급조건`,placeholder:`$.{pay_condition}`,type:`text`,category:`계약`},{id:`pay_detail`,label:`지급조건상세`,placeholder:`$.{pay_detail}`,type:`text`,category:`계약`},{id:`amount`,label:`계약금액`,placeholder:`$.{amount}`,type:`number`,category:`금액`,defaultNumberFormat:`comma_won`},{id:`supply_price`,label:`공급가액`,placeholder:`$.{supply_price}`,type:`number`,category:`금액`,defaultNumberFormat:`comma_won`},{id:`vat`,label:`부가세`,placeholder:`$.{vat}`,type:`number`,category:`금액`,defaultNumberFormat:`comma_won`},{id:`penalty`,label:`지체상금`,placeholder:`$.{penalty}`,type:`number`,category:`금액`,defaultNumberFormat:`comma_won`},{id:`advance`,label:`선급금 이행 보증률`,placeholder:`$.{advance}`,type:`number`,category:`보증`,defaultNumberFormat:`percent`},{id:`contract_bond`,label:`계약 이행 보증률`,placeholder:`$.{contract_bond}`,type:`number`,category:`보증`,defaultNumberFormat:`percent`},{id:`defect_bond`,label:`하자 이행 보증률`,placeholder:`$.{defect_bond}`,type:`number`,category:`보증`,defaultNumberFormat:`percent`},{id:`warranty_end`,label:`하자보증기간 종류`,placeholder:`$.{warranty_end}`,type:`text`,category:`보증`},{id:`warranty_period`,label:`하자보증기간`,placeholder:`$.{warranty_period}`,type:`text`,category:`보증`},{id:`warranty_unit`,label:`하자보증기간 단위`,placeholder:`$.{warranty_unit}`,type:`text`,category:`보증`},{id:`remark`,label:`비고`,placeholder:`$.{remark}`,type:`text`,category:`기타`}],pi=Object.fromEntries(fi.map(e=>[e.id,e])),mi=[{id:`A3`,label:`A3`,widthPx:1123,heightPx:1587,widthMm:297,heightMm:420},{id:`A4`,label:`A4`,widthPx:794,heightPx:1123,widthMm:210,heightMm:297},{id:`A5`,label:`A5`,widthPx:559,heightPx:794,widthMm:148,heightMm:210},{id:`B4`,label:`B4`,widthPx:945,heightPx:1335,widthMm:250,heightMm:353},{id:`B5`,label:`B5`,widthPx:665,heightPx:945,widthMm:176,heightMm:250},{id:`Letter`,label:`Letter`,widthPx:816,heightPx:1056,widthMm:215.9,heightMm:279.4},{id:`Legal`,label:`Legal`,widthPx:816,heightPx:1344,widthMm:215.9,heightMm:355.6}],hi={top:25,right:30,bottom:25,left:30},gi=3.7795,_i=class e{currentSize;currentZoom;currentMargin;static ZOOM_MIN=50;static ZOOM_MAX=200;static ZOOM_STEP=10;static STORAGE_KEY_SIZE=`poa-paper-size`;static STORAGE_KEY_ZOOM=`poa-editor-zoom`;static STORAGE_KEY_MARGIN=`poa-paper-margin`;constructor(e,t){this.editableArea=e,this.wrapperEl=t,this.currentSize=mi.find(e=>e.id===`A4`),this.currentZoom=100,this.currentMargin={...hi}}init(){try{let t=localStorage.getItem(e.STORAGE_KEY_SIZE);if(t){let e=mi.find(e=>e.id===t);e&&(this.currentSize=e)}let n=localStorage.getItem(e.STORAGE_KEY_ZOOM);if(n){let t=parseInt(n,10);isNaN(t)||(this.currentZoom=Math.min(e.ZOOM_MAX,Math.max(e.ZOOM_MIN,t)))}let r=localStorage.getItem(e.STORAGE_KEY_MARGIN);if(r){let e=JSON.parse(r);this.currentMargin={...hi,...e}}}catch{}this.applyToEditor()}setPaperSize(e){let t=mi.find(t=>t.id===e);t&&(this.currentSize=t,this.applyToEditor())}setZoom(t){let n=Math.round(t/e.ZOOM_STEP)*e.ZOOM_STEP;this.currentZoom=Math.min(e.ZOOM_MAX,Math.max(e.ZOOM_MIN,n)),this.applyToEditor()}setMargin(e){this.currentMargin={...this.currentMargin,...e},this.applyToEditor()}zoomIn(){this.setZoom(this.currentZoom+e.ZOOM_STEP)}zoomOut(){this.setZoom(this.currentZoom-e.ZOOM_STEP)}resetZoom(){this.setZoom(100)}getSize(){return this.currentSize}getZoom(){return this.currentZoom}getMargin(){return{...this.currentMargin}}applyToEditor(){let{widthPx:t,heightPx:n}=this.currentSize,r=this.currentZoom/100,{top:i,right:a,bottom:o,left:s}=this.currentMargin,c=Math.round(i*gi),l=Math.round(a*gi),u=Math.round(o*gi),d=Math.round(s*gi);this.editableArea.style.width=`${t}px`,this.editableArea.style.minHeight=`${n}px`,this.editableArea.style.height=`auto`,this.editableArea.style.padding=`${c}px ${l}px ${u}px ${d}px`,this.editableArea.style.boxSizing=`border-box`,this.editableArea.style.overflowY=`visible`,this.editableArea.style.overflowX=`visible`,this.editableArea.style.flex=`0 0 auto`,this.editableArea.style.transform=`scale(${r})`,this.editableArea.style.transformOrigin=`top center`,this.editableArea.style.margin=`0 auto`,this.editableArea.style.background=`var(--poa-editor-bg, #fff)`,this.wrapperEl.style.background=`#e5e5e5`,this.wrapperEl.style.padding=`20px`,this.wrapperEl.style.overflowY=`auto`,this.wrapperEl.style.overflowX=`auto`,this.wrapperEl.style.display=`flex`,this.wrapperEl.style.flexDirection=`column`,this.wrapperEl.style.alignItems=`center`,this.wrapperEl.style.justifyContent=`flex-start`;try{localStorage.setItem(e.STORAGE_KEY_SIZE,this.currentSize.id),localStorage.setItem(e.STORAGE_KEY_ZOOM,String(this.currentZoom)),localStorage.setItem(e.STORAGE_KEY_MARGIN,JSON.stringify(this.currentMargin))}catch{}this.wrapperEl.dispatchEvent(new CustomEvent(`paper-change`,{bubbles:!0,detail:{size:this.currentSize,zoom:this.currentZoom,margin:this.currentMargin}}))}};function vi(){return new URLSearchParams(window.location.search).get(`mode`)===`user`?`user`:`admin`}function yi(){return new URLSearchParams(window.location.search).get(`template`)}function bi(){let{origin:e,pathname:t}=window.location,n=e+t.replace(/\/index\.html$/,`/`).replace(/\/[^/]*\.[^/]*$/,`/`);return n.endsWith(`/`)?n:n+`/`}function xi(e){return bi()+`?mode=user&template=`+encodeURIComponent(e)}var Si=`http://localhost:8080/api/v1`;function Ci(e){return`s-${e}`}function wi(e){if(!e.startsWith(`s-`))return null;let t=Number(e.slice(2));return Number.isFinite(t)?t:null}function Ti(e){return{id:Ci(e.id),type:`folder`,name:e.name,parentId:e.parentId===null?null:Ci(e.parentId),isPublic:e.isPublic,createdBy:e.createdBy??null,createdAt:new Date(e.createdAt).getTime(),updatedAt:new Date(e.updatedAt).getTime(),order:e.orderIndex}}function Ei(e){return{id:Ci(e.id),type:`template`,name:e.name,parentId:e.folderId===null?null:Ci(e.folderId),content:e.content??``,isPublic:e.isPublic,...e.isTemp?{isTemp:!0}:{},createdBy:e.createdBy??null,createdAt:new Date(e.createdAt).getTime(),updatedAt:new Date(e.updatedAt).getTime(),order:e.orderIndex}}async function Di(e,t){let n=await fetch(`${Si}${e}`,{...t,headers:{"Content-Type":`application/json`,"Poa-User-Id":Le(),...t?.headers??{}}});if(n.status===204)return;let r=await n.json();if(!r.success)throw Error(r.message??`API 오류`);return r.data}var J={async getFolders(){return(await Di(`/folders`)).map(Ti)},async createFolder(e){return Ti(await Di(`/folders`,{method:`POST`,body:JSON.stringify(e)}))},async updateFolder(e,t){return Ti(await Di(`/folders/${e}`,{method:`PUT`,body:JSON.stringify(t)}))},async deleteFolder(e){await Di(`/folders/${e}`,{method:`DELETE`})},async getTemplates(e){return(await Di(`/templates${e===void 0?``:`?folderId=${e}`}`)).map(Ei)},async getTemplate(e){return Ei(await Di(`/templates/${e}`))},async createTemplate(e){return Ei(await Di(`/templates`,{method:`POST`,body:JSON.stringify(e)}))},async updateTemplate(e,t){return Ei(await Di(`/templates/${e}`,{method:`PUT`,body:JSON.stringify(t)}))},async deleteTemplate(e){await Di(`/templates/${e}`,{method:`DELETE`})},async deleteTempTemplates(){await Di(`/templates/temp`,{method:`DELETE`})},async getAllNodes(){let[e,t]=await Promise.all([this.getFolders(),this.getTemplates()]);return[...e,...t]}},Oi=`poa-templates`;function ki(){return`${Date.now().toString(36)}-${Math.random().toString(36).slice(2,7)}`}var Ai=[{name:`공지사항 기본 양식`,content:`<h2>공지사항</h2><p><strong>제목:</strong>&nbsp;</p><p><strong>내용:</strong>&nbsp;</p><p><strong>담당자:</strong>&nbsp;</p><p><strong>날짜:</strong>&nbsp;</p>`},{name:`회의록 양식`,content:`<h2>회의록</h2><p><strong>일시:</strong>&nbsp;</p><p><strong>장소:</strong>&nbsp;</p><p><strong>참석자:</strong>&nbsp;</p><hr><h3>안건</h3><ol><li></li></ol><h3>결정사항</h3><ol><li></li></ol><h3>다음 회의</h3><p>&nbsp;</p>`},{name:`주간 보고서 양식`,content:`<h2>주간 보고서</h2><p><strong>기간:</strong>&nbsp;</p><p><strong>작성자:</strong>&nbsp;</p><hr><h3>이번 주 완료 업무</h3><ul><li></li></ul><h3>다음 주 계획</h3><ul><li></li></ul><h3>이슈 및 건의사항</h3><p>&nbsp;</p>`}],ji=class{nodes=[];constructor(){this._load(),this.nodes.length===0&&this._seed(),this._syncFromServer()}_load(){try{let e=localStorage.getItem(Oi);this.nodes=e?JSON.parse(e):[]}catch{this.nodes=[]}this._cleanTemp(),this._cleanDuplicates()}_cleanDuplicates(){let e=new Map,t=new Map;for(let n of[...this.nodes].sort((e,t)=>e.createdAt-t.createdAt)){let r=`${n.type}|${n.parentId??``}|${n.name}`,i=e.get(r);i?t.set(n.id,i):e.set(r,n.id)}t.size!==0&&(this.nodes=this.nodes.filter(e=>!t.has(e.id)).map(e=>e.parentId&&t.has(e.parentId)?{...e,parentId:t.get(e.parentId)}:e),this._persist())}_cleanTemp(){let e=Date.now()-1440*60*1e3,t=this.nodes.length;this.nodes=this.nodes.filter(t=>t.type===`template`?!(t.name.startsWith(`임시_`)||t.isTemp&&t.createdAt<e):!0),this.nodes.length!==t&&this._persist()}_persist(){try{localStorage.setItem(Oi,JSON.stringify(this.nodes))}catch{this._evict();try{localStorage.setItem(Oi,JSON.stringify(this.nodes))}catch{}}}_evict(){let e=this.nodes.filter(e=>e.type===`template`).sort((e,t)=>e.updatedAt-t.updatedAt)[0];e&&(this.nodes=this.nodes.filter(t=>t.id!==e.id))}_seed(){let e={id:ki(),type:`folder`,name:`공용 템플릿`,parentId:null,isPublic:!0,createdAt:Date.now(),updatedAt:Date.now(),order:0},t={id:ki(),type:`folder`,name:`내 템플릿`,parentId:null,isPublic:!1,createdAt:Date.now(),updatedAt:Date.now(),order:1};this.nodes.push(e,t),Ai.forEach((t,n)=>{let r=String(j.sanitize(t.content,{USE_PROFILES:{html:!0}}));this.nodes.push({id:ki(),type:`template`,name:t.name,parentId:e.id,content:r,isPublic:!0,createdAt:Date.now(),updatedAt:Date.now(),order:n})}),this._persist()}async _syncFromServer(){try{let e=await J.getAllNodes();if(e.length===0)return;let t=this.nodes.filter(e=>e.isTemp);this.nodes=[...e,...t],this._persist()}catch{console.warn(`API 서버 연결 실패. LocalStorage 모드로 동작합니다.`)}}getAll(){return[...this.nodes]}getById(e){return this.nodes.find(t=>t.id===e)??null}getChildren(e){return this.nodes.filter(t=>t.parentId===e).sort((e,t)=>e.order-t.order||e.name.localeCompare(t.name))}getRoots(){return this.getChildren(null)}getFolders(){return this.nodes.filter(e=>e.type===`folder`)}addFolder(e,t,n=!1){let r={id:ki(),type:`folder`,name:e,parentId:t,isPublic:n,createdBy:n?null:Le(),createdAt:Date.now(),updatedAt:Date.now(),order:this.getChildren(t).length};this.nodes.push(r),this._persist();let i=t?wi(t):null;return J.createFolder({parentId:i,name:r.name,isPublic:r.isPublic,orderIndex:r.order}).then(e=>{r.id=e.id,this._persist()}).catch(()=>{}),r}addTemplate(e,t,n,r=!1,i=!1){let a=String(j.sanitize(t,{USE_PROFILES:{html:!0}})),o={id:ki(),type:`template`,name:e,parentId:n,content:a,isPublic:r,...i?{isTemp:!0}:{},createdBy:r?null:Le(),createdAt:Date.now(),updatedAt:Date.now(),order:this.getChildren(n).length};if(this.nodes.push(o),this._persist(),!i){let e=n?wi(n):null;J.createTemplate({folderId:e,name:o.name,content:o.content??``,isPublic:o.isPublic,isTemp:!1,orderIndex:o.order}).then(e=>{o.id=e.id,this._persist()}).catch(()=>{})}return o}rename(e,t){let n=this.nodes.find(t=>t.id===e);if(!n||!t.trim())return!1;n.name=t.trim(),n.updatedAt=Date.now(),this._persist();let r=wi(e);return r!==null&&(n.type===`folder`?J.updateFolder(r,{parentId:n.parentId?wi(n.parentId)??null:null,name:n.name,isPublic:n.isPublic,orderIndex:n.order}).catch(()=>{}):J.updateTemplate(r,{folderId:n.parentId?wi(n.parentId)??null:null,name:n.name,isPublic:n.isPublic,orderIndex:n.order}).catch(()=>{})),!0}delete(e){let t=this.nodes.find(t=>t.id===e)?.type,n=wi(e);for(let t of this.getChildren(e))this.delete(t.id);this.nodes=this.nodes.filter(t=>t.id!==e),this._persist(),n!==null&&(t===`folder`?J.deleteFolder(n):J.deleteTemplate(n)).catch(()=>{})}move(e,t){let n=this.nodes.find(t=>t.id===e);if(!n||this._isDescendant(t,e))return!1;n.parentId=t,n.order=this.getChildren(t).filter(t=>t.id!==e).length,n.updatedAt=Date.now(),this._persist();let r=wi(e);if(r!==null){let e=t?wi(t)??null:null;n.type===`folder`?J.updateFolder(r,{parentId:e,name:n.name,isPublic:n.isPublic,orderIndex:n.order}).catch(()=>{}):J.updateTemplate(r,{folderId:e,name:n.name,isPublic:n.isPublic,orderIndex:n.order}).catch(()=>{})}return!0}_isDescendant(e,t){if(e===null)return!1;if(e===t)return!0;let n=this.nodes.find(t=>t.id===e);return n?this._isDescendant(n.parentId,t):!1}},Mi=2,Ni=new Set([`p`,`div`,`h1`,`h2`,`h3`,`h4`,`h5`,`h6`,`li`,`blockquote`,`pre`]);function Pi(e){return!e||e===`inherit`?e:e.split(`,`).map(e=>{let t=e.trim().replace(/^['"](.*)['"]\s*$/,`$1`);return/\s/.test(t)?`"${t}"`:t}).join(`, `)}var Fi=class e extends HTMLElement{shadow;core;contentEl;toolbar;statusBar;savedRange=null;clipboardHandler;findReplace;imageInserter;fileManager;autoSave;findDialog;imageDialog;imageInsertDialog;settingsDialog;tableDialog;cellSplitDialog;cellMerger;tableNavigator;tableResizer;tableSelector;tableHandle;tableContextMenu;linkInserter;bookmarkManager;linkDialog;imageResizer;imageToolbar;imgContextMenu=null;linkContextMenu=null;viewManager;tableWholeResizer;tableInlineToolbar;formatPainter;listManager;toast;confirmDialog;accessibilityDialog;privacyDialog;formulaDialog;formulaManager;formulaPickMode=!1;videoDialog;videoInserter;formControlDialog;formControlInserter;formControlEditor;templateDialog;signatureDialog;emojiDialog;tooltipDialog;inputPropertyDialog;emojiInserter;tooltipManager;fieldInserter;paperSizeManager;scrollContainer=null;selectedTable=null;previousMenuTab=`edit`;inTableContext=!1;pendingStyles=new Map;pendingStylesJustSet=!1;selectionHandler=()=>{this.pendingStyles.size>0&&(this.pendingStylesJustSet?this.pendingStylesJustSet=!1:this.pendingStyles.clear()),this.syncToolbar()};constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){He(),this.shadow.innerHTML=`
<style>
:host {
...
`;function Fo(e,t){return e.replace(/width="24"/,`width="${t}"`).replace(/height="24"/,`height="${t}"`)}function Z(e){return Fo(e,16)}function Io(e){return Fo(e,14)}function Lo(e){return Fo(e,12)}var Q={bold:Z(ra),italic:Z(Ma),underline:Z(jo),strike:Z(vo),undo:Z(Mo),redo:Z(ro),alignLeft:Z(Oo),alignCenter:Z(To),alignRight:Z(Eo),alignJustify:Z(Do),indent:Z(Ba),outdent:Z(za),foreColor:Z(ta),backColor:Z(Da),lineHeight:Z(na),letterSpacing:Z(Ja),fileNew:Z(ya),fileOpen:Z(Ca),save:Z(so),fileSaveAs:Z(va),print:Z(to),settings:Z(fo),clock:Z(pa),cut:Z(co),copy:Z(ga),paste:Z(fa),pastePlain:Z(da),selectAll:Z(_o),search:Z(lo),imageEdit:Z(Oa),image:Z(ka),images:Z(Aa),videoTag:Z(Sa),embedVideo:Z(la),link:Z(Ra),linkOff:Z(La),bookmark:Z(aa),signature:Z(Qa),emoji:Z(ho),tooltip:Z(Wa),tooltipList:Z(Ga),calendar:Z(oa),hr:Z(Ka),symbol:Z(Ya),youtube:Z(qa),pageBreak:Z(uo),template:Z(Ia),formField:Z(no),viewDesign:Z(Pa),viewHtml:Z(ma),viewPreview:Z(_a),viewText:Z(Ao),viewPage:Z(ba),fullscreen:Z(Ua),ruler:Z(oo),grid:Z(Ta),hiddenBorder:Z(_o),table:Z(wo),tableProps:Z(Co),cellProps:Z(Fa),mergeCells:Z(xo),splitCell:Z(So),rowAbove:Z(ea),rowBelow:Z(Zi),colLeft:Z(Qi),colRight:Z($i),rowDelete:Z(ao),colDelete:Z(ha),tableDelete:Z(ko),painterCopy:Z(Xa),painterPaste:Z(Za),formatClear:Z(io),ul:Z(Ha),ol:Z(Va),sup:Z(bo),sub:Z(yo),a11y:Z(Xi),privacy:Z(po),form:Z(go),calc:Z(mo),userMode:Z(No),shortcuts:Z(Na),guide:Z(ia),about:Z(ja),folder:Z(wa),folderOpen:Z(Ca),file:Z(xa),fileText16:Z(ba),users16:Z(Po),user16:Z(No),userCircle:Z(ua),plus:Z(eo),pencil:Z($a),trash:Z(ko),link16:Z(Ra),chevronRight:Z(ca),chevronDown:Z(sa),folder14:Io(wa),folderOpen14:Io(Ca),file14:Io(xa),fileText14:Io(ba),users14:Io(Po),user14:Io(No),chevronRight12:Lo(ca),chevronDown12:Lo(sa),fieldText:Io(Ao),fieldNumber:Io(Ea),fieldDate:Io(oa),layoutTemplate48:Fo(Ia,48)},Ro={"file:new":`fileNew`,"file:open":`fileOpen`,"file:save":`save`,"file:saveas":`fileSaveAs`,"file:print":`print`,settings:`settings`,"edit:cut":`cut`,"edit:copy":`copy`,"edit:paste":`paste`,"edit:paste-plain":`pastePlain`,"edit:select-all":`selectAll`,"find-replace":`search`,"edit:image-edit":`imageEdit`,image:`image`,"insert:multi-image":`images`,"insert:video":`videoTag`,"insert:embed":`embedVideo`,"insert:link":`link`,"insert:link-remove":`linkOff`,"insert:bookmark":`bookmark`,"insert:signature":`signature`,"insert:emoji":`emoji`,"insert:tooltip":`tooltip`,"insert:tooltip-list":`tooltipList`,"insert:datetime":`calendar`,"insert:hr":`hr`,"insert:symbol":`symbol`,"insert:pagebreak":`pageBreak`,"misc:template":`template`,"view:design":`viewDesign`,"view:html":`viewHtml`,"view:preview":`viewPreview`,"view:text":`viewText`,"view:page":`viewPage`,"view:fullscreen":`fullscreen`,"view:ruler":`ruler`,"view:grid":`grid`,"view:hidden-border":`hiddenBorder`,table:`table`,"table:table-props":`tableProps`,"table:cell-props":`cellProps`,"table:merge":`mergeCells`,"table:split-cell":`splitCell`,"table:row-above":`rowAbove`,"table:row-below":`rowBelow`,"table:col-left":`colLeft`,"table:col-right":`colRight`,"table:row-delete":`rowDelete`,"table:col-delete":`colDelete`,"table:delete":`tableDelete`,"table:align-left":`alignLeft`,"table:align-center":`alignCenter`,"table:align-right":`alignRight`,"format:painter-copy":`painterCopy`,"format:painter-paste":`painterPaste`,"format:clear":`formatClear`,"format:ul":`ul`,"format:ol":`ol`,"format:sup":`sup`,"format:sub":`sub`,"misc:a11y":`a11y`,"misc:privacy":`privacy`,"misc:form":`form`,"misc:calc":`calc`,"misc:user-mode":`userMode`,"help:shortcuts":`shortcuts`,"help:guide":`guide`,"help:about":`about`},zo=`
*, *::before, *::after { box-sizing: border-box; }
...
`,Uo=class extends HTMLElement{shadow;mgr;tree;selected=null;_getEditorHTML=null;_saveFormOpen=!1;connectedCallback(){this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${Vo}</style>${Ho}`,this.mgr=new ji,this.tree=this.shadow.querySelector(`poa-template-tree`),this.tree.setManager(this.mgr),this._bind()}setup(e){this._getEditorHTML=e}open(){this.selected=null,this._refreshPreview(),this._fillFolderSelect(),this.tree.render(),this._closeSaveForm(),this.setAttribute(`open`,``),setTimeout(()=>this.tree.render(),300)}close(){this.removeAttribute(`open`)}_bind(){this.shadow.querySelector(`.x-btn`).addEventListener(`click`,()=>this.close()),this.addEventListener(`click`,e=>{e.composedPath()[0]===this&&this.close()}),this.addEventListener(`keydown`,e=>{e.key===`Escape`&&(this._saveFormOpen?this._closeSaveForm():this.close())}),this.shadow.getElementById(`search-input`).addEventListener(`input`,e=>{this.tree.setFilter(e.target.value)}),this.shadow.getElementById(`btn-add-folder`).addEventListener(`click`,()=>{let e=this.tree.getSelected(),t=e?.type===`folder`?e.id:null,n=e?.isPublic??!1;this.tree.addFolder(t,Be()?n:!1)}),this.shadow.getElementById(`btn-save-tmpl`).addEventListener(`click`,()=>{this._saveFormOpen?this._closeSaveForm():this._openSaveForm()}),this.shadow.getElementById(`sf-cancel`).addEventListener(`click`,()=>this._closeSaveForm()),this.shadow.getElementById(`sf-ok`).addEventListener(`click`,()=>this._doSave()),this.shadow.getElementById(`sf-name`).addEventListener(`keydown`,e=>{e.key===`Enter`&&this._doSave()}),Be()||this.shadow.getElementById(`sf-public-label`).classList.add(`disabled`),this.shadow.getElementById(`btn-append`).addEventListener(`click`,()=>this._apply(`append`)),this.shadow.getElementById(`btn-replace`).addEventListener(`click`,()=>this._apply(`replace`)),this.shadow.getElementById(`btn-apply-quick`).addEventListener(`click`,()=>this._apply(`replace`)),this.shadow.addEventListener(`poa-tmpl-copy-link`,()=>{this._showToast(`링크가 복사되었습니다.`)}),this.shadow.addEventListener(`poa-tmpl-select`,e=>{let{node:t}=e.detail;this.selected=t.type===`template`?t:null,this._refreshPreview()}),this.shadow.addEventListener(`poa-tmpl-dblclick`,e=>{let{node:t}=e.detail;this.selected=t,this._apply(`replace`)})}_openSaveForm(){this._saveFormOpen=!0,this._fillFolderSelect(),this.shadow.getElementById(`sf-name`).value=``,this.shadow.getElementById(`save-form`).classList.add(`visible`),this.shadow.getElementById(`btn-save-tmpl`).classList.add(`active`),setTimeout(()=>this.shadow.getElementById(`sf-name`).focus(),50)}_closeSaveForm(){this._saveFormOpen=!1,this.shadow.getElementById(`save-form`).classList.remove(`visible`),this.shadow.getElementById(`btn-save-tmpl`).classList.remove(`active`)}async _ensureContent(){if(!this.selected)return``;if(this.selected.content)return this.selected.content;let e=wi(this.selected.id);if(e===null)return``;try{let t=await J.getTemplate(e);return this.selected={...this.selected,content:t.content??``},this.selected.content??``}catch{return``}}async _refreshPreview(){let e=this.shadow.getElementById(`preview-empty`),t=this.shadow.getElementById(`preview-content`),n=this.shadow.getElementById(`preview-frame`),r=this.shadow.getElementById(`btn-append`),i=this.shadow.getElementById(`btn-replace`);if(!this.selected||this.selected.type!==`template`){e.classList.remove(`hidden`),t.classList.add(`hidden`),r.disabled=!0,i.disabled=!0;return}this.shadow.getElementById(`info-name`).textContent=this.selected.name,this.shadow.getElementById(`info-date`).textContent=new Date(this.selected.updatedAt).toLocaleDateString(`ko-KR`,{year:`numeric`,month:`2-digit`,day:`2-digit`}),e.classList.add(`hidden`),t.classList.remove(`hidden`),r.disabled=!1,i.disabled=!1;let a=await this._ensureContent();n.srcdoc=`<!DOCTYPE html>
...
`,es=class extends HTMLElement{shadow;inserter=new Wr;activeCatId=Vr[0].id;connectedCallback(){this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${$o}</style>
<div class="dlg">
...
</div>`,this._buildCatBar(),this._bind()}open(){this._renderCategory(this.activeCatId),this.setAttribute(`open`,``),setTimeout(()=>this.shadow.getElementById(`search`).focus(),50)}close(){this.removeAttribute(`open`)}_buildCatBar(){let e=this.shadow.getElementById(`cat-bar`);e.innerHTML=``;for(let t of Vr){let n=document.createElement(`button`);n.className=`cat-btn${t.id===this.activeCatId?` active`:``}`,n.title=t.label,n.textContent=t.icon,n.dataset.catId=t.id,n.addEventListener(`click`,()=>{this.activeCatId=t.id,this._syncCatBar(),this._renderCategory(t.id),this.shadow.getElementById(`search`).value=``}),e.appendChild(n)}}_syncCatBar(){this.shadow.querySelectorAll(`.cat-btn`).forEach(e=>{e.classList.toggle(`active`,e.dataset.catId===this.activeCatId)})}_renderCategory(e){let t=this.shadow.getElementById(`emoji-area`);t.innerHTML=``;let n=this.inserter.getRecent();if(n.length>0){this._appendSection(t,`최근 사용`,n);let e=document.createElement(`hr`);e.className=`divider`,t.appendChild(e)}let r=Vr.find(t=>t.id===e);r&&this._appendSection(t,r.label,r.emojis)}_renderSearch(e){let t=this.shadow.getElementById(`emoji-area`);t.innerHTML=``;let n=Ur(e);if(n.length===0){let n=document.createElement(`div`);n.className=`no-result`,n.textContent=`"${e}"에 대한 결과가 없습니다`,t.appendChild(n)}else this._appendSection(t,`검색 결과 (${n.length})`,n)}_appendSection(e,t,n){let r=document.createElement(`div`);r.className=`section-label`,r.textContent=t,e.appendChild(r);let i=document.createElement(`div`);i.className=`emoji-grid`;for(let e of n){let t=document.createElement(`button`);t.className=`emoji-btn`,t.textContent=e,t.title=e,t.addEventListener(`click`,()=>this._pickEmoji(e)),i.appendChild(t)}e.appendChild(i)}_bind(){this.shadow.querySelector(`.x-btn`).addEventListener(`click`,()=>this.close()),this.addEventListener(`click`,e=>{e.composedPath()[0]===this&&this.close()});let e=this.shadow.getElementById(`search`);e.addEventListener(`input`,()=>{let t=e.value.trim();t?this._renderSearch(t):this._renderCategory(this.activeCatId)}),e.addEventListener(`keydown`,e=>{e.key===`Escape`&&(e.stopPropagation(),this.close())})}_pickEmoji(e){this.dispatchEvent(new CustomEvent(`poa-emoji-insert`,{bubbles:!0,composed:!0,detail:{emoji:e}})),this.shadow.getElementById(`search`).value.trim()||this._renderCategory(this.activeCatId)}},ts=`
*, *::before, *::after { box-sizing: border-box; }
:host { display: none; position: fixed; inset: 0; z-index: 9999; align-items: center; justify-content: center; }
:host([open]) { display: flex; background: rgba(0,0,0,.45); }
...
.hidden { display: none !important; }
`,ns=class extends HTMLElement{shadow;mode=`add`;editId=null;entries=[];connectedCallback(){this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${ts}</style>
<div class="dlg">
  <div class="hdr">
...
`;function Ts(e){return new Date(e).toLocaleString(`ko-KR`,{month:`2-digit`,day:`2-digit`,hour:`2-digit`,minute:`2-digit`,second:`2-digit`})}var Es=class extends HTMLElement{shadow;autoSave=null;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${ws}</style>
  ...
  <div class="dialog" role="dialog" aria-modal="true" aria-label="설정">
    ...
    <div class="body">
      ...
      <div class="section">
        ...
        <span class="history-time">${Ts(n.savedAt)}</span>
        <button class="restore-btn" data-id="${String(n.id)}">복원</button>`,t.querySelector(`.restore-btn`).addEventListener(`click`,()=>{this.handleRestore(n)}),e.appendChild(t)}}handleRestore(e){this.dispatchEvent(new CustomEvent(`poa-autosave-restore`,{bubbles:!0,composed:!0,detail:{html:e.html}})),this.close()}},Ds=`
/* ── 호스트 슬라이드 애니메이션 ── */
:host {
  display: block;
  overflow: hidden;
...
`,js=class extends HTMLElement{shadow;editor=new Ii;originalSrc=``;currentDataUrl=``;busy=!1;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${As}</style>
<div class="backdrop" id="backdrop">
...
.grid-picker {
  display: grid;
  grid-template-columns: repeat(${Fs}, ${Ls}px);
  gap: ${Rs}px;
  cursor: crosshair;
}
.gc {
...
`,Bs=class e extends HTMLElement{shadow;selectedPreset=`border-all`;gridCells=[];constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${zs}</style>
<div class="overlay" id="overlay">
  <div class="dialog" role="dialog" aria-modal="true">
    <div class="dlg-hd">
...
</div>`,this.shadow.getElementById(`btn-close`).addEventListener(`click`,()=>this.close()),this.shadow.getElementById(`overlay`).addEventListener(`click`,e=>{e.target.id===`overlay`&&this.close()})}open(e){this.classList.add(`open`);let t=this.shadow.getElementById(`dlg-body`),n=this.shadow.getElementById(`dlg-title`);e?(n.textContent=`표 속성`,this.renderProps(t,e)):(n.textContent=`표`,this.renderInsert(t))}close(){this.classList.remove(`open`),this.gridCells=[]}renderInsert(e){let t=e.ownerDocument;e.innerHTML=``;let n=t.createElement(`div`);n.className=`preset-grid`;for(let e of pn){let r=t.createElement(`div`);r.className=`preset-item`+(e.id===this.selectedPreset?` active`:``),r.dataset.pid=e.id,r.innerHTML=`${e.icon}<span class="preset-lbl">${e.label}</span>`,r.addEventListener(`click`,()=>this.selectPreset(e.id)),n.appendChild(r)}e.appendChild(n);let r=t.createElement(`hr`);r.className=`sep`,e.appendChild(r);let i=t.createElement(`div`);i.className=`grid-wrap`;let a=t.createElement(`div`);a.className=`grid-picker`,this.gridCells=[];for(let e=0;e<Is;e++)for(let n=0;n<Fs;n++){let r=t.createElement(`div`);r.className=`gc`,r.dataset.r=String(e),r.dataset.c=String(n),a.appendChild(r),this.gridCells.push(r)}let o=t.createElement(`div`);o.className=`grid-size`,o.textContent=``,a.addEventListener(`mousemove`,e=>{if(!e.target.closest(`.grid-picker`))return;let t=a.getBoundingClientRect(),n=Ls+Rs,r=Math.min(Math.floor((e.clientX-t.left)/n),Fs-1),i=Math.min(Math.floor((e.clientY-t.top)/n),Is-1);this.highlightGrid(i,r),o.textContent=`${r+1} × ${i+1}`}),a.addEventListener(`mouseleave`,()=>{this.highlightGrid(-1,-1),o.textContent=``}),a.addEventListener(`click`,e=>{let t=a.getBoundingClientRect(),n=Ls+Rs,r=Math.min(Math.floor((e.clientX-t.left)/n),Fs-1),i=Math.min(Math.floor((e.clientY-t.top)/n),Is-1);this.insertTable(i+1,r+1)}),i.appendChild(a),i.appendChild(o),e.appendChild(i)}selectPreset(e){this.selectedPreset=e,this.shadow.querySelectorAll(`.preset-item`).forEach(t=>{t.classList.toggle(`active`,t.dataset.pid===e)})}highlightGrid(e,t){for(let n of this.gridCells){let r=parseInt(n.dataset.r??`0`),i=parseInt(n.dataset.c??`0`);n.classList.toggle(`hl`,r<=e&&i<=t)}}insertTable(e,t){let n=pn.find(e=>e.id===this.selectedPreset)??pn[0],r={rows:e,cols:t,width:`100%`,align:`center`,...n.baseOptions};this.dispatchEvent(new CustomEvent(`poa-table-insert`,{bubbles:!0,composed:!0,detail:{options:r,presetId:n.id}})),this.close()}renderProps(t,n){let r=n.style.width||`100%`,i=e.rgbToHex(n.style.backgroundColor)||`#ffffff`,a=n.querySelector(`td,th`)?.style.border.match(/solid\s+(#[\da-fA-F]{3,6}|[a-z]+)/i),o=a?a[1]:`#000000`,s=`left`;n.style.marginLeft===`auto`&&n.style.marginRight===`auto`?s=`center`:n.style.marginLeft===`auto`&&(s=`right`);let c=(e,t,n)=>`<button class="align-btn${s===e?` active`:``}" data-align="${e}">${t} ${n}</button>`;t.innerHTML=`
...
</div>`;let l=s;t.querySelector(`#pp-align-btns`).addEventListener(`click`,e=>{let n=e.target.closest(`.align-btn`);n&&(l=n.dataset.align,t.querySelectorAll(`.align-btn`).forEach(e=>{e.classList.toggle(`active`,e.dataset.align===l)}))}),t.querySelector(`#pp-cancel`).addEventListener(`click`,()=>this.close()),t.querySelector(`#pp-ok`).addEventListener(`click`,()=>{let e={width:t.querySelector(`#pp-w`).value.trim(),borderColor:t.querySelector(`#pp-bc`).value,bgColor:t.querySelector(`#pp-bg`).value,align:l};this.dispatchEvent(new CustomEvent(`poa-table-update`,{bubbles:!0,composed:!0,detail:{options:e,table:n}})),this.close()})}static rgbToHex(e){let t=e.match(/\d+/g);return!t||t.length<3?``:`#`+t.slice(0,3).map(e=>parseInt(e).toString(16).padStart(2,`0`)).join(``)}static colorToHex(t){return e.rgbToHex(t)||`#ffffff`}},Vs=[{label:`날짜 (2025-05-05)`,fn:()=>new Date().toISOString().slice(0,10)},{label:`시간 (14:30:05)`,fn:()=>new Intl.DateTimeFormat(`ko-KR`,{hour:`2-digit`,minute:`2-digit`,second:`2-digit`,hour12:!1}).format(new Date)},{label:`날짜·시간 (2025-05-05 14:30)`,fn:()=>{let e=new Date;return`${e.toISOString().slice(0,10)} ${new Intl.DateTimeFormat(`ko-KR`,{hour:`2-digit`,minute:`2-digit`,hour12:!1}).format(e)}`}},{label:`한국어 날짜 (2025년 5월 5일)`,fn:()=>new Intl.DateTimeFormat(`ko-KR`,{year:`numeric`,month:`long`,day:`numeric`}).format(new Date)},{label:`한국어 날짜·시간 (2025년 5월 5일 월요일 오후 2:30)`,fn:()=>new Intl.DateTimeFormat(`ko-KR`,{year:`numeric`,month:`long`,day:`numeric`,weekday:`long`,hour:`numeric`,minute:`2-digit`}).format(new Date)}],Hs=`
:host { display: none; }
:host([open]) { display: block; }
.backdrop {
  position: fixed; inset: 0; background: rgba(0,0,0,.45);
...
`,Us=class extends HTMLElement{shadow;bookmarks=[];editingId=null;editingAnchor=null;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${Hs}</style>
<div class="backdrop" id="backdrop">
  <div class="dialog" role="dialog" aria-modal="true" aria-label="링크 삽입">
    ...
    `).join(``),this.refreshDatetimePreviews(),e.addEventListener(`click`,e=>{let t=e.target.closest(`[data-preset]`);if(!t)return;let n=Vs[parseInt(t.dataset.preset??`0`)]?.fn()??``;this.dispatch(`poa-datetime-insert`,{text:n}),this.close()}))}refreshDatetimePreviews(){Vs.forEach((e,t)=>{let n=this.shadow.getElementById(`dt-prev-${t}`);n&&(n.textContent=e.fn())})}dispatch(e,t){this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0,detail:t}))}},Ws=`
:host { display: none; }
:host([open]) {
  display: flex; align-items: center; gap: 6px;
...
`,Gs=class extends HTMLElement{shadow;img=null;aspectLocked=!1;naturalW=0;naturalH=0;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${Ws}</style>
<label>너비</label>
...
`,Js=class extends HTMLElement{shadow;resolvePromise=null;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${Ks}</style>${qs}`,this.bindEvents()}show(e,t=`확인`){let n=this.shadow.getElementById(`dlg-title`),r=this.shadow.getElementById(`dlg-message`);return n&&(n.textContent=t),r&&(r.textContent=e),this.setAttribute(`open`,``),new Promise(e=>{this.resolvePromise=e})}close(e){this.removeAttribute(`open`),this.resolvePromise?.(e),this.resolvePromise=null}bindEvents(){this.shadow.getElementById(`btn-ok`)?.addEventListener(`click`,()=>this.close(!0)),this.shadow.getElementById(`btn-cancel`)?.addEventListener(`click`,()=>this.close(!1)),this.shadow.getElementById(`overlay`)?.addEventListener(`click`,e=>{e.target.id===`overlay`&&this.close(!1)}),this.addEventListener(`keydown`,e=>{e.key===`Escape`&&(e.preventDefault(),this.close(!1))})}},Ys={error:`●`,warning:`▲`,info:`ℹ`},Xs={error:`#DC2626`,warning:`#D97706`,info:`#2563EB`},Zs=`
:host { display: none; }
:host([open]) { display: block; }
...
`,Qs=class extends HTMLElement{shadow;issues=[];contentEl=null;rerunFn=null;currentFilter=`all`;constructor(){super(),this.shadow=this.attachShadow({mode:`open`})}connectedCallback(){this.shadow.innerHTML=`<style>${Zs}</style>
<div class="overlay" id="overlay">
  <div class="dialog">
    <div class="header">
      <h2>웹 접근성 검사 결과</h2>
...
`,rc=class extends HTMLElement{shadow;items=[];filteredType=`all`;onModified=null;onConfirmFn=null;constructor(){super(),this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${nc}</style><slot></slot>`}setup(e,t){this.onModified=e,this.onConfirmFn=t}startLoading(){this.setAttribute(`open`,``),this.shadow.innerHTML=`<style>${nc}</style>
<div class="overlay">
  <div class="dialog">
    <div class="header">
      <h2>개인정보 검사</h2>
...
<div class="card" data-level="${e.riskLevel}" data-id="${e.id}">
  <div class="card-header" data-toggle="${e.id}">
    <span class="card-icon">${ec[e.riskLevel]}</span>
    <span class="card-label">${e.label}</span>
    <span class="card-risk">${tc[e.riskLevel]}</span>
    <span class="card-toggle">∨</span>
  </div>
  <div class="card-body" id="body-${e.id}">
    <div class="raw-text">"${ic(e.raw)}"</div>
...
`,oc=class extends HTMLElement{shadow;currentTable=null;currentRow=1;currentCol=1;pickBar=null;constructor(){super(),this.shadow=this.attachShadow({mode:`open`}),this.shadow.innerHTML=`<style>${ac}</style>`}open(e){this.currentTable=e.table,this.currentRow=e.cellRow,this.currentCol=e.cellCol,this.setAttribute(`open`,``),this.render(e.existingFormula,e.initialRange)}close(){this.removeAttribute(`open`),this.exitPickMode(),this.currentTable=null}applyRange(e,t,n,r){this.exitPickMode();let i=e=>this.shadow.getElementById(e),a=(e,t)=>{let n=i(e);n&&(n.value=String(t))};a(`sr`,e),a(`sc`,t),a(`er`,n),a(`ec`,r)}render(e,t){let n=e?.fn??`SUM`,r=e?.format??`integer`,i=e?.decimalPlaces??2,[a,o,s,c]=e?.range??t??[1,1,1,1],l=e?.targetRow??this.currentRow,u=e?.targetCol??this.currentCol,d=!e||e.targetRow===this.currentRow&&e.targetCol===this.currentCol,f=e?.style?.backgroundColor??`#ffffff`,p=e?.style?.color??`#000000`,m=(e,t)=>`<label><input type="radio" name="fn" value="${e}"${n===e?` checked`:``}> ${e} (${t})</label>`,h=(e,t)=>`<label><input type="radio" name="format" value="${e}"${r===e?` checked`:``}> ${t}</label>`;this.shadow.innerHTML=`<style>${ac}</style>
<div class="overlay" id="overlay">
  <div class="dialog" id="dialog">
    <div class="header">
      <h2>계산식 설정</h2>
    ...
    <div class="footer">
      ...
      ">취소</button>`,document.body.appendChild(e),this.pickBar=e,e.querySelector(`#cancel-pick`)?.addEventListener(`click`,()=>this.exitPickMode()),this.dispatchEvent(new CustomEvent(`poa-formula-start-pick`,{bubbles:!0}))}exitPickMode(){this.shadow.getElementById(`overlay`)?.classList.remove(`pick-mode`),this.pickBar?.remove(),this.pickBar=null}};customElements.get(`poa-menubar`)||customElements.define(`poa-menubar`,cs),customElements.get(`poa-context-toolbar`)||customElements.define(`poa-context-toolbar`,hs),customElements.get(`poa-toolbar`)||customElements.define(`poa-toolbar`,Ss),customElements.get(`poa-status-bar`)||customElements.define(`poa-status-bar`,Cs),customElements.get(`poa-settings-dialog`)||customElements.define(`poa-settings-dialog`,Es),customElements.get(`poa-find-replace-dialog`)||customElements.define(`poa-find-replace-dialog`,ks),customElements.get(`poa-image-edit-dialog`)||customElements.define(`poa-image-edit-dialog`,js),customElements.get(`poa-image-dialog`)||customElements.define(`poa-image-dialog`,Ps),customElements.get(`poa-table-dialog`)||customElements.define(`poa-table-dialog`,Bs),customElements.get(`poa-cell-split-dialog`)||customElements.define(`poa-cell-split-dialog`,Vi),customElements.get(`poa-link-dialog`)||customElements.define(`poa-link-dialog`,Us),customElements.get(`poa-image-toolbar`)||customElements.define(`poa-image-toolbar`,Gs),customElements.get(`poa-confirm-dialog`)||customElements.define(`poa-confirm-dialog`,Js),customElements.get(`poa-accessibility-dialog`)||customElements.define(`poa-accessibility-dialog`,Qs),customElements.get(`poa-privacy-dialog`)||customElements.define(`poa-privacy-dialog`,rc),customElements.get(`poa-formula-dialog`)||customElements.define(`poa-formula-dialog`,oc),customElements.get(`poa-video-dialog`)||customElements.define(`poa-video-dialog`,Ui),customElements.get(`poa-form-control-dialog`)||customElements.define(`poa-form-control-dialog`,Yi),customElements.get(`poa-template-tree`)||customElements.define(`poa-template-tree`,Bo),customElements.get(`poa-template-dialog`)||customElements.define(`poa-template-dialog`,Uo),customElements.get(`poa-signature-dialog`)||customElements.define(`poa-signature-dialog`,Qo),customElements.get(`poa-emoji-dialog`)||customElements.define(`poa-emoji-dialog`,es),customElements.get(`poa-tooltip-dialog`)||customElements.define(`poa-tooltip-dialog`,ns),customElements.get(`poa-input-property-dialog`)||customElements.define(`poa-input-property-dialog`,is),customElements.get(`poa-editor`)||customElements.define(`poa-editor`,Fi);var sc=class{mgr;grid;constructor(e){this.container=e,this.mgr=new ji}renderTemplateSelector(){this.container.innerHTML=``;let e=document.createElement(`h2`);e.className=`user-mode-selector-title`,e.textContent=`양식 선택`,this.container.appendChild(e),this.grid=document.createElement(`div`),this.grid.className=`user-mode-card-grid`,this.container.appendChild(this.grid);let t=this.mgr.getAll().filter(e=>e.type===`template`&&!e.isTemp);this._renderCards(t),this._refreshFromServer()}async _refreshFromServer(){try{let e=(await J.getTemplates()).filter(e=>!e.isTemp);this._renderCards(e)}catch{}}_renderCards(e){if(this.grid.innerHTML=``,e.length===0){let e=document.createElement(`p`);e.style.cssText=`color:#9ca3af;font-size:14px;`,e.textContent=`저장된 템플릿이 없습니다.`,this.grid.appendChild(e)}else for(let t of e)this.grid.appendChild(this._buildCard(t))}_buildCard(e){let t=document.createElement(`div`);t.className=`user-mode-card`;let n=document.createElement(`div`);n.className=`user-mode-card-icon`,n.textContent=`📄`;let r=document.createElement(`div`);return r.className=`user-mode-card-name`,r.textContent=e.name,t.appendChild(n),t.appendChild(r),t.addEventListener(`click`,()=>{window.location.href=xi(e.id)}),t}static async loadTemplateById(e){let t=wi(e);if(t!==null)try{return await J.getTemplate(t)}catch{}return new ji().getById(e)??null}};if(vi()===`user`){let e=yi();if(e){let t=await sc.loadTemplateById(e),n=document.getElementById(`editor`);t?.content&&n.setHTML(t.content),n.enterUserMode(t?.name??`문서`)}else document.getElementById(`editor-root`).classList.add(`hidden`),document.body.classList.add(`user-mode`),new sc(document.getElementById(`user-mode-root`)).renderTemplateSelector()}var cc=document.getElementById(`editor`),lc=document.getElementById(`output`),uc=`<h2>poa-editor v1.0.0</h2>
...
<p>표 삽입 → 삽입 메뉴 → 표를 사용해보세요.</p>`;document.getElementById(`btn-get-html`).addEventListener(`click`,()=>{lc.style.display=`block`,lc.textContent=cc.getHTML()}),document.getElementById(`btn-set-html`).addEventListener(`click`,()=>{cc.setHTML(uc),lc.style.display=`none`}),document.getElementById(`btn-clear`).addEventListener(`click`,()=>{cc.setHTML(``),lc.style.display=`none`}),document.getElementById(`btn-find`).addEventListener(`click`,()=>{cc.querySelector(`.poa-editor-content`)?.focus(),cc.dispatchEvent(new KeyboardEvent(`keydown`,{key:`f`,ctrlKey:!0,bubbles:!0}))}),document.getElementById(`btn-replace`).addEventListener(`click`,()=>{cc.querySelector(`.poa-editor-content`)?.focus(),cc.dispatchEvent(new KeyboardEvent(`keydown`,{key:`h`,ctrlKey:!0,bubbles:!0}))}),document.getElementById(`btn-undo`).addEventListener(`click`,()=>{cc.querySelector(`.poa-editor-content`)?.focus(),document.execCommand(`undo`)}),document.getElementById(`btn-redo`).addEventListener(`click`,()=>{cc.querySelector(`.poa-editor-content`)?.focus(),document.execCommand(`redo`)}),vi()!==`user`&&setTimeout(()=>cc.setHTML(uc),100);