import { Type, Bold, Clipboard, Search, Table, ChevronRight, TableCellsMerge, Rows3, Image, Maximize2, ImagePlus, FormInput, List, User, } from 'lucide-static';
...
const GUIDE_TABS = ['기본편집', '표', '이미지', '양식필드'];
const CSS = `
:host { display: none; }
