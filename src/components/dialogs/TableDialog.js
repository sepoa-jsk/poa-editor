  ...
  <div class="dialog" role="dialog" aria-modal="true">
    ...
    renderInsert(body) {
        ...
        gridPicker.addEventListener('mousemove', (e) => {
            const gc = e.target.closest('.grid-picker');
            if (!gc)
                return;
    ...
    selectPreset(id) {
        ...
        this.shadow.querySelectorAll('.preset-item').forEach((el) => {
...
<div class="props-actions">
  ...
  <button class="btn btn-primary" id="pp-ok">적용</button>
        ...
        body.querySelector('#pp-align-btns').addEventListener('click', (e) => {
            ...
            body.querySelectorAll('.align-btn').forEach((b) => {
    ...
    static colorToHex(color) { return PoaTableDialog.rgbToHex(color) || '#ffffff'; }
}
