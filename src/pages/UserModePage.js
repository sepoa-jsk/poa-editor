...
function isValidTemplate(n) {
    return (n.type === 'template' &&
        !n.isTemp &&
...
export class UserModePage {
    ...
    _renderCards(grid, templates, kind, emptyMsg) {
        grid.innerHTML = '';
     ...
     */
    static async loadTemplateById(templateId) {
