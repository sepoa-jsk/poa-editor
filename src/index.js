...
if (!customElements.get('poa-menubar'))
    customElements.define('poa-menubar', PoaMenuBar);
if (!customElements.get('poa-context-toolbar'))
    customElements.define('poa-context-toolbar', PoaContextToolbar);
if (!customElements.get('poa-toolbar'))
    customElements.define('poa-toolbar', PoaToolbar);
if (!customElements.get('poa-status-bar'))
    customElements.define('poa-status-bar', PoaStatusBar);
if (!customElements.get('poa-settings-dialog'))
    customElements.define('poa-settings-dialog', PoaSettingsDialog);
if (!customElements.get('poa-file-manager-dialog'))
    customElements.define('poa-file-manager-dialog', PoaFileManagerDialog);
if (!customElements.get('poa-find-replace-dialog'))
    customElements.define('poa-find-replace-dialog', PoaFindReplaceDialog);
if (!customElements.get('poa-image-edit-dialog'))
    customElements.define('poa-image-edit-dialog', PoaImageEditDialog);
if (!customElements.get('poa-image-dialog'))
    customElements.define('poa-image-dialog', PoaImageDialog);
if (!customElements.get('poa-table-dialog'))
    customElements.define('poa-table-dialog', PoaTableDialog);
if (!customElements.get('poa-cell-split-dialog'))
    customElements.define('poa-cell-split-dialog', _PoaCellSplitDialog);
if (!customElements.get('poa-link-dialog'))
    customElements.define('poa-link-dialog', PoaLinkDialog);
if (!customElements.get('poa-image-toolbar'))
    customElements.define('poa-image-toolbar', PoaImageToolbar);
if (!customElements.get('poa-confirm-dialog'))
    customElements.define('poa-confirm-dialog', PoaConfirmDialog);
if (!customElements.get('poa-accessibility-dialog'))
    customElements.define('poa-accessibility-dialog', PoaAccessibilityDialog);
if (!customElements.get('poa-privacy-dialog'))
    customElements.define('poa-privacy-dialog', PoaPrivacyDialog);
if (!customElements.get('poa-formula-dialog'))
    customElements.define('poa-formula-dialog', PoaFormulaDialog);
if (!customElements.get('poa-video-dialog'))
    customElements.define('poa-video-dialog', _PoaVideoDialog);
if (!customElements.get('poa-form-control-dialog'))
    customElements.define('poa-form-control-dialog', _PoaFormControlDialog);
if (!customElements.get('poa-template-tree'))
    customElements.define('poa-template-tree', _PoaTemplateTree);
if (!customElements.get('poa-template-dialog'))
    customElements.define('poa-template-dialog', _PoaTemplateDialog);
if (!customElements.get('poa-signature-dialog'))
    customElements.define('poa-signature-dialog', _PoaSignatureDialog);
if (!customElements.get('poa-emoji-dialog'))
    customElements.define('poa-emoji-dialog', _PoaEmojiDialog);
if (!customElements.get('poa-tooltip-dialog'))
    customElements.define('poa-tooltip-dialog', _PoaTooltipDialog);
if (!customElements.get('poa-input-property-dialog'))
    customElements.define('poa-input-property-dialog', _PoaInputPropertyDialog);
if (!customElements.get('poa-document-list-dialog'))
    customElements.define('poa-document-list-dialog', _PoaDocumentListDialog);
if (!customElements.get('poa-doc-title-dialog'))
    customElements.define('poa-doc-title-dialog', _PoaDocTitleDialog);
if (!customElements.get('poa-shortcuts-dialog'))
    customElements.define('poa-shortcuts-dialog', _PoaShortcutsDialog);
if (!customElements.get('poa-user-guide-dialog'))
    customElements.define('poa-user-guide-dialog', _PoaUserGuideDialog);
if (!customElements.get('poa-editor'))
    customElements.define('poa-editor', PoaEditor);
// ── 팩토리 함수 ───────────────────────────────────────────────────────────────
/**
...
export function createEditor(container, options) {
    const editor = document.createElement('poa-editor');
