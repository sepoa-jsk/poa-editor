...
function makeInputInCell(): { inp: HTMLInputElement; td: HTMLTableCellElement } {
...
function getBtns(bar: Element): HTMLButtonElement[] {
...
describe('InputInlineToolbar — 표 안 input', () => {
  ...
  it('위치 정렬 "가운데 배치" → td.style.textAlign:center', () => {
    const alignSel = getBar()!.querySelector<HTMLSelectElement>('select')!;
    alignSel.value = 'pos-center';
    alignSel.dispatchEvent(new Event('change', { bubbles: true }));
