...
function fireTab(target: HTMLElement, shiftKey = false): KeyboardEvent {
...
describe('TableNavigator — Tab 셀 이동', () => {
  ...
  it('th 헤더 셀에서도 Tab 이동 동작', () => {
    ...
    const focusSpy = vi.spyOn(th2 as HTMLElement, 'focus');
    placeCaretInCell(th1 as unknown as HTMLTableCellElement);
    const e = fireTab(root);
